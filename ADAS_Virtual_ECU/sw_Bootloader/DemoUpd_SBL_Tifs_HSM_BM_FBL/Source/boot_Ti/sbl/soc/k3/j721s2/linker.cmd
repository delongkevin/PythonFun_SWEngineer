...
/*MCU1_0 DDR space is from 0x9D000000  to 0x9DFEFBFF*/
#define MCU1_0_DDR_CERT_STORE_BASE  0x9DFEFC00
...
MEMORY
{
    ...
    OCMRAM_SBL    (RWIX)   : origin=0x41C00200 length=0x80000-0x200-0x20

    /* MCU0 memory used for the SBL to save OSPI PHY tuning data for later apps to use */
    OCMRAM_SBL_PHY_TUNING    (RWIX)   : origin=0x41c7ffe0 length=0x20
    ...
    /* This space is used for storing Security Certificate */
    MCU1_0_DDR_CERT_STORE (RWIX) : origin=MCU1_0_DDR_CERT_STORE_BASE length=0x00010000 /* 64KB */
...
/* a range of +\- 16 MB                                                       */
    ...
    .ospi_phy_tuning_data         : {} palign(8)     > OCMRAM_SBL_PHY_TUNING
    ...
    cert_store (NOINIT)           : {} palign(8)     > MCU1_0_DDR_CERT_STORE /*for Security certificate */
    .sysmem                       : {}               > OCMRAM_SBL
    ...
    .fcopy             : {} palign(8)                            > OCMRAM_SBL_RESERVED_CUST_BOOT

    /*.nand_flash_critical_functions  : {} align(8)      >  MCU0_R5F_TCMA */
}  /* end of SECTIONS */
