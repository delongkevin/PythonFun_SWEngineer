...
drvudma_BOARDLIST       = am65xx_evm am65xx_idk j721e_sim j721e_evm j7200_evm am64x_evm j721s2_evm j721s2_hyd j784s4_evm
drvudma_dru_BOARDLIST   = am65xx_evm am65xx_idk j721e_evm j721s2_evm j721s2_hyd j784s4_evm
...
export dmautils_autoincrement_testapp_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), j721e_evm j721s2_evm j721s2_hyd)
...
export dmautils_autoinc_1d2d3d_testapp_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), j721e_evm j721s2_evm j721s2_hyd)
...
export dmautils_autoinc_circular_testapp_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), j721e_evm j721s2_evm j721s2_hyd)
...
export dmautils_autoinc_compression_testapp_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), j721s2_evm j721s2_hyd)
