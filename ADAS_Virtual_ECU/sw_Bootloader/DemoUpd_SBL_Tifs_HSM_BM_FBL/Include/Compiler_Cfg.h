...
#define EEP_E_READ_FAILED 1u /*  Ref to DemEvent (EEP_E_READ_FAILED)  */
#define EEP_E_COMPARE_FAILED 1u /*  Ref to DemEvent (EEP_E_COMPARE_FAILED)  */
#define EEP_E_WRITE_FAILED 1u /*  Ref to DemEvent (EEP_E_WRITE_FAILED)  */
#define EEP_E_ERASE_FAILED 1u /*  Ref to DemEvent (EEP_E_ERASE_FAILED)  */
