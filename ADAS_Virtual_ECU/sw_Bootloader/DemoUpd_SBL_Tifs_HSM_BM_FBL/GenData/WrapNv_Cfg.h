...
#define WRAPNV_RECORD_ID_SWC_CONFIGMGRVIN_ORIGINALVAL 0x24u

/** fileHeader */
#define WRAPNV_DATASET_FILEHEADER            0x09u
#define WRAPNV_RECORD_ID_FILEHEADERINFO      0x25u
#define WRAPNV_RECORD_ID_UUID                0x26u

/** CertAccessInfo */
#define WRAPNV_DATASET_CERTACCESSINFO        0x0Au
#define WRAPNV_RECORD_ID_ISSUERNME           0x27u
#define WRAPNV_RECORD_ID_SERIALNUMBER        0x28u

/** Maximum ID of a DataElement */
#define WRAPNV_RECORD_ID_MAX                 0x28u
...
#define kWrapNvNrOfBlock                     0x1Bu
#define kWrapNvNrOfRecord                    0x29u
