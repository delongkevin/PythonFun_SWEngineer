...
#define CsmConf_CsmJob_CsmJob_GVCS_UpdateCertStore                                                  3u 
#define CsmConf_CsmJob_CsmJob_GetRoleFromTesterCertificate                                          4u 
#define CsmConf_CsmJob_CsmJob_MacGenerate                                                           5u 
#define CsmConf_CsmJob_CsmJob_MacVerify                                                             6u 
#define CsmConf_CsmJob_CsmJob_SignatureVerify_ADA                                                   7u 
#define CsmConf_CsmJob_CsmJob_TRNGGen                                                               8u 
...
#define CsmConf_CsmKey_CsmKey_Sha256Result                                                          8u 
...
#define Csm_GetSizeOfJobInfoOfPCConfig()                                                            9u  /**< the number of accomplishable value elements in Csm_JobInfo */
#define Csm_GetSizeOfJobOfPCConfig()                                                                5u  /**< the number of accomplishable value elements in Csm_Job */
#define Csm_GetSizeOfJobPrimitiveInfoOfPCConfig()                                                   9u  /**< the number of accomplishable value elements in Csm_JobPrimitiveInfo */
#define Csm_GetSizeOfJobTableOfPCConfig()                                                           9u  /**< the number of accomplishable value elements in Csm_JobTable */
#define Csm_GetSizeOfKeyOfPCConfig()                                                                9u  /**< the number of accomplishable value elements in Csm_Key */
#define Csm_GetSizeOfPrimitiveInfoOfPCConfig()                                                      9u  /**< the number of accomplishable value elements in Csm_PrimitiveInfo */
...
/*lint -restore */
extern CONST(Crypto_JobInfoType, CSM_CONST) Csm_JobInfo[9];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Crypto_JobPrimitiveInfoType, CSM_CONST) Csm_JobPrimitiveInfo[9];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Csm_JobTableType, CSM_CONST) Csm_JobTable[9];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Csm_KeyType, CSM_CONST) Csm_Key[9];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Crypto_PrimitiveInfoType, CSM_CONST) Csm_PrimitiveInfo[9];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Csm_JobStateType, CSM_VAR_NOINIT) Csm_JobState[9];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Csm_SizeOfJobType, CSM_VAR_NOINIT) Csm_JobToObjMap[9];
#define CSM_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
