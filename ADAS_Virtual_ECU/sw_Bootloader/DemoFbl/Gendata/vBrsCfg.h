...
/* CAN Clock (Hz) */
#define BRS_CAN_CLOCK 19200000

/* Frequency, used for PLL calculation of I2C driver peripheral clock. */
/* I2C Clock (Hz) */
#define BRS_I2C_CLOCK 19200000
...
#define BRS_ENABLE_I2C_SUPPORT

/* Enable the configuration of communication channel 0. */
...
#define BRS_DRVCAN_HEADER_FILENAME "Can_30_Mcan.h"
#define BRS_DRVCAN_EXCLUSIVE_AREA_INFIX(a, b) void SchM_##a##_Can_30_Mcan_CAN_30_MCAN_##b(void)
#define BRS_DRVCAN_ControllerInterrupts_INFIX(a) Can_30_Mcan_##a##ControllerInterrupts
