...
#define CryIfConf_CryIfChannel_CryIfChannel_Hal                                                     1u 
#define CryIfConf_CryIfChannel_CryIfChannel_vHsm_Core                                               2u 
#define CryIfConf_CryIfChannel_CryIfChannel_vHsm_GVCS                                               3u 
#define CryIfConf_CryIfChannel_CryIfChannel_vHsm_KeyMRemote                                         4u 
#define CryIfConf_CryIfChannel_CryIfChannel_vHsm_LibCv                                              5u 
...
#define CryIfConf_CryIfKey_CryIfKey_CryIfKey_RsaSignatureVerifyKey_CodeSign_App_L4                  4u 
#define CryIfConf_CryIfKey_CryIfKey_CryIfKey_SecondCounter                                          5u 
#define CryIfConf_CryIfKey_CryIfKey_CryIfKey_Sha256Result                                           6u 
#define CryIfConf_CryIfKey_CryIfKey_Mac_Crypto_30_vHsm                                              7u 
#define CryIfConf_CryIfKey_CryIfKey_Random                                                          8u 
#define CryIfConf_CryIfKey_CryIfKey_SecureLog                                                       9u 
...
#define CryIf_GetSizeOfChannelOfPCConfig()                                                          6u  /**< the number of accomplishable value elements in CryIf_Channel */
#define CryIf_GetSizeOfCryptoFunctionsOfPCConfig()                                                  1u  /**< the number of accomplishable value elements in CryIf_CryptoFunctions */
#define CryIf_GetSizeOfKeyOfPCConfig()                                                              10u  /**< the number of accomplishable value elements in CryIf_Key */
...
/*lint -restore */
extern CONST(CryIf_ChannelType, CRYIF_CONST) CryIf_Channel[6];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(CryIf_KeyType, CRYIF_CONST) CryIf_Key[10];
#define CRYIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
