 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: I2c_PBcfg.c
 *   Generation Time: 2024-12-03 15:57:18
...
static CONST(I2c_ChannelType, I2C_CONST) I2c_I2cConfigSet_I2cSequence_Eep_Read_ChannelList[2]; 
...
/* PRQA S 0777 1 */  /* MD_MSR_5.1_777 */ 
static CONST(I2c_ChannelType, I2C_CONST) I2c_I2cConfigSet_I2cSequence_Eep_Write_ChannelList[2]; 
...
/* PRQA S 0777 1 */  /* MD_MSR_5.1_777 */ 
static CONST(I2c_ChannelType, I2C_CONST) I2c_I2cConfigSet_I2cSequence_Eep_Ack_ChannelList[1]; 
...
{
  {
    I2cConf_I2cHardwareUnit_I2cHardwareUnit /*  Hardware unit.  */ , 
...
{
  {
    I2cConf_I2cBus_I2cBus /*  Bus identifier.  */ , 
    &I2c_ConstHwUnitDescrList_I2cConfigSet[0] /*  Pointer to bus hardware configuration.  */ , 
    10u /*  Bus timeout (in "Main Function Period" cycles).  */ , 
    { /*  Values specifying the baudrate.   */ 
      0x08u /*  I2C SCL Low Time register value (I2C_SCLL register).  */ , 
      0x0Au /*  I2C SCL High Time register value (I2C_SCLH register).  */ , 
      0x07u /*  I2C Clock Prescaler register value (I2C_PSC register).  */ 
    }
  }
};
...
static CONST(I2c_ChannelType, I2C_CONST) I2c_I2cConfigSet_I2cSequence_Eep_Read_ChannelList[2] =
{
  I2cConf_I2cChannel_I2cChannel_Eep_Read_Command, 
  I2cConf_I2cChannel_I2cChannel_Eep_Read_Data
};
...
static CONST(I2c_ChannelType, I2C_CONST) I2c_I2cConfigSet_I2cSequence_Eep_Write_ChannelList[2] =
{
  I2cConf_I2cChannel_I2cChannel_Eep_Write_Command, 
  I2cConf_I2cChannel_I2cChannel_Eep_Write_Data
};
...
static CONST(I2c_ChannelType, I2C_CONST) I2c_I2cConfigSet_I2cSequence_Eep_Ack_ChannelList[1] =
{
  I2cConf_I2cChannel_I2cChannel_Eep_Ack_Ack
};
...
{
  {
    I2cConf_I2cChannel_I2cChannel_Eep_Read_Command /*   Channel id: 0  */ , 
    0x0050u /*  Slave address.  */ , 
    0xFFu /*  Default data.  */ , 
  ...
  {
    I2cConf_I2cChannel_I2cChannel_Eep_Read_Data /*   Channel id: 1  */ , 
    0x0050u /*  Slave address.  */ , 
    0xFFu /*  Default data.  */ , 
    FALSE /*  Chained attribute.  */ , 
  ...
  {
    I2cConf_I2cChannel_I2cChannel_Eep_Write_Command /*   Channel id: 2  */ , 
    0x0050u /*  Slave address.  */ , 
    0xFFu /*  Default data.  */ , 
    FALSE /*  Chained attribute.  */ , 
  ...
  {
    I2cConf_I2cChannel_I2cChannel_Eep_Write_Data /*   Channel id: 3  */ , 
    0x0050u /*  Slave address.  */ , 
    0xFFu /*  Default data.  */ , 
  ...
  {
    I2cConf_I2cChannel_I2cChannel_Eep_Ack_Ack /*   Channel id: 4  */ , 
    0x0050u /*  Slave address.  */ , 
    0xFFu /*  Default data.  */ , 
    FALSE /*  Chained attribute.  */ , 
...
{
  {
    I2cConf_I2cSequence_I2cSequence_Eep_Read /*  Sequence identifier.  */ , 
    Eep_30_XXi2c01_ComEnd /*  End notification function.  */ , 
    Eep_30_XXi2c01_ComEnd /*  Error notification function.  */ , 
    &I2c_VarSeqDescrList_I2cConfigSet[0] /*  Pointer to runtime data.  */ , 
    I2c_I2cConfigSet_I2cSequence_Eep_Read_ChannelList /*  Channel mapping.  */ , 
  ...
  {
    I2cConf_I2cSequence_I2cSequence_Eep_Write /*  Sequence identifier.  */ , 
    Eep_30_XXi2c01_ComEnd /*  End notification function.  */ , 
    Eep_30_XXi2c01_ComEnd /*  Error notification function.  */ , 
    &I2c_VarSeqDescrList_I2cConfigSet[1] /*  Pointer to runtime data.  */ , 
    I2c_I2cConfigSet_I2cSequence_Eep_Write_ChannelList /*  Channel mapping.  */ , 
    2u /*  No. of channels in sequence.  */ , 
    &I2c_ConstBusDescrList_I2cConfigSet[0] /*  Bus configuration.  */ , 
    FALSE /*  Handle NACK as error.  */ , 
    1u /*  Sequence queue priority.  */ 
  ...
  {
    I2cConf_I2cSequence_I2cSequence_Eep_Ack /*  Sequence identifier.  */ , 
    Eep_30_XXi2c01_ComEnd /*  End notification function.  */ , 
    Eep_30_XXi2c01_ComEnd /*  Error notification function.  */ , 
    &I2c_VarSeqDescrList_I2cConfigSet[2] /*  Pointer to runtime data.  */ , 
    I2c_I2cConfigSet_I2cSequence_Eep_Ack_ChannelList /*  Channel mapping.  */ , 
