...
#define EaConf_EaBlockConfiguration_EaBlockConfiguration_SecureLogGroup1                         448u 
#define EaConf_EaBlockConfiguration_EaBlockConfiguration_SecureLogGroup2                         464u 
#define EaConf_EaBlockConfiguration_EaBlockDescriptor_SecondCounter                              480u 
#define EaConf_EaBlockConfiguration_EaBlockDescriptor_SystemTimestamp                            496u 
