...
#endif
#define CRYPTO_30_VHSM_NOBUFFERING_ENABLED                                                          STD_ON
...
#define CRYPTO_30_VHSM_INTERRUPT_MODE                                                               STD_OFF 
...
#define CRYPTO_30_VHSM_WAITLOOPCALLOUTOFVHSM                                                        STD_ON
...
#define CRYPTO_30_VHSM_WAITLOOPCALLOUTOFVHSMOFPCCONFIG                                              STD_ON
/** 
  \}
*/ 
...
#define Crypto_30_vHsm_IsInterruptModeOfvHsmOfPCConfig()                                            (((FALSE)) != FALSE)
...
#define Crypto_30_vHsm_GetSizeOfSharedDataBufferOfPCConfig()                                        1811u  /**< the number of accomplishable value elements in Crypto_30_vHsm_SharedDataBuffer */
...
#define Crypto_30_vHsm_GetWaitLoopCalloutOfvHsmOfPCConfig()                                         vMemAccM_MainFunction_wrapper
/** 
  \}
*/ 
...
#define Crypto_30_vHsm_GetWaitLoopCalloutOfvHsm()                                                   Crypto_30_vHsm_GetWaitLoopCalloutOfvHsmOfPCConfig()
/** 
  \}
*/ 
...
#define Crypto_30_vHsm_HasWaitLoopCalloutOfvHsm()                                                   (TRUE != FALSE)
...
#define Crypto_30_vHsm_HasWaitLoopCalloutOfvHsmOfPCConfig()                                         (TRUE != FALSE)
/** 
  \}
*/ 
...
/**   \brief  value based type definition for Crypto_30_vHsm_WaitLoopCalloutOfvHsm */
typedef uint32 Crypto_30_vHsm_WaitLoopCalloutOfvHsmType;
...
typedef struct Crypto_30_vHsm_SharedDataBufferStructSTag
{
  ...
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_Core;
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_GVCS[116];
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_Hal[524];
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_KeyMRemote[8];
  ...
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_LibCv_HighPrio;
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  Crypto_30_vHsm_SharedDataBufferType raw[1811];
...
/**   \brief  type used to point to Crypto_30_vHsm_WaitLoopCalloutOfvHsmOfPCConfig */
typedef P2CONST(Crypto_30_vHsm_WaitLoopCalloutOfvHsmType, TYPEDEF, CRYPTO_30_VHSM_CONST) Crypto_30_vHsm_WaitLoopCalloutOfvHsmOfPCConfigPtrType;
...
/**********************************************************************************************************************
 *  vMemAccM_MainFunction_wrapper()
 *********************************************************************************************************************/
/*! \brief       Notification about ongoing waiting for a response from the vHsm Firmware for a synchronous job.
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
extern FUNC(void, CRYPTO_30_VHSM_APPL_CODE) vMemAccM_MainFunction_wrapper(void);
