...
extern void TimeStampIncrement(void);
extern void CheckAuthCertiValidity(void);
extern Std_ReturnType getEpochTime(uint8* LocSystemTime, uint32* LocTimestampCounter);

/***********************************************************************************************************************
 *  EXTERNAL DATA
 **********************************************************************************************************************/

extern boolean IsSystemTimeSet;
extern uint8 SystemTime[15];
extern uint32 SecondCounter;
extern uint32 TimestampCounter;
extern boolean CheckCertSessionValid;
extern boolean CertificateExpired;
extern vuint8 s_BootUpdater;
#endif /* FBL_APNV_H */
