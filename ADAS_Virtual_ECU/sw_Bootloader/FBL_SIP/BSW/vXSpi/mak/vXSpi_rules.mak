...
#------------------------------------------------------------------------------
# 1.00.00   2021-07-09  virzln  Initial version
# 2.00.00   2022-03-15  virzln  update to vXSpi_Common template
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD        += vXSpi
vXSpi_FILES                = vXSpi$(BSW_SRC_DIR)\vXSpi.c \
                             vXSpi$(BSW_SRC_DIR)\vXSpi_Peripheral.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += $(vXSpi_FILES)
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\vXSpi_Cfg.c
