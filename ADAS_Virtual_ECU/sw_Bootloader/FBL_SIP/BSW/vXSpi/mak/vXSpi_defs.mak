...
# REVISION HISTORY
#------------------------------------------------------------------------------
# Refer to the I2c_rules.mak file.
############################################################################### 
...
VXSPI_CORE_PATH       =   vXSpi$(BSW_SRC_DIR)


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


VXSPI_OUTPUT_PATH     =   $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(VXSPI_CORE_PATH)  $(VXSPI_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
