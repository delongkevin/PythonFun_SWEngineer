...
typedef struct Fee_30_FlexNor_SecureChunk
{
    ...
    Fee_30_FlexNor_MarkerType StartMarker;                   /*!< Stores the start marker of the chunk. */
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_CheckInstanceValidity(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);
