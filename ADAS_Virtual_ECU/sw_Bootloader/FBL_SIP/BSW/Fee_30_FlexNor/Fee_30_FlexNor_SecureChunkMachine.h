 ...
 *  FILE DESCRIPTION
 *  ------------------------------------------------------------------------------------------------------------------*/
/*!        \file  Fee_30_FlexNor_SecureChunkMachine.h
 *        \brief  State machine prototypes for secure chunk
 *      \details  Provides the prototypes for the state machine implementation of the secure chunk unit.
 *         \unit  SecureChunk
 *********************************************************************************************************************/
...
#if !defined (FEE_30_FLEXNOR_SECURECHUNKMACHINE_H)
# define FEE_30_FLEXNOR_SECURECHUNKMACHINE_H
 ...
 *  \synchronous    TRUE
 *********************************************************************************************************************/
FUNC(Fee_30_FlexNor_ScheduleBehaviorType, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_DefaultProcessEvent(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);
 ...
 *  \synchronous    TRUE
 *********************************************************************************************************************/
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_DefaultFailEvent(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);
 ...
 *  \synchronous    TRUE
 *********************************************************************************************************************/
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ValidateChunkHeader_OnEnter(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);
 ...
 *  \synchronous    TRUE
 *********************************************************************************************************************/
FUNC(Fee_30_FlexNor_ScheduleBehaviorType, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ValidateChunkHeader_ProcessEvent(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);
 ...
 *  \synchronous    TRUE
 *********************************************************************************************************************/
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_WritePredecessorLink_OnEnter(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);
 ...
 *  \synchronous    TRUE
 *********************************************************************************************************************/
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_WriteInstance_OnEnter(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);
...
#endif /* FEE_30_FLEXNOR_SECURECHUNKMACHINE_H */

/**********************************************************************************************************************
 *  END OF FILE: Fee_30_FlexNor_SecureChunkMachine.h
 *********************************************************************************************************************/
