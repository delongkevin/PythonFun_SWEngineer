...
FEE_30_FLEXNOR_LOCAL Fee_30_FlexNor_SecureChunk_ContextType Fee_30_FlexNor_SecureChunkStmContext;
...
FEE_30_FLEXNOR_LOCAL Fee_30_FlexNor_DataType Fee_30_FlexNor_SecureChunkBuffer[FEE_30_FLEXNOR_CHUNKBUFFER_SIZE]; /* PRQA S 3218 */ /* MD_Fee_30_FlexNor_StateFileScopeStatic */
...
/**********************************************************************************************************************
 * Fee_30_FlexNor_SecureChunk_GetAlignedStartMarkerSize()
 *********************************************************************************************************************/
/*! \brief       Gets the aligned size of the start marker
 *  \details     -
 *  \param[in]   pageAlignment               Page alignment in bytes
 *  \return      The aligned size of the start marker
 *  \pre         -
 *  \context     TASK
 *  \reentrant   TRUE
 *  \synchronous TRUE
 *********************************************************************************************************************/
FEE_30_FLEXNOR_LOCAL_INLINE FUNC(uint32, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_GetAlignedStartMarkerSize(uint16 pageAlignment);
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FEE_30_FLEXNOR_LOCAL_INLINE FUNC(uint32, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_GetAlignedCommitMarkerSize(uint16 interferenceFreeAlignment);
...
/**********************************************************************************************************************
 * Fee_30_FlexNor_SecureChunk_ParseProperties()
 *********************************************************************************************************************/
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FEE_30_FLEXNOR_LOCAL FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ParseProperties(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);

/**********************************************************************************************************************
 * Fee_30_FlexNor_SecureChunk_ParseChunkMetadata()
 *********************************************************************************************************************/
/*! \brief       Parses the metadata of the given context.
 *  \details     Parses the metadata of the given context and saves the value of the read markers.
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FEE_30_FLEXNOR_LOCAL FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ParseChunkMetadata(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);

/**********************************************************************************************************************
 * Fee_30_FlexNor_SecureChunk_ValidatePropertiesChecksum()
 *********************************************************************************************************************/
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FEE_30_FLEXNOR_LOCAL FUNC(Std_ReturnType, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ValidatePropertiesChecksum(Fee_30_FlexNor_SecureChunk_ConstContextPtrType ctx);

/**********************************************************************************************************************
 * Fee_30_FlexNor_SecureChunk_ValidateLinkChecksum()
 *********************************************************************************************************************/
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FUNC(Std_ReturnType, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ValidateLinkChecksum(Fee_30_FlexNor_SecureChunk_ConstContextPtrType ctx);
...
FEE_30_FLEXNOR_LOCAL FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_SetChunkPropertiesToBuffer(
    Fee_30_FlexNor_SecureChunk_ContextPtrType ctx, Fee_30_FlexNor_LengthType propertiesOffset);

/**********************************************************************************************************************
 * Fee_30_FlexNor_SecureChunk_ParseChunkLink()
 *********************************************************************************************************************/
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ParseChunkLink(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx);
...
FEE_30_FLEXNOR_LOCAL_INLINE FUNC(uint32, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_GetAlignedCommitMarkerSize(uint16 interferenceFreeAlignment)
{
    return Fee_30_FlexNor_Shared_Align(sizeof(Fee_30_FlexNor_CommitMarker), interferenceFreeAlignment);
}
...
FEE_30_FLEXNOR_LOCAL_INLINE FUNC(uint32, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_GetAlignedMetadataSize(uint16 pageAlignment, uint16 interferenceFreeAlignment)
{
    ...
    uint32 alignedCommitMarkerSize = Fee_30_FlexNor_SecureChunk_GetAlignedCommitMarkerSize(interferenceFreeAlignment);
...
FEE_30_FLEXNOR_LOCAL_INLINE FUNC(uint32, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_GetCommitMarkerOffset(uint16 pageAlignment, uint16 interferenceFreeAlignment)
{
    ...
    uint32 alignedStartMarkerSize = Fee_30_FlexNor_SecureChunk_GetAlignedStartMarkerSize(pageAlignment);
    return Fee_30_FlexNor_Shared_Align(alignedStartMarkerSize + chunkPropertiesSize, interferenceFreeAlignment);
}
...
FEE_30_FLEXNOR_LOCAL FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ParseProperties(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx)
{
    ...
    uint32 blockIdBeginOffset = Fee_30_FlexNor_SecureChunk_GetAlignedStartMarkerSize(ctx->PartitionConfig->PageAlignment);
    ...
    uint32 metadataChecksumBeginOffset = instanceCountBeginOffset + sizeof(Fee_30_FlexNor_InstanceCountType) + sizeof(uint8); /* Reserved byte */
    ...
    Fee_30_FlexNor_SecureChunk_ParseChunkLink(ctx); /* SBSW_Fee_30_FlexNor_FunctionCallWithContext */
}
...
FEE_30_FLEXNOR_LOCAL FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ParseChunkMetadata(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx)
{
    ...
    commitMarkerOffset = Fee_30_FlexNor_SecureChunk_GetCommitMarkerOffset(ctx->PartitionConfig->PageAlignment, ctx->PartitionConfig->InterferenceFreeAlignment);

    ctx->Chunk.StartMarker = Fee_30_FlexNor_Shared_GetMarker(ctx->ChunkBuffer, 0); /* SBSW_Fee_30_FlexNor_ContextPointerAccess */ /* SBSW_Fee_30_FlexNor_FunctionCallWithContextPointer */
    ...
    Fee_30_FlexNor_SecureChunk_ParseProperties(ctx); /* SBSW_Fee_30_FlexNor_FunctionCallWithContext */
}
...
FEE_30_FLEXNOR_LOCAL FUNC(Std_ReturnType, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ValidatePropertiesChecksum(Fee_30_FlexNor_SecureChunk_ConstContextPtrType ctx)
{
    ...
    Fee_30_FlexNor_LengthType propertiesOffset = Fee_30_FlexNor_SecureChunk_GetAlignedStartMarkerSize(ctx->PartitionConfig->PageAlignment);
    Fee_30_FlexNor_LengthType propertiesLengthWithoutChecksum = (Fee_30_FlexNor_LengthType)Fee_30_FlexNor_SecureChunk_GetChunkPropertiesSize() - sizeof(Fee_30_FlexNor_ChecksumType);
...
{
    Std_ReturnType checkResult = E_NOT_OK;
    Fee_30_FlexNor_LengthType linkOffset = Fee_30_FlexNor_SecureChunk_GetAlignedMetadataSize(ctx->PartitionConfig->PageAlignment, ctx->PartitionConfig->InterferenceFreeAlignment);
 ...
 */
FEE_30_FLEXNOR_LOCAL FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_SetChunkPropertiesToBuffer(
    Fee_30_FlexNor_SecureChunk_ContextPtrType ctx, Fee_30_FlexNor_LengthType propertiesOffset)  /* PRQA S 3673 */ /* MD_Fee_30_FlexNor_CouldBeConstPointer */
{
...
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ParseChunkLink(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx)
{
    ...
    uint32 chunklinkOffsetBegin = Fee_30_FlexNor_SecureChunk_GetAlignedMetadataSize(ctx->PartitionConfig->PageAlignment, ctx->PartitionConfig->InterferenceFreeAlignment);
    ...
    else 
    {
        ...
        if(Fee_30_FlexNor_SecureChunk_ValidateLinkChecksum(ctx) == E_OK) /* SBSW_Fee_30_FlexNor_FunctionCallWithContext */
        {
...
{
    Fee_30_FlexNor_SecureChunkStmContext.ChunkBuffer = Fee_30_FlexNor_SecureChunkBuffer;
...
/**********************************************************************************************************************
 * Fee_30_FlexNor_SecureChunk_CheckInstanceValidity()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 *
 */
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_CheckInstanceValidity(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx) /* PRQA S 3673 */ /* MD_Fee_30_FlexNor_CouldBeConstPointer */
{
 ...
 *
 */
FUNC(Std_ReturnType, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ValidateChunkHeader(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx)
{
    ...
    Fee_30_FlexNor_SecureChunk_ParseChunkMetadata(ctx); /* SBSW_Fee_30_FlexNor_FunctionCallWithContext */

    erasedMarker = Fee_30_FlexNor_Shared_GetEmptyMarker(ctx->PartitionConfig->ErasedValue);
    if(ctx->Chunk.StartMarker == Fee_30_FlexNor_StartMarker)
    {        
        /* Valid start marker */
        ...
        else if (ctx->Chunk.CommitMarker == erasedMarker)
        {
            ...
            if(Fee_30_FlexNor_SecureChunk_ValidatePropertiesChecksum(ctx) == E_OK) /* SBSW_Fee_30_FlexNor_FunctionCallWithContext */
            {
                /* Metadata is valid */
    ...
    else if(ctx->Chunk.StartMarker == erasedMarker)
    {
        /* Start marker empty */
 ...
 *
 */
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_ReadChunkHeader(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx) /* PRQA S 3673 */ /* MD_Fee_30_FlexNor_CouldBeConstPointer */
{        
    Fee_30_FlexNor_LengthType headerLength;
    headerLength = Fee_30_FlexNor_SecureChunk_GetAlignedHeaderSize(ctx->PartitionConfig->PageAlignment, ctx->PartitionConfig->InterferenceFreeAlignment);
    ...
    Fee_30_FlexNor_ResultCallback resultCbk)
{
    ...
    Fee_30_FlexNor_SecureChunkStmContext.InstanceToWrite = instanceToWrite;
    Fee_30_FlexNor_SecureChunkStmContext.ResultCallback = resultCbk;
 ...
 *
 */
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_WriteStartMarker(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx) /* PRQA S 3673 */ /* MD_Fee_30_FlexNor_CouldBeConstPointer */
{
    Fee_30_FlexNor_LengthType alignedStartMarkerSize;    
    alignedStartMarkerSize = Fee_30_FlexNor_Shared_Align(sizeof(Fee_30_FlexNor_StartMarker), ctx->PartitionConfig->PageAlignment);

    Fee_30_FlexNor_Shared_SetBufferValues(ctx->ChunkBuffer, alignedStartMarkerSize, ctx->PartitionConfig->ErasedValue); /* SBSW_Fee_30_FlexNor_FunctionCallWithContextPointer */
    Fee_30_FlexNor_Shared_SetMarker(Fee_30_FlexNor_StartMarker, ctx->ChunkBuffer); /* SBSW_Fee_30_FlexNor_FunctionCallWithContextPointer */
 ...
 *
 */
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_WriteProperties(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx) /* PRQA S 3673 */ /* MD_Fee_30_FlexNor_CouldBeConstPointer */
{
    ...
    propertiesSize = Fee_30_FlexNor_SecureChunk_GetChunkPropertiesSize();
    alignedStartMarkerSize = Fee_30_FlexNor_SecureChunk_GetAlignedStartMarkerSize(ctx->PartitionConfig->PageAlignment);
    ...
    checksumOffset = sizeof(Fee_30_FlexNor_BlockIdType) + sizeof(Fee_30_FlexNor_PayloadSizeType) + sizeof(Fee_30_FlexNor_InstanceCountType) + 0x01u; /* +1u because of the reserved byte */
 ...
 *
 */
FUNC(void, FEE_30_FLEXNOR_CODE) Fee_30_FlexNor_SecureChunk_WriteCommitMarker(Fee_30_FlexNor_SecureChunk_ContextPtrType ctx) /* PRQA S 3673 */ /* MD_Fee_30_FlexNor_CouldBeConstPointer */
{
    Fee_30_FlexNor_LengthType commitMarkerOffset;
