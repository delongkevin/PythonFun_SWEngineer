...
#------------------------------------------------------------------------------
# 1.00.00   2020-06-14  virzln  Initial version
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += I2c
I2c_FILES                = I2c$(BSW_SRC_DIR)\I2c.c I2c$(BSW_SRC_DIR)\I2c_PerMgr.c I2c$(BSW_SRC_DIR)\I2c_PrioQueueMgr.c I2c$(BSW_SRC_DIR)\I2c_TransProc.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += $(I2c_FILES)
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
#-------------------------------------------------------------------------------------------------
# only define new directories, OBJ, LIB, LOG were created automatically
#-------------------------------------------------------------------------------------------------
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\I2c_PBcfg.c $(GENDATA_DIR)\I2c_Irq.c
