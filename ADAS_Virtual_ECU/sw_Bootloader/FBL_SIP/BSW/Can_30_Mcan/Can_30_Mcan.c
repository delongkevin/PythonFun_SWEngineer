...
| 2023-03-30 5.13.00  Hum - CANHAL-2257  : Add support for MSPM0
| 2023-04-14 5.13.01  Meid- ESCAN00114324: Erroneous Rx Indication when using Rx BasicCANs
|************************************************************************** */
...
#if (CAN_30_MCAN_COREVERSION           != 0x1002u) /* \trace SPEC-1699 */
# error "Source and Header file are inconsistent!"
#endif
#if (CAN_30_MCAN_RELEASE_COREVERSION   != 0x00u)
# error "Source and Header file are inconsistent!"
#endif
...
#endif
#if( DRVCAN_MPC5700MCANASR_VERSION != 0x0513)
# error "Source and Header file are inconsistent!"
#endif
...
# if defined(C_30_MCAN_ENABLE_MULTIPLE_BASICCAN_TX)
  for (; mailboxHandle < Can_30_Mcan_GetTxBasicHandleStop(canHwChannel); mailboxHandle++) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* FETA_CAN_HL01 */
# endif
  {
# if defined(C_30_MCAN_ENABLE_MULTIPLEXED_TRANSMISSION) || defined(C_30_MCAN_ENABLE_TX_HW_FIFO)
    for (mailboxElement = 0u; mailboxElement < Can_30_Mcan_GetMailboxSize(mailboxHandle); mailboxElement++) /* PRQA S 2880 */ /*  MD_MSR_Unreachable */ /* FETA_CAN_HL01 */
# else
...
# if defined(C_30_MCAN_ENABLE_TX_FULLCAN_OBJECTS)
  ...
  for (mailboxHandle = Can_30_Mcan_GetTxFullHandleStart(canHwChannel); mailboxHandle < Can_30_Mcan_GetTxFullHandleStop(canHwChannel); mailboxHandle++) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* FETA_CAN_HL01 */
  {
...
# endif
    ...
    txPara->frameLen = CAN_30_MCAN_DLC2LEN(CAN_30_MCAN_LEN2DLC(txPara->messageLen)); /* SBSW_CAN_HL42 */
#endif
...
# endif
  ...
  for (initPara->mailboxHandle = Can_30_Mcan_GetTxFullHandleStart(canHwChannel); initPara->mailboxHandle < Can_30_Mcan_GetTxFullHandleStop(canHwChannel); initPara->mailboxHandle++) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* SBSW_CAN_HL36 */ /* SBSW_CAN_HL36 */ /* FETA_CAN_HL01 */
...
#if defined(C_30_MCAN_ENABLE_MULTIPLE_BASICCAN_TX)
  for (; initPara->mailboxHandle < Can_30_Mcan_GetTxBasicHandleStop(canHwChannel); initPara->mailboxHandle++) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* SBSW_CAN_HL36 */ /* FETA_CAN_HL01 */
#endif
...
# endif
  ...
  /* ----- Implementation ----------------------------------------------- */
  initOk = kCan_30_McanOk;
  for (initPara->mailboxHandle = Can_30_Mcan_GetRxFullHandleStart(canHwChannel); initPara->mailboxHandle < Can_30_Mcan_GetRxFullHandleStop(canHwChannel); initPara->mailboxHandle++) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* SBSW_CAN_HL36 */ /* SBSW_CAN_HL36 */ /* FETA_CAN_HL01 */
...
# endif
  ...
  /* ----- Implementation ----------------------------------------------- */
  initOk = kCan_30_McanOk;
  for (initPara->mailboxHandle = Can_30_Mcan_GetRxBasicHandleStart(canHwChannel); initPara->mailboxHandle < Can_30_Mcan_GetRxBasicHandleStop(canHwChannel); initPara->mailboxHandle++) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* SBSW_CAN_HL36 */ /* SBSW_CAN_HL36 */ /* FETA_CAN_HL01 */
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanHL_30_Mcan_RxBasicCanPolling( CAN_30_MCAN_HW_CHANNEL_CANTYPE_ONLY )
{
  ...
  if(CanLL_30_Mcan_RxBasicIsGlobalIndPending(CAN_30_MCAN_HW_CHANNEL_CANPARA_ONLY) == kCan_30_McanTrue) /* PRQA S 2991,2995 */ /* MD_Can_ConstValue */ /* COV_CAN_LL_HARDWARE_BEHAVIOUR */
  {
    ...
    for (taskPara.mailboxHandle = Can_30_Mcan_GetRxBasicHandleStart(canHwChannel); taskPara.mailboxHandle < Can_30_Mcan_GetRxBasicHandleStop(canHwChannel); taskPara.mailboxHandle++) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* FETA_CAN_HL01 */
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanHL_30_Mcan_RxFullCanPolling( CAN_30_MCAN_HW_CHANNEL_CANTYPE_ONLY )
{
  ...
  if(CanLL_30_Mcan_RxFullIsGlobalIndPending(CAN_30_MCAN_HW_CHANNEL_CANPARA_ONLY) == kCan_30_McanTrue) /* PRQA S 2991,2995 */ /* MD_Can_ConstValue */ /* COV_CAN_LL_HARDWARE_BEHAVIOUR */
  {
    ...
    for (taskPara.mailboxHandle = Can_30_Mcan_GetRxFullHandleStart(canHwChannel); taskPara.mailboxHandle < Can_30_Mcan_GetRxFullHandleStop(canHwChannel); taskPara.mailboxHandle++ ) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* FETA_CAN_HL01 */
    {
      taskPara.hwObjHandle = Can_30_Mcan_GetMailboxHwHandle(taskPara.mailboxHandle); /* PRQA S 2880 */ /*  MD_MSR_Unreachable */
#  if defined(C_30_MCAN_ENABLE_INDIVIDUAL_POLLING) /* COV_CAN_HWOBJINDIVPOLLING */
      /* #30 check individual polling flag */
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanHL_30_Mcan_RxQueueExecution( void )
{
  ...
  while ( ( Can_30_Mcan_GetRxQueueInfo().Count != (uint16)0 ) && ( loopTimeout < Can_30_Mcan_GetSizeOfRxQueueBuffer() ) ) /* FETA_CAN_HL04 */
...
#  endif
  {
    ...
    for (subSystemIndex = 0u; subSystemIndex<Can_30_Mcan_GetSizeOfCanSubSystemBaseAdr(); subSystemIndex++) /* FETA_CAN_HL01 */
    {
...
# endif
  ...
  if ((Cn->CCCR & kCanCCCR_INIT) != kCanCCCR_INIT ) /* If Init-Bit is not set */ /* PRQA S 2842,2843 */ /* MD_Can_Assertion,MD_Can_HL_DereferencePointerValue */
  {
    ...
    while( ((Cn->CCCR & kCanCCCR_INIT) == 0UL) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303,2842,2843 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess,MD_Can_Assertion,MD_Can_HL_DereferencePointerValue */ /* COV_CAN_HW_SPECIFIC */ /* FETA_CAN_LL01 */
  ...
  CanLL_30_Mcan_ApplCanTimerStart(kCan_30_McanLoopInit); /* PRQA S 2842 */ /* MD_Can_Assertion */ /* SBSW_CAN_LL_101 */
  while( ((Cn->CCCR & kCanCCCR_CCE) == 0UL) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303,2842,2843 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess,MD_Can_Assertion,MD_Can_HL_DereferencePointerValue */ /* COV_CAN_HW_SPECIFIC */ /* FETA_CAN_LL01 */
...
#if defined(C_30_MCAN_ENABLE_MULTIPLEXED_TRANSMISSION) || defined(C_30_MCAN_ENABLE_TX_HW_FIFO)
  for(; mailboxElement < Can_30_Mcan_GetMailboxSize(initPara->mailboxHandle); mailboxElement++) /* FETA_CAN_HL01 */
#endif
  {
...
#  if defined( C_30_MCAN_ENABLE_STD_ID ) && (kCanNumberOfStandardFilter > 0)  
  for(index = 0u; index < Can_30_Mcan_GetCanSIDFC_LSSOfCanSIDFC(canHwChannel); index++)  /* SBSW_CAN_LL_109 */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* FETA_CAN_HL01 */
  {
...
#  if defined(C_30_MCAN_ENABLE_EXTENDED_ID) && (kCanNumberOfExtendedFilter > 0)
  for(index = 0u; index < Can_30_Mcan_GetCanXIDFC_LSEOfCanXIDFC(canHwChannel); index++)  /* SBSW_CAN_LL_109 */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* FETA_CAN_HL01 */
  { 
...
#  if defined( C_30_MCAN_ENABLE_STD_ID ) && (kCanNumberOfStandardFilter > 0)  /* at least one std filter is available */
  ...
  for(index = 0u; index < Can_30_Mcan_GetCanSIDFC_LSSOfCanSIDFC(canHwChannel); index++) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* FETA_CAN_HL01 */
  { 
...
#  if defined(C_30_MCAN_ENABLE_EXTENDED_ID) && (kCanNumberOfExtendedFilter > 0)
  ...
  for(index = 0u; index < Can_30_Mcan_GetCanXIDFC_LSEOfCanXIDFC(canHwChannel); index++) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* FETA_CAN_HL01 */
  { 
    /* If Filter is configured to ( RXFIFO0 OR RXFIFO1) AND The filter offset matches the HwObjHandle */
...
# if defined(C_30_MCAN_ENABLE_MULTIPLEXED_TRANSMISSION) || defined(C_30_MCAN_ENABLE_RX_BASICCAN_OBJECTS) || defined(C_30_MCAN_ENABLE_TX_HW_FIFO)
  for (;(( mailboxElement < Can_30_Mcan_GetMailboxSize(initPara->mailboxHandle) ) && (ret_val == kCan_30_McanFalse)); mailboxElement++) /* COV_CAN_HARDWARE_FAILURE */ /* FETA_CAN_HL01 */
# endif
  {

    /* If TX Buffer */
    if((((initPara->mailboxHandle) < CAN_30_MCAN_HL_MB_TX_BASIC_STOPINDEX(canHwChannel)) && ((initPara->mailboxHandle) >= CAN_30_MCAN_HL_MB_TX_BASIC_STARTINDEX(canHwChannel))) || /* PRQA S 2992,2996 */ /* MD_Can_ConstValue */
       (((initPara->mailboxHandle) < CAN_30_MCAN_HL_MB_TX_FULL_STOPINDEX(canHwChannel)) && ((initPara->mailboxHandle) >= CAN_30_MCAN_HL_MB_TX_FULL_STARTINDEX(canHwChannel))))/* PRQA S 2992,2996 */ /* MD_Can_ConstValue */ /* COV_CAN_HARDWARE_FAILURE */
    {
...
# if defined( C_30_MCAN_ENABLE_RX_FULLCAN_OBJECTS )
    else if (((initPara->mailboxHandle) < CAN_30_MCAN_HL_MB_RX_FULL_STOPINDEX(canHwChannel)) && ((initPara->mailboxHandle) >= CAN_30_MCAN_HL_MB_RX_FULL_STARTINDEX(canHwChannel))) /* PRQA S 2004 */ /* MD_Can_NoElseAfterIf */ /* COV_CAN_HARDWARE_FAILURE */
    {
...
# endif
    ...
    { /* found valid handle */
      ...
      else
      {
        ...
        for(i = 0u; (i < 3u) && (ret_val == kCan_30_McanFalse); i++) /* COV_CAN_HARDWARE_FAILURE */ /* FETA_CAN_LL02 */
        { /* PRQA S 0303 QAC_Can_0303 */ /* MD_Can_HwAccess */
          vuint8 j;
# if defined (C_30_MCAN_ENABLE_CAN_FD_FULL)
          for(j=0u ; (j < ((Can_30_Mcan_GetMaxDataLenOfMailbox(initPara->mailboxHandle)/4u) + (8u/4u))) && (ret_val == kCan_30_McanFalse);j++) /* Maximum mailbox size pluss 8 byte header */ /* COV_CAN_HARDWARE_FAILURE */ /* FETA_CAN_LL03 */
# else
          for(j=0u; (j <  4u) && (ret_val == kCan_30_McanFalse);j++)  /* 16 byte per mbox */ /* COV_CAN_HARDWARE_FAILURE */ /* FETA_CAN_LL03 */
# endif
          {
...
# if defined(C_30_MCAN_ENABLE_MULTIPLEXED_TRANSMISSION) || defined(C_30_MCAN_ENABLE_TX_HW_FIFO)
    for (;mailboxElement < Can_30_Mcan_GetMailboxSize(taskPara->mailboxHandle); mailboxElement++) /* FETA_CAN_HL01 */
# endif
    {
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_30_Mcan_TxConfSetTxConfStruct(CAN_30_MCAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_FIRST CanTxConfirmationParaStructPtr txConfPara) /* COV_CAN_GENDATA_TX_NOT_IN_ALL_CONFIG */
{
  ...
  {
    vuint8 i;
    for(i=0u ; i< (Can_30_Mcan_GetMaxDataLenOfMailbox(txConfPara->mailboxHandle)/4u) ; i++) /* FETA_CAN_HL01 */
    {
...
# if defined(C_30_MCAN_ENABLE_CAN_FD_FULL)
  ...
  for(indexL = 0u; ( ((indexL << 2u) < fElmSize) && (indexL < (Can_30_Mcan_GetMaxDataLenOfMailbox(rxBasicPara->mailboxHandle)/4u)) ); indexL++) /* ESCAN00113161 - Do not copy/read more than MaxDataLen */ /* FETA_CAN_LL06 */
#else
...
{
  volatile vuint32 dummyRead; /* required for register update */
  ...
  { /* Attention: ACK with Fill Level '0' will result in a endless read loop !!! */
    ...
    *rxBasicPara->pFifoAck    = (rxBasicPara->fGetIndex & 0x0000003FUL); /* SBSW_CAN_LL_109 */  
    dummyRead = ((vuint32)*(vuint32*) rxBasicPara->pFifoStatus); /* ESCAN00114324 */ /* PRQA S 0310,0312 */ /* MD_Can_PointerCast,MD_Can_NoneVolatilePointerCast */
...
# if defined ( C_30_MCAN_ENABLE_CAN_FD_FULL ) || defined ( C_30_MCAN_ENABLE_CAN_FD_USED )
  ...
  {
   ErrorValue = (vuint8)((Can_30_Mcan_GetPSRValue(canHwChannel) & kCanPSR_FLEC) >> 8u);
  }
...
# endif
  ...
  while( (((Cn->RXF0S).B.FnFL) > 0UL) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopRxFifo) != CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* FETA_CAN_LL01 */
  {
...
#if defined( C_30_MCAN_ENABLE_MULTIPLE_BASICCAN )
  CanLL_30_Mcan_ApplCanTimerStart(kCan_30_McanLoopRxFifo); /* SBSW_CAN_LL_102 */  
  while( (((Cn->RXF1S).B.FnFL) > 0UL) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopRxFifo) != CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* FETA_CAN_LL01 */
  {
...
#   endif  
  boolean  retval = kCan_30_McanFalse;
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_30_Mcan_SetAllFilter(CAN_30_MCAN_CHANNEL_CANTYPE_FIRST CanInitParaStructPtr initPara) /* PRQA S 3673 */ /* MD_Can_NoneConstParameterPointer */
{
  ...
  for(initPara->tmpVal = 0; initPara->tmpVal < (Can_30_Mcan_GetCanSIDFC_LSSOfCanSIDFC(canHwChannel)); (initPara->tmpVal)++) /* SBSW_CAN_LL_109 */  /* SBSW_CAN_LL_109 */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* FETA_CAN_HL01 */
...
#if defined(C_30_MCAN_ENABLE_EXTENDED_ID) && (kCanNumberOfExtendedFilter > 0)
  for(initPara->tmpVal = 0; initPara->tmpVal < (Can_30_Mcan_GetCanXIDFC_LSEOfCanXIDFC(canHwChannel)); (initPara->tmpVal)++) /* SBSW_CAN_LL_109 */  /* SBSW_CAN_LL_109 */ /* FETA_CAN_HL01 */
...
# endif
  {
    ...
    CanLL_30_Mcan_ApplCanTimerStart(kCan_30_McanLoopClockStop); /* SBSW_CAN_LL_101 */
    while( ((Cn->CCCR & kCanCCCR_CSA) == 0UL) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopClockStop) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */ /* COV_CAN_HW_SPECIFIC */ /* FETA_CAN_LL01 */
...
# if defined( C_30_MCAN_ENABLE_DYNAMIC_MCAN_REVISION )
  else
  {
    ...
    CanLL_30_Mcan_ApplCanTimerStart(kCan_30_McanLoopInit); /* SBSW_CAN_LL_101 */  
    while( ((Cn->CCCR & kCanCCCR_INIT) == 0UL) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */ /* COV_CAN_HW_SPECIFIC */ /* FETA_CAN_LL01 */
    { /* Assure that INIT has been accepted. */ }
    CanLL_30_Mcan_ApplCanTimerEnd(kCan_30_McanLoopInit); /* SBSW_CAN_LL_101 */  
  }
# endif
...
# if defined( C_30_MCAN_ENABLE_DYNAMIC_MCAN_REVISION )
  else
  {
    ...
    CanLL_30_Mcan_ApplCanTimerStart(kCan_30_McanLoopInit); /* SBSW_CAN_LL_101 */
    while( ((Cn->CCCR & kCanCCCR_CCE) == 0UL) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */ /* COV_CAN_HW_SPECIFIC */ /* FETA_CAN_LL01 */
    { /* Assure that the previous value has been accepted. */ }
    CanLL_30_Mcan_ApplCanTimerEnd(kCan_30_McanLoopInit); /* SBSW_CAN_LL_101 */  
  }
# endif
...
#  endif
  {
    ...
    for (indx=0;indx<Can_30_Mcan_GetSizeOfCanSubSystemBaseAdr(); indx++) /* FETA_CAN_HL01 */
    {
...
# if defined( C_30_MCAN_ENABLE_REGEXT_TCC_PWD ) && !defined (CAN_30_MCAN_TCC_PWD_OFF)
    TCC_CFG->CAN_CFG_WR_PW = Can_30_Mcan_GetCanTccPwdKeyCode();                                                /* SBSW_CAN_LL_128 */ /* PRQA S 0303 */ /* MD_Can_HwAccess */
...
#  endif
    {
      CanLL_30_Mcan_ApplCanTimerStart(kCan_30_McanLoopRxFifo); /* SBSW_CAN_LL_102 */  
      while( (((Cn->RXF1S).B.FnFL) > 0UL) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopRxFifo) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */ /* COV_CAN_HW_SPECIFIC */ /* FETA_CAN_LL01 */
      {
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanInterruptTx(CAN_30_MCAN_HW_CHANNEL_CANTYPE_ONLY)
{
  ...
  { /* Tx Confirmation */
    ...
    while ( (hwObjHdl < kCanTXBC_NDTB) && (Can_30_Mcan_GetCanTXBRP(canHwChannel) > 0UL) ) /* FETA_CAN_LL10 */
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_30_Mcan_StartSilentRequest(CAN_30_MCAN_HW_CHANNEL_CANTYPE_ONLY)
{
  ...
  else
  {
    ...
    /* #30 check current state: if already reached then avoid asynchronous all */
    CanLL_30_Mcan_ApplCanTimerStart(kCan_30_McanLoopInit); /* SBSW_CAN_LL_101 */  
    while( ((Cn->CCCR & (vuint32)(kCanCCCR_MON | kCanCCCR_ASM | kCanCCCR_INIT)) != (kCanCCCR_MON | kCanCCCR_ASM)) && (CanLL_30_Mcan_ApplCanTimerLoop(kCan_30_McanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */ /* COV_CAN_HW_SPECIFIC */ /* FETA_CAN_LL01 */
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanHL_30_Mcan_ControllerErrorStatePassive( CAN_30_MCAN_CHANNEL_CANTYPE_FIRST uint16 RxErrorCounter, uint16 TxErrorCounter )
{
  ...
  CanIf_30_Mcan_ControllerErrorStatePassive(channel, RxErrorCounter, TxErrorCounter);
}
...
V_DEF_30_MCAN_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanHL_30_Mcan_ErrorNotification( CAN_30_MCAN_CHANNEL_CANTYPE_FIRST Can_ErrorType CanError ) /* PRQA S 3219 */ /* MD_Can_HL_UnusedFunction */
{
  ...
  CanIf_30_Mcan_ErrorNotification(channel, CanError);
}
#endif /* CAN_30_MCAN_ENABLE_SECURITY_EVENT_REPORTING */
...
# endif
  {
    ...
    for (baudrateIndex = Can_30_Mcan_GetInitObjectStartIndex(channel); baudrateIndex < Can_30_Mcan_GetInitObjectStartIndex(channel + 1u); baudrateIndex++) /* FETA_CAN_HL01 */
...
# if defined(C_30_MCAN_ENABLE_TX_POLLING) /* COV_CAN_TX_POLLING TX */ /* always true when no hw-cancel is supported */
          ...
          { /* #110 is at least one mailbox pending */
            for ( taskPara.mailboxHandle = Can_30_Mcan_GetTxBasicHandleStart(canHwChannel); taskPara.mailboxHandle < Can_30_Mcan_GetTxBasicHandleStop(canHwChannel); taskPara.mailboxHandle++ ) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* FETA_CAN_HL01 */
...
#  if defined(C_30_MCAN_ENABLE_TX_POLLING) /* COV_CAN_TX_POLLING TX */ /* always true when no hw-cancel is supported */
          ...
          { /* #210 is at least one mailbox pending */
            for ( taskPara.mailboxHandle = Can_30_Mcan_GetTxFullHandleStart(canHwChannel); taskPara.mailboxHandle < Can_30_Mcan_GetTxFullHandleStop(canHwChannel); taskPara.mailboxHandle++ ) /* PRQA S 2994,2996 */ /* MD_Can_ConstValue */ /* FETA_CAN_HL01 */
...
# if defined(C_30_MCAN_ENABLE_MULTIPLEXED_TRANSMISSION) || defined(C_30_MCAN_ENABLE_TX_HW_FIFO) /* \trace SPEC-1677 */
        for (; txCancellationPara.mailboxElement < Can_30_Mcan_GetMailboxSize(Hth); txCancellationPara.mailboxElement++, txCancellationPara.activeSendObject++) /* PRQA S 2463,3387,3418 */ /* MD_Can_HL_AdditionalExpressionInForLoop,MD_Can_HL_UsingIncOrDec,MD_Can_IncompleteForLoop */ /* FETA_CAN_HL05 */
# endif
