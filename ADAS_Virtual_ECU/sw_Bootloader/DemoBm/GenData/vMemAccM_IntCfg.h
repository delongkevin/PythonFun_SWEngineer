...
#define VMEMACCM_MULTIPARTITION_PARTITION_ID        0x00u 

#define VMEMACCM_MULTIPARTITION_NR_OF_PARTITIONS    0x02u 

#define VMEMACCM_MULTIPARTITION_MASTER_PARTITION_ID 0x00u 

#define VMEMACCM_MULTIPARTITION_RESYNC_TOKEN        0xFEu 

#define VMEMACCM_MULTIPARTITION_SYNC_TOKEN          0xFFu 

#define VMEMACCM_MULTIPARTITION_PUBLISH_NOREQUEST   0xFFFFFFFFu 

#define VMEMACCM_PARTITION_USECASE                  VMEMACCM_MULTI_PARTITION_SINGLE_ACCESSOR 
...
#define vMemAccM_GetSizeOfSubAddressAreaOfPCConfig()                                                2u  /**< the number of accomplishable value elements in vMemAccM_SubAddressArea */
...
typedef uint16 vMemAccM_ReadLengthOfAddressAreaType;
...
typedef uint32 vMemAccM_PhysicalStartAddressOfSubAddressAreaType;
...
typedef uint32 vMemAccM_VirtualStartAddressOfSubAddressAreaType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(vMemAccM_SubAddressAreaType, VMEMACCM_CONST) vMemAccM_SubAddressArea[2];
#define VMEMACCM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
extern vMemAccM_PartitionPublishRequestType vMemAccM_PublishReq_vMemAccMMasterPartitionConfiguration_Id0;
...
extern vMemAccM_PartitionPublishRequestPtrType vMemAccM_MultiPartitionPublishedRequests[VMEMACCM_MULTIPARTITION_NR_OF_PARTITIONS];
...
extern vMemAccM_NVRAMAccessTokenPtrType vMemAccM_NVRAMAccessTokenPtr; 
extern vMemAccM_PartitionPublishRequestPtrType vMemAccM_PartitionPublishRequestPtr; 
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */ 
extern vMemAccM_NVRAMAccessTokenType vMemAccM_NVRAMAccessToken; 
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */ 
extern vMemAccM_PublishRequestDataType vMemAccM_PublishReq_Satellite_Id1_Data[VMEMACCM_MULTI_PARTITION_PUBLISH_DATA_SIZE]; 
extern vMemAccM_PartitionPublishRequestType vMemAccM_PublishReq_Satellite_Id1; 
