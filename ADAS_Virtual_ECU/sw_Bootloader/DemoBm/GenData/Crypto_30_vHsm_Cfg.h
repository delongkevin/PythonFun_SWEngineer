...
#define Crypto_30_vHsm_GetSizeOfSharedDataBufferOfPCConfig()                                        1947u  /**< the number of accomplishable value elements in Crypto_30_vHsm_SharedDataBuffer */
...
typedef struct Crypto_30_vHsm_SharedDataBufferStructSTag
{
  ...
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_GVCS[128];
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_Hal[1041];
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_KeyMRemote;
  Crypto_30_vHsm_SharedDataBufferType Crypto_30_vHsm_KeyManagement;
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  Crypto_30_vHsm_SharedDataBufferType raw[1947];
