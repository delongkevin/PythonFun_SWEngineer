...
#define EaConf_EaBlockConfiguration_EaBlockConfiguration_FileHeader                              416u 
#define EaConf_EaBlockConfiguration_EaBlockConfiguration_CertAccessInfo                          432u 
#define EaConf_EaBlockConfiguration_EaBlockConfiguration_SecureLogGroup2                         448u 
#define EaConf_EaBlockConfiguration_EaBlockConfiguration_SecureLogGroup1                         464u 
#define EaConf_EaBlockConfiguration_EaBlockConfiguration_SecondCounter                           480u 
#define EaConf_EaBlockConfiguration_EaBlockConfiguration_SystemTimestamp                         496u 
#define EaConf_EaBlockConfiguration_EaBlockDescriptor_CertificateExpired                         512u 
...
#define EA_NUMBER_OF_PARTITIONS                              (3u)
#define EA_NUMBER_OF_BLOCKS                                  (32u)
