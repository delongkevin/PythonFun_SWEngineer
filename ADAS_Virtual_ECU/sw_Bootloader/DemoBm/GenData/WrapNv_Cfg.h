 ...
 *   |
 *   +-- CertificateExpired           NvMBlockDescriptor_CertificateExpired 0x00000000 Store certificate Expiry due to session second counter(not used in BM)
 *   |
 ...
 *   |
 *   +-- SWC_ConfigMgrVIN_OriginalVal SWC_ConfigMgrVIN_OriginalVal 0x00000000   SWC_ConfigMgrVIN_OriginalVal
 *   |
 ...
 *   |   |
 *   |   +-- IssuerName               NvMBlockDescriptor_CertAccessInfo 0x00000000 FBL ADA  certificate issuer name
 *   |   |
 *   |   +-- SerialNumber             NvMBlockDescriptor_CertAccessInfo 0x0000001A FBL ADA  certificate serialNumber
 *   |
 *   +-- SecureLogGroupOne            NvMBlockDescriptor_SecureLogGroup1 0x00000000
 *   |
 *   +-- SecureLogGroupTwo            NvMBlockDescriptor_SecureLogGroup2 0x00000000
 *   |
 *   +-- SecondCounter                NvMBlockDescriptor_SecondCounter 0x00000000 Second Counter
 *   |
 *   +-- SystemTimestamp              NvMBlockDescriptor_SystemTimestamp 0x00000000 System Timestamp(NotBefore time from received certificate)
 ******************************************************************************************/
...
/** CertificateExpired */
#define WRAPNV_DATASET_CERTIFICATEEXPIRED    0x01u
#define WRAPNV_RECORD_ID_CERTIFICATEEXPIRED  0x00u

/** NvMConfigBlock */
#define WRAPNV_DATASET_NVMCONFIGBLOCK        0x01u
#define WRAPNV_RECORD_ID_NVMCONFIGBLOCK      0x01u

/** ApplUpdate */
#define WRAPNV_DATASET_APPLUPDATE            0x01u
#define WRAPNV_RECORD_ID_APPLUPDATE          0x02u

/** ProgReqFlag */
#define WRAPNV_DATASET_PROGREQFLAG           0x01u
#define WRAPNV_RECORD_ID_PROGREQFLAG         0x03u

/** SecAccessDelayFlag */
#define WRAPNV_DATASET_SECACCESSDELAYFLAG    0x01u
#define WRAPNV_RECORD_ID_SECACCESSDELAYFLAG  0x04u

/** SecAccessInvalidCount */
#define WRAPNV_DATASET_SECACCESSINVALIDCOUNT 0x01u
#define WRAPNV_RECORD_ID_SECACCESSINVALIDCOUNT 0x05u

/** ApplValidity */
#define WRAPNV_DATASET_APPLVALIDITY          0x01u
#define WRAPNV_RECORD_ID_APPLVALIDITY        0x06u

/** DcmDslRxTesterSourceAddr */
#define WRAPNV_DATASET_DCMDSLRXTESTERSOURCEADDR 0x01u
#define WRAPNV_RECORD_ID_DCMDSLRXTESTERSOURCEADDR 0x07u

/** ValidityFlags */
#define WRAPNV_DATASET_VALIDITYFLAGS         0x01u
#define WRAPNV_RECORD_ID_VALIDITYFLAGS       0x08u

/** ExhaustRegulationTan */
#define WRAPNV_DATASET_EXHAUSTREGULATIONTAN  0x01u
#define WRAPNV_RECORD_ID_EXHAUSTREGULATIONTAN 0x09u

/** ResetResponseFlag */
#define WRAPNV_DATASET_RESETRESPONSEFLAG     0x01u
#define WRAPNV_RECORD_ID_RESETRESPONSEFLAG   0x0Au

/** DID_F180_Boot_SW_Ver_Info */
#define WRAPNV_DATASET_DID_F180_BOOT_SW_VER_INFO 0x01u
#define WRAPNV_RECORD_ID_DID_F180_BOOT_SW_VER_INFO 0x0Bu

/** ProgrammingStatus */
#define WRAPNV_DATASET_PROGRAMMINGSTATUS     0x01u
#define WRAPNV_RECORD_ID_PROGRAMMINGSTATUS   0x0Cu

/** Metadata */
#define WRAPNV_DATASET_METADATA              0x0Au
#define WRAPNV_RECORD_ID_FINGERPRINT         0x0Du
#define WRAPNV_RECORD_ID_PROGCOUNTER         0x0Eu
#define WRAPNV_RECORD_ID_PROGATTEMPTS        0x0Fu
#define WRAPNV_RECORD_ID_CRCVALUE            0x10u
#define WRAPNV_RECORD_ID_CRCSTART            0x11u
#define WRAPNV_RECORD_ID_CRCLENGTH           0x12u
#define WRAPNV_RECORD_ID_SOFTWAREIDENTIFICATION 0x13u
#define WRAPNV_RECORD_ID_SWEBOMPARTNUMBER    0x14u
#define WRAPNV_RECORD_ID_MEMORYSTATUS        0x15u
#define WRAPNV_RECORD_ID_SEGMENTCOUNT        0x16u
#define WRAPNV_RECORD_ID_SEGMENTADDRLIST     0x17u
#define WRAPNV_RECORD_ID_SEGMENTLENGTHLIST   0x18u
#define WRAPNV_RECORD_ID_FLASHSTATUS         0x19u

/** VehicleManufEcuSwNumber */
#define WRAPNV_DATASET_VEHICLEMANUFECUSWNUMBER 0x01u
#define WRAPNV_RECORD_ID_VEHICLEMANUFECUSWNUMBER 0x1Au

/** EbomAssemblyPartNumber */
#define WRAPNV_DATASET_EBOMASSEMBLYPARTNUMBER 0x01u
#define WRAPNV_RECORD_ID_EBOMASSEMBLYPARTNUMBER 0x1Bu

/** DID_F18A_FCA_ESLM_Ecu_SW_Cal_Num */
#define WRAPNV_DATASET_DID_F18A_FCA_ESLM_ECU_SW_CAL_NUM 0x01u
#define WRAPNV_RECORD_ID_DID_F18A_FCA_ESLM_ECU_SW_CAL_NUM 0x1Cu

/** DID_F18B_FCA_ESLM_ECU_SW_App_Num */
#define WRAPNV_DATASET_DID_F18B_FCA_ESLM_ECU_SW_APP_NUM 0x01u
#define WRAPNV_RECORD_ID_DID_F18B_FCA_ESLM_ECU_SW_APP_NUM 0x1Du

/** CoDePEcuPartNumber */
#define WRAPNV_DATASET_CODEPECUPARTNUMBER    0x01u
#define WRAPNV_RECORD_ID_CODEPECUPARTNUMBER  0x1Eu

/** CodepAssemblyPartNumber */
#define WRAPNV_DATASET_CODEPASSEMBLYPARTNUMBER 0x01u
#define WRAPNV_RECORD_ID_CODEPASSEMBLYPARTNUMBER 0x1Fu

/** EbomEcuPartNumber */
#define WRAPNV_DATASET_EBOMECUPARTNUMBER     0x01u
#define WRAPNV_RECORD_ID_EBOMECUPARTNUMBER   0x20u

/** DID_F194_Supplier_Ecu_SW_PartNum */
#define WRAPNV_DATASET_DID_F194_SUPPLIER_ECU_SW_PARTNUM 0x01u
#define WRAPNV_RECORD_ID_DID_F194_SUPPLIER_ECU_SW_PARTNUM 0x21u

/** DID_F195_Supplier_Ecu_SW_VerNum */
#define WRAPNV_DATASET_DID_F195_SUPPLIER_ECU_SW_VERNUM 0x01u
#define WRAPNV_RECORD_ID_DID_F195_SUPPLIER_ECU_SW_VERNUM 0x22u

/** DiagnosticVersion */
#define WRAPNV_DATASET_DIAGNOSTICVERSION     0x01u
#define WRAPNV_RECORD_ID_DIAGNOSTICVERSION   0x23u

/** DID_2002_OdoFlashing */
#define WRAPNV_DATASET_DID_2002_ODOFLASHING  0x01u
#define WRAPNV_RECORD_ID_DID_2002_ODOFLASHING 0x24u

/** SWC_ConfigMgrVIN_OriginalVal */
#define WRAPNV_DATASET_SWC_CONFIGMGRVIN_ORIGINALVAL 0x01u
#define WRAPNV_RECORD_ID_SWC_CONFIGMGRVIN_ORIGINALVAL 0x25u

/** fileHeader */
#define WRAPNV_DATASET_FILEHEADER            0x09u
#define WRAPNV_RECORD_ID_FILEHEADERINFO      0x26u
#define WRAPNV_RECORD_ID_UUID                0x27u

/** CertAccessInfo */
#define WRAPNV_DATASET_CERTACCESSINFO        0x0Au
#define WRAPNV_RECORD_ID_ISSUERNAME          0x28u
#define WRAPNV_RECORD_ID_SERIALNUMBER        0x29u

/** SecureLogGroup1 */
#define WRAPNV_DATASET_SECURELOGGROUP1       0x01u
#define WRAPNV_RECORD_ID_SECURELOGGROUPONE   0x2Au

/** SecureLogGroup2 */
#define WRAPNV_DATASET_SECURELOGGROUP2       0x01u
#define WRAPNV_RECORD_ID_SECURELOGGROUPTWO   0x2Bu

/** SecondCounter */
#define WRAPNV_DATASET_SECONDCOUNTER         0x01u
#define WRAPNV_RECORD_ID_SECONDCOUNTER       0x2Cu

/** SystemTimestamp */
#define WRAPNV_DATASET_SYSTEMTIMESTAMP       0x01u
#define WRAPNV_RECORD_ID_SYSTEMTIMESTAMP     0x2Du

/** Maximum ID of a DataElement */
#define WRAPNV_RECORD_ID_MAX                 0x2Du

/** Maximum NvM Block size */
#define WRAPNV_MAX_BLOCK_LENGTH              0x01E8u

/** Size defines ************************************************************** */


#define kEepSizeCertificateExpired           0x01u
...
#define kEepSizeIssuerName                   0x1Au
#define kEepSizeSerialNumber                 0x14u
#define kEepSizeSecureLogGroupOne            0x01E8u
#define kEepSizeSecureLogGroupTwo            0x01E8u
#define kEepSizeSecondCounter                0x04u
#define kEepSizeSystemTimestamp              0x0Fu

#define kWrapNvNrOfBlock                     0x20u
#define kWrapNvNrOfRecord                    0x2Eu

/** Access macros ************************************************************* */

/* PRQA S 3453 FctLikeMacroLabel */ /* MD_MSR_FctLikeMacro */

#define ApplFblNvReadSecureLogGroup1(buf)    WrapNv_ReadBlockSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf))
#define ApplFblNvReadPartialSecureLogGroup1(buf, offset, length) WrapNv_ReadPartialBlockSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf), (offset), (length))
#define ApplFblNvDeleteSecureLogGroup1(idx)  WrapNv_DeleteSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, (idx))
#define ApplFblNvWriteSecureLogGroup1(buf)   WrapNv_WriteBlockSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf))
#define ApplFblNvReadAsyncSecureLogGroup1(buf, op) WrapNv_ReadBlockAsync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf), (op))
#define ApplFblNvReadPartialAsyncSecureLogGroup1(buf, offset, length, op) WrapNv_ReadPartialBlockSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf), (offset), (length), (op))
#define ApplFblNvDeleteAsyncSecureLogGroup1(idx, op) WrapNv_DeleteAsync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, (idx), (op))
#define ApplFblNvWriteAsyncSecureLogGroup1(buf, op) WrapNv_WriteBlockAsync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf), (op))

#define ApplFblNvReadSecureLogGroup2(buf)    WrapNv_ReadBlockSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf))
#define ApplFblNvReadPartialSecureLogGroup2(buf, offset, length) WrapNv_ReadPartialBlockSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf), (offset), (length))
#define ApplFblNvDeleteSecureLogGroup2(idx)  WrapNv_DeleteSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, (idx))
#define ApplFblNvWriteSecureLogGroup2(buf)   WrapNv_WriteBlockSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf))
#define ApplFblNvReadAsyncSecureLogGroup2(buf, op) WrapNv_ReadBlockAsync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf), (op))
#define ApplFblNvReadPartialAsyncSecureLogGroup2(buf, offset, length, op) WrapNv_ReadPartialBlockSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf), (offset), (length), (op))
#define ApplFblNvDeleteAsyncSecureLogGroup2(idx, op) WrapNv_DeleteAsync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, (idx), (op))
#define ApplFblNvWriteAsyncSecureLogGroup2(buf, op) WrapNv_WriteBlockAsync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf), (op))

#define ApplFblNvReadCertificateExpired(buf) WrapNv_ReadSync(WRAPNV_RECORD_ID_CERTIFICATEEXPIRED, 0u, (buf))
#define ApplFblNvReadPartialCertificateExpired(buf, offset, length) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_CERTIFICATEEXPIRED, 0u, (buf), (offset), (length))
#define ApplFblNvWriteCertificateExpired(buf) WrapNv_WriteSync(WRAPNV_RECORD_ID_CERTIFICATEEXPIRED, 0u, (buf))
#define ApplFblNvReadAsyncCertificateExpired(buf, op) WrapNv_ReadAsync(WRAPNV_RECORD_ID_CERTIFICATEEXPIRED, 0u, (buf), (op))
#define ApplFblNvReadPartialAsyncCertificateExpired(buf, offset, length, op) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_CERTIFICATEEXPIRED, 0u, (buf), (offset), (length), (op))
#define ApplFblNvWriteAsyncCertificateExpired(buf, op) WrapNv_WriteAsync(WRAPNV_RECORD_ID_CERTIFICATEEXPIRED, 0u, (buf), (op))
...
#define ApplFblNvReadSWC_ConfigMgrVIN_OriginalVal(buf) WrapNv_ReadSync(WRAPNV_RECORD_ID_SWC_CONFIGMGRVIN_ORIGINALVAL, 0u, (buf))
#define ApplFblNvReadPartialSWC_ConfigMgrVIN_OriginalVal(buf, offset, length) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SWC_CONFIGMGRVIN_ORIGINALVAL, 0u, (buf), (offset), (length))
#define ApplFblNvWriteSWC_ConfigMgrVIN_OriginalVal(buf) WrapNv_WriteSync(WRAPNV_RECORD_ID_SWC_CONFIGMGRVIN_ORIGINALVAL, 0u, (buf))
#define ApplFblNvReadAsyncSWC_ConfigMgrVIN_OriginalVal(buf, op) WrapNv_ReadAsync(WRAPNV_RECORD_ID_SWC_CONFIGMGRVIN_ORIGINALVAL, 0u, (buf), (op))
#define ApplFblNvReadPartialAsyncSWC_ConfigMgrVIN_OriginalVal(buf, offset, length, op) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SWC_CONFIGMGRVIN_ORIGINALVAL, 0u, (buf), (offset), (length), (op))
#define ApplFblNvWriteAsyncSWC_ConfigMgrVIN_OriginalVal(buf, op) WrapNv_WriteAsync(WRAPNV_RECORD_ID_SWC_CONFIGMGRVIN_ORIGINALVAL, 0u, (buf), (op))
...
#define ApplFblNvReadIssuerName(idx, buf)    WrapNv_ReadSync(WRAPNV_RECORD_ID_ISSUERNAME, (uint16)(idx), (buf))
#define ApplFblNvReadPartialIssuerName(idx, buf, offset, length) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_ISSUERNAME, (uint16)(idx), (buf), (offset), (length))
#define ApplFblNvWriteIssuerName(idx, buf)   WrapNv_WriteSync(WRAPNV_RECORD_ID_ISSUERNAME, (uint16)(idx), (buf))
#define ApplFblNvReadAsyncIssuerName(idx, buf, op) WrapNv_ReadAsync(WRAPNV_RECORD_ID_ISSUERNAME, (uint16)(idx), (buf), (op))
#define ApplFblNvReadPartialAsyncIssuerName(idx, buf, offset, length, op) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_ISSUERNAME, (uint16)(idx), (buf), (offset), (length), (op))
#define ApplFblNvWriteAsyncIssuerName(idx, buf, op) WrapNv_WriteAsync(WRAPNV_RECORD_ID_ISSUERNAME, (uint16)(idx), (buf), (op))
...
#define ApplFblNvReadSecureLogGroupOne(buf)  WrapNv_ReadSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf))
#define ApplFblNvReadPartialSecureLogGroupOne(buf, offset, length) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf), (offset), (length))
#define ApplFblNvWriteSecureLogGroupOne(buf) WrapNv_WriteSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf))
#define ApplFblNvReadAsyncSecureLogGroupOne(buf, op) WrapNv_ReadAsync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf), (op))
#define ApplFblNvReadPartialAsyncSecureLogGroupOne(buf, offset, length, op) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf), (offset), (length), (op))
#define ApplFblNvWriteAsyncSecureLogGroupOne(buf, op) WrapNv_WriteAsync(WRAPNV_RECORD_ID_SECURELOGGROUPONE, 0u, (buf), (op))

#define ApplFblNvReadSecureLogGroupTwo(buf)  WrapNv_ReadSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf))
#define ApplFblNvReadPartialSecureLogGroupTwo(buf, offset, length) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf), (offset), (length))
#define ApplFblNvWriteSecureLogGroupTwo(buf) WrapNv_WriteSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf))
#define ApplFblNvReadAsyncSecureLogGroupTwo(buf, op) WrapNv_ReadAsync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf), (op))
#define ApplFblNvReadPartialAsyncSecureLogGroupTwo(buf, offset, length, op) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf), (offset), (length), (op))
#define ApplFblNvWriteAsyncSecureLogGroupTwo(buf, op) WrapNv_WriteAsync(WRAPNV_RECORD_ID_SECURELOGGROUPTWO, 0u, (buf), (op))

#define ApplFblNvReadSecondCounter(buf)      WrapNv_ReadSync(WRAPNV_RECORD_ID_SECONDCOUNTER, 0u, (buf))
#define ApplFblNvReadPartialSecondCounter(buf, offset, length) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SECONDCOUNTER, 0u, (buf), (offset), (length))
#define ApplFblNvWriteSecondCounter(buf)     WrapNv_WriteSync(WRAPNV_RECORD_ID_SECONDCOUNTER, 0u, (buf))
#define ApplFblNvReadAsyncSecondCounter(buf, op) WrapNv_ReadAsync(WRAPNV_RECORD_ID_SECONDCOUNTER, 0u, (buf), (op))
#define ApplFblNvReadPartialAsyncSecondCounter(buf, offset, length, op) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SECONDCOUNTER, 0u, (buf), (offset), (length), (op))
#define ApplFblNvWriteAsyncSecondCounter(buf, op) WrapNv_WriteAsync(WRAPNV_RECORD_ID_SECONDCOUNTER, 0u, (buf), (op))

#define ApplFblNvReadSystemTimestamp(buf)    WrapNv_ReadSync(WRAPNV_RECORD_ID_SYSTEMTIMESTAMP, 0u, (buf))
#define ApplFblNvReadPartialSystemTimestamp(buf, offset, length) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SYSTEMTIMESTAMP, 0u, (buf), (offset), (length))
#define ApplFblNvWriteSystemTimestamp(buf)   WrapNv_WriteSync(WRAPNV_RECORD_ID_SYSTEMTIMESTAMP, 0u, (buf))
#define ApplFblNvReadAsyncSystemTimestamp(buf, op) WrapNv_ReadAsync(WRAPNV_RECORD_ID_SYSTEMTIMESTAMP, 0u, (buf), (op))
#define ApplFblNvReadPartialAsyncSystemTimestamp(buf, offset, length, op) WrapNv_ReadPartialSync(WRAPNV_RECORD_ID_SYSTEMTIMESTAMP, 0u, (buf), (offset), (length), (op))
#define ApplFblNvWriteAsyncSystemTimestamp(buf, op) WrapNv_WriteAsync(WRAPNV_RECORD_ID_SYSTEMTIMESTAMP, 0u, (buf), (op))
