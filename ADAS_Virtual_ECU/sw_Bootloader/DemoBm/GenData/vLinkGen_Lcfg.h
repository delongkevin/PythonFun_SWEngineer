...
extern uint8 _MasterSatelliteSharedRamSection_LIMIT[]; 
extern uint8 _MasterSatelliteSharedRamSection_ROM_LIMIT[]; 
extern uint8 _MasterSatelliteSharedRamSection_ROM_START[]; 
extern uint8 _MasterSatelliteSharedRamSection_START[]; 
extern uint8 _RamBssSecGroup_LIMIT[]; 
extern uint8 _RamBssSecGroup_START[]; 
extern uint8 _RamDataSecGroup_LIMIT[]; 
extern uint8 _RamDataSecGroup_ROM_LIMIT[]; 
extern uint8 _RamDataSecGroup_ROM_START[]; 
extern uint8 _RamDataSecGroup_START[]; 
