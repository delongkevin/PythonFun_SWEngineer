...
{
  {
    ...
    {
      208384u /*  FSS threshold  */ , 
      198143u /*  BSS threshold  */ 
    }, 
    { /*  AssociatedSectors_at  */ 
      { /*  LowerSector  */ 
        0xFFFFFFFFu /*  Fls Erase Value  */ , 
        { /*  physical sector  */ 
          0x00000000u /*  physical sector start address  */ , 
          0x00040000u /*  physical sector size  */ 
        }, 
        { /*  configured sector  */ 
          0x00000000u /*  configured sector start address  */ , 
          0x00040000u /*  configured sector size  */ 
        }, 
        { /*  alignments  */ 
          11u /*  write alignment  */ , 
