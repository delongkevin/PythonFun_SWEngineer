...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(vMem_30_vXSpi_Nand_MemSectorType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_MemSector[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    EraseBurstSize  SectorSize  StartAddress  NrOfSectors  PageSize  WriteBurstSize  ReplacementSector  RamAlignment  vMemDieIdx        Referable Keys */
  { /*     0 */        262144u,    262144u,  0x00000000u,        502u,    4096u,          4096u,             FALSE,           1u,         0u },  /* [/ActiveEcuC/vMem_30_vXSpi_Nand/vMemInstance_ExtFlash] */
  { /*     1 */        262144u,    262144u,  0x07D80000u,         10u,    4096u,          4096u,              TRUE,           1u,         0u }   /* [/ActiveEcuC/vMem_30_vXSpi_Nand/vMemInstance_ExtFlash] */
};
...
CONST(vMem_30_vXSpi_Nand_vMemInstanceType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_vMemInstance[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    BlankCheckBufferArrayOne2SortedNEndIdx  BlankCheckBufferArrayOne2SortedNLength  BlankCheckBufferArrayOne2SortedNStartIdx  BusyCheckTimeoutThreshold  AutomatedBadBlockManagment  SoftwareDieSelectCommandUsed  Id  MemSectorEndIdx  MemSectorLength  MemSectorStartIdx  vMemDieEndIdx  vMemDieLength  vMemDieStartIdx  GenericProtocolModeId    ReadDataProtocolModeId        WriteDataProtocolModeId              Referable Keys */
  { /*     0 */                                  4096u,                                  4096u,                                       0u,                    65535u,                       TRUE,                        FALSE, 0u,              2u,              2u,                0u,            1u,            1u,              0u, VXSPI_vXSpiProtocolMode, VXSPI_vXSpiProtocolMode_Read, VXSPI_vXSpiProtocolMode_Write }   /* [/ActiveEcuC/vMem_30_vXSpi_Nand/vMemInstance_ExtFlash] */
};
#define VMEM_30_VXSPI_NAND_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
