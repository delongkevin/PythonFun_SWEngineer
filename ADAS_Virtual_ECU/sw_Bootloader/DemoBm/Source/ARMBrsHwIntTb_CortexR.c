...
__attribute__((naked))__attribute__((used)) void intvect_CoreExceptions(void)
{
  __asm("  b resetAddress");
...
__attribute__((used)) void resetAddress(void)
{
	__asm("ldr pc,=brsStartupEntry");
}
