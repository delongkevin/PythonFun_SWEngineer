...
CONST(vMem_30_vXSpi_Nand_MemSectorType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_MemSector[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */        131072u,    131072u,       1024u,    2048u,          2048u,             FALSE,           1u,        0x00u,         0u }   /* [/ActiveEcuC/vMem_30_vXSpi_Nand/vMemInstance_ExtFlash] */
};
...
CONST(vMem_30_vXSpi_Nand_vMemDeviceConfigType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_vMemDeviceConfig[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    EraseValue  LutAddressLength  LutDataBufferLength  LutEntryLength  LutMaxEntries  StatusRegister1Address  StatusRegister2Address  StatusRegister3Address  StatusRegisterBufferReadModeBitMask  StatusRegisterBusyFlagBitMask  StatusRegisterDataBufferLength  StatusRegisterEcc0BitMask  StatusRegisterEcc1BitMask  StatusRegisterEraseErrorBitMask  StatusRegisterLutFBitMask  StatusRegisterProgramErrorBitMask  StatusRegisterProtectionBitMask        Referable Keys */
  { /*     0 */      0xFFu,            0x02u,               0x50u,          0x04u,         0x14u,                  0xA0u,                  0xB0u,                  0xC0u,                               0x08u,                         0x01u,                          0x01u,                     0x10u,                     0x20u,                           0x04u,                     0x40u,                             0x08u,                           0xFFu }   /* [/ActiveEcuC/vMem_30_vXSpi_Nand/Winbond_W25N01JW] */
};
#define VMEM_30_VXSPI_NAND_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(vMem_30_vXSpi_Nand_vMemDieType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_vMemDie[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */ 134217728u,              0u }   /* [/ActiveEcuC/vMem_30_vXSpi_Nand/Winbond_W25N01JW/vMemDieList/Die0, /ActiveEcuC/vMem_30_vXSpi_Nand/vMemInstance_ExtFlash] */
};
#define VMEM_30_VXSPI_NAND_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(vMem_30_vXSpi_Nand_vMemFlsCmdAddressFormatValueType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_vMemFlsCmdAddressFormatValue[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    EraseCmd                                  PageDataReadCmd                           ProgramDataLoadCmd                        ProgramExecuteCmd                         ReadBbmLutCmd                             ReadCmd                                   ReadStatusRegisterCmd                     ReplaceLogicalBlocksCmd                   SoftwareDieSelectCmd                      WriteEnableCmd                            WriteStatusRegisterCmd                          Comment                                                Referable Keys */
  { /*     0 */ VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_0_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_0_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_2_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_0_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_1_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_2_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_1_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_0_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_1_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_0_BYTE, VMEM_30_VXSPI_NAND_ADDRESS_FORMAT_1_BYTE }   /* [Contains device-specific flash commands.] */  /* [/ActiveEcuC/vMem_30_vXSpi_Nand/Winbond_W25N01JW] */
};
#define VMEM_30_VXSPI_NAND_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(vMem_30_vXSpi_Nand_vMemFlsCmdDummyCycleValueType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_vMemFlsCmdDummyCycleValue[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    EraseCmd  PageDataReadCmd  ProgramDataLoadCmd  ProgramExecuteCmd  ReadBbmLutCmd  ReadCmd  ReadStatusRegisterCmd  ReplaceLogicalBlocksCmd  SoftwareDieSelectCmd  WriteEnableCmd  WriteStatusRegisterCmd        Comment                                                Referable Keys */
  { /*     0 */       0u,              0u,                 0u,                0u,            0u,      4u,                    0u,                      0u,                   0u,             0u,                     0u }   /* [Contains device-specific flash commands.] */  /* [/ActiveEcuC/vMem_30_vXSpi_Nand/Winbond_W25N01JW] */
};
#define VMEM_30_VXSPI_NAND_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(vMem_30_vXSpi_Nand_vMemFlsCmdValueType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_vMemFlsCmdValue[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    EraseCmd  PageDataReadCmd  ProgramDataLoadCmd  ProgramExecuteCmd  ReadBbmLutCmd  ReadCmd  ReadStatusRegisterCmd  ReplaceLogicalBlocksCmd  SoftwareDieSelectCmd  WriteEnableCmd  WriteStatusRegisterCmd        Comment                                                Referable Keys */
  { /*     0 */    0xD8u,           0x13u,              0x32u,             0x10u,         0xA5u,   0xEBu,                 0x05u,                   0xA1u,                0xC2u,          0x06u,                  0x01u }   /* [Contains device-specific flash commands.] */  /* [/ActiveEcuC/vMem_30_vXSpi_Nand/Winbond_W25N01JW] */
};
#define VMEM_30_VXSPI_NAND_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(vMem_30_vXSpi_Nand_vMemInstanceType, VMEM_30_VXSPI_NAND_CONST) vMem_30_vXSpi_Nand_vMemInstance[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */                                  2048u,                                  2048u,                                       0u,                     2000u,                        FALSE, 0u,              1u,              1u,                0u,            1u,            1u,              0u, VXSPI_vXSpiProtocolMode, VXSPI_vXSpiProtocolMode_Read, VXSPI_vXSpiProtocolMode_Write }   /* [/ActiveEcuC/vMem_30_vXSpi_Nand/vMemInstance_ExtFlash] */
};
#define VMEM_30_VXSPI_NAND_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
