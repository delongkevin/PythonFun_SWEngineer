...
IO_ErrorType /* V_API_NEAR */ RamDriver_InitSync( void * );
IO_ErrorType /* V_API_NEAR */ RamDriver_DeinitSync( void * );
IO_ErrorType /* V_API_NEAR */ RamDriver_RReadSync( IO_MemPtrType, IO_SizeType, IO_PositionType );
IO_ErrorType /* V_API_NEAR */ RamDriver_RWriteSync( IO_MemPtrType, IO_SizeType, IO_PositionType );
IO_ErrorType /* V_API_NEAR */ RamDriver_REraseSync( IO_SizeType, IO_PositionType );
