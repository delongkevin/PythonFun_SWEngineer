...
#define TIVX_TARGET_R5F_MAX            (28U)
...
void ownPlatformCreateTargets(void)
{
    ...
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_VPAC_CUC_VISS, 21, "TIVX_CUC_VISS", 13u);
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_VPAC_CUC_RC, 22, "TIVX_CUC_RC", 12u);

    #if defined(SOC_J721S2) || defined(SOC_J784S4)
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_CSITX2, 23, "TIVX_CSITX2", 8u);
    #endif

    #if defined(SOC_J784S4)
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_CAPTURE9, 24, "TIVX_CAPT9", 15u);
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_CAPTURE10, 25, "TIVX_CAPT10", 15u);
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_CAPTURE11, 26, "TIVX_CAPT11", 15u);
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_CAPTURE12, 27, "TIVX_CAPT12", 15u);
    #endif
...
void ownPlatformDeleteTargets(void)
{
    ...
    tivxPlatformDeleteTargetId((vx_enum)TIVX_TARGET_ID_VPAC_CUC_VISS);
    tivxPlatformDeleteTargetId((vx_enum)TIVX_TARGET_ID_VPAC_CUC_RC);
    #if defined(SOC_J721S2) || defined(SOC_J784S4)
