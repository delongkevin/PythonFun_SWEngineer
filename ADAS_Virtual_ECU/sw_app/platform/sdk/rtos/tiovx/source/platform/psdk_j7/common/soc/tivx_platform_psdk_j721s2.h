 ...
 */
#define TIVX_PLATFORM_MAX_TARGETS            (46u)
...
typedef enum _tivx_target_id_e {
    ...
    /*! \brief target ID for CUC_VISS */
    TIVX_TARGET_ID_VPAC_CUC_VISS = TIVX_MAKE_TARGET_ID(TIVX_CPU_ID_MCU2_0, 22u),

    /*! \brief target ID for CE_RC */
    TIVX_TARGET_ID_VPAC_CUC_RC = TIVX_MAKE_TARGET_ID(TIVX_CPU_ID_MCU2_0, 23u),
...
{                                                                              \
    ...
    {TIVX_TARGET_VPAC_CUC_VISS, (vx_enum)TIVX_TARGET_ID_VPAC_CUC_VISS},                 \
    {TIVX_TARGET_VPAC_CUC_RC, (vx_enum)TIVX_TARGET_ID_VPAC_CUC_RC},                     \
