...
IDIRS+=${SAFERTOS_KERNEL_INSTALL_PATH_r5f}/source_code_and_projects/SafeRTOS/checkpoints
endif
ifeq ($(TARGET_CPU),C66)
...
# To access GPIO expander routines
IMAGING_IDIRS += $(IMAGING_PATH)/sensor_drv/src
IDIRS += $(IMAGING_IDIRS)
