...
ifeq ($(BUILD_CPU_C7x_1),yes)
	cp $(VISION_APPS_PATH)/out/$(TARGET_SOC)/$(C7X_TARGET)/$(RTOS_C7x)/$(QNX_APP_PROFILE)/vx_app_rtos_qnx_c7x_1.out $(INPUT_IMG_PATH)/vx_app_rtos_qnx_c7x_1.xe71
...
OPTEE_IMG=load_only,$(ATF_OPTEE_PATH)/bl32.bin,0x90800000,0x90800000
