...
ifneq (, $(fisker_hydra_PATH))
sciclient_LIB_LIST += sciserver_autosaros
sciclient_LIB_LIST += sciclient_direct_autosar
endif
endif
endif

drvsciclient_BOARDLIST = am65xx_evm am65xx_idk j721e_sim j721e_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm am64x_evm
...
export sciclient_direct_BOARDLIST = j721e_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm
...
export sciclient_direct_hs_BOARDLIST = j721e_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm
export sciclient_direct_hs_$(SOC)_CORELIST = mcu1_0

export sciclient_direct_autosar_COMP_LIST = sciclient_direct_autosar
export sciclient_direct_autosar_RELPATH = ti/drv/sciclient_direct_autosar
export sciclient_direct_autosar_OBJPATH = ti/drv/sciclient_direct_autosar
export sciclient_direct_autosar_LIBNAME = sciclient_direct_autosar
export sciclient_direct_autosar_PATH = $(PDK_SCICLIENT_COMP_PATH)
export sciclient_direct_autosar_LIBPATH = $(PDK_SCICLIENT_COMP_PATH)/lib
export sciclient_direct_autosar_MAKEFILE = -fsrc/sciclient_direct_autosar_makefile BUILD_HS=no
export sciclient_direct_autosar_BOARD_DEPENDENCY = no
export sciclient_direct_autosar_CORE_DEPENDENCY = yes
export sciclient_direct_autosar_PKG_LIST = sciclient_direct_autosar
export sciclient_direct_autosar_INCLUDE = $(sciclient_direct_autosar_PATH)
export sciclient_direct_autosar_SOCLIST = j721s2
export sciclient_direct_autosar_BOARDLIST = j721s2_hyd
export sciclient_direct_autosar_$(SOC)_CORELIST = mcu1_0
...
export sciserver_tirtos_BOARDLIST = j721e_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm
export sciserver_tirtos_$(SOC)_CORELIST = mcu1_0

export sciserver_autosaros_COMP_LIST = sciserver_autosaros
export sciserver_autosaros_RELPATH = ti/drv/sciserver_autosaros
export sciserver_autosaros_OBJPATH = ti/drv/sciserver_autosaros
export sciserver_autosaros_LIBNAME = sciserver_autosaros
export sciserver_autosaros_PATH = $(PDK_SCICLIENT_COMP_PATH)
export sciserver_autosaros_LIBPATH = $(PDK_SCICLIENT_COMP_PATH)/lib
export sciserver_autosaros_MAKEFILE = -fsrc/sciserver_makefile
export sciserver_autosaros_BOARD_DEPENDENCY = no
export sciserver_autosaros_CORE_DEPENDENCY = yes
export sciserver_autosaros_PKG_LIST = sciserver_autosaros
export sciserver_autosaros_INCLUDE = $(sciserver_PATH)
export sciserver_autosaros_SOCLIST = j721s2
export sciserver_autosaros_BOARDLIST = j721s2_hyd
export sciserver_autosaros_$(SOC)_CORELIST = mcu1_0
...
export sciserver_baremetal_BOARDLIST = j721e_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm
...
export rm_pm_hal_BOARDLIST = j721e_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm
...
export sciclient_firmware_boot_TestApp_BOARDLIST = am65xx_evm am64x_evm j7200_evm j721e_evm j721s2_evm j721s2_hyd j784s4_evm
...
export sciclient_ccs_init_BOARDLIST = am65xx_evm j721e_sim j721e_evm am64x_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm
...
export sciclient_rtos_app_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), am65xx_evm j721e_sim j721e_evm am64x_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm)
...
export sciclient_unit_testapp_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), am65xx_evm j721e_sim j721e_evm am64x_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm)
...
export sciserver_testapp_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), j721e_evm j7200_evm j721s2_evm j721s2_hyd j784s4_evm)
...
export sciclient_fw_testapp_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), am65xx_evm j721e_evm j7200_evm j721s2_evm j721s2_hyd)
