...
# if (COM_RXDEFERREDEVENTCACHE == STD_ON)
    ...
    Com_SetRxDeferredEventCacheIdxOfRxNextEventCacheEntry(Com_GetRxNextEventCacheEntryIdxOfMainFunctionRxStruct(mainFunctionId), Com_GetRxDeferredEventCacheStartIdxOfMainFunctionRxStruct(mainFunctionId));    /* SBSW_COM_CSL_VAR_ACCESS */
# endif
...
# if (COM_RXDEFERREDEVENTCACHE == STD_ON)
  ...
  if(Com_GetRxDeferredEventCacheIdxOfRxNextEventCacheEntry(nextEventCacheEntryIdx) != COM_NO_HANDLERXPDUDEFERREDIDXOFRXPDUINFO)
  {
    ...
    while(Com_GetRxDeferredEventCacheIdxOfRxNextEventCacheEntry(nextEventCacheEntryIdx) > Com_GetRxDeferredEventCacheStartIdxOfMainFunctionRxStruct(mainFunctionId))
    {
