 ...
 *  23.00.02  2022-11-07  viscpe  ESCAN00112557 Wrong datatype Com_GwSigGrpMappingIterType is used (type is too small).
 *  23.00.03  2022-11-30  viscpe  ESCAN00113172 Rx pdus are stored in a DeferredEventCache of an incorrect partition/mainfunction after an overflow occurred
 *            2022-11-30  viscpe  ESCAN00113246 Rx pdus are stored in a DeferredEventCache of an incorrect partition/mainfunction
 *********************************************************************************************************************/
#if !defined (COM_H)
# define COM_H
