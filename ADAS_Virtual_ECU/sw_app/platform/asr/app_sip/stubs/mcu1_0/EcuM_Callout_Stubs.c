 ...
 *********************************************************************************************************************/
  ...
  if(reason == (Std_ReturnType)ECUM_E_HOOK_CONFIGURATION_DATA_INCONSISTENT)
  {
	  while(1)
	  {
	  }
 ...
 *********************************************************************************************************************/
  ...
  Dio_WriteChannel((Dio_ChannelType)DioConf_DioChannel_DioChannel_MCU_LED, STD_HIGH);
   /* Add implementation of EcuM_AL_SwitchOff() */
  Dio_LevelType CanTrcvSTB;
  Dio_LevelType CanTrcvEN;
  volatile uint32 delaycnt;
  ...
  if((CanTrcvSTB == ((Dio_LevelType)STD_HIGH)) && (CanTrcvEN == ((Dio_LevelType)STD_HIGH)))
  {
    Dio_WriteChannel((Dio_ChannelType)DioConf_DioChannel_DioChannel_pinEN, STD_HIGH);
    for(delaycnt=(uint32)ZERO;delaycnt<(uint32)FIFTY_THOUSAND;delaycnt++)
    {
    	/* Do nothing */;
    }
  ...
  else
  {
    ...
    Dio_WriteChannel((Dio_ChannelType)DioConf_DioChannel_DioChannel_PinSTB, STD_HIGH);
    for(delaycnt=(uint32)ZERO;delaycnt<(uint32)FIFTY_THOUSAND;delaycnt++)
    {
    	/* Do nothing */;
    }
 ...
 *********************************************************************************************************************/
 ...
 uint32 delaycnt;
  ...
  Dio_WriteChannel((Dio_ChannelType)DioConf_DioChannel_DioChannel_MCU_LED, STD_LOW);
...
FUNC(void, ECUM_CODE) EcuM_AL_DriverInitOne(void) 
{
  Dio_Init();
    ...
    while ((regVal & (uint32)0x1U) != (uint32)0x1U)
    {
        /* Check for unlock */
        regVal = CSL_REG32_RD(CSL_MCU_CTRL_MMR0_CFG0_BASE + CSL_MCU_CTRL_MMR_CFG0_LOCK2_KICK0);
    }
 ...
 *********************************************************************************************************************/
  ...
  {
    for(coreId=0u; coreId < ECUM_NUMBER_OF_CORES; coreId++)
    {
 ...
 *********************************************************************************************************************/
  ...
  if ((wakeupSource & ECUM_WKSOURCE_CN_FDCAN2_28a8fc44) == ECUM_WKSOURCE_CN_FDCAN2_28a8fc44)
  {
	  Os_Call_CanWUp_Val_CheckPN(wakeupSource);
  }  
  else
  {
	  /* Do Nothing */
