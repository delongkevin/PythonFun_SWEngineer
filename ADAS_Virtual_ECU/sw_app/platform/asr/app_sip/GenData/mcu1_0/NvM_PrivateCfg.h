...
typedef struct
{
    ...
    NvM_BitFieldType SelectBlockForPreReadAllEnabled : 1;    
...
#define NVM_CALC_RAM_CRC_USED STD_ON 
...
#define NVM_SELECT_BLOCK_FOR_PRE_READALL_ON      (1u)
#define NVM_SELECT_BLOCK_FOR_PRE_READALL_OFF     (0u)
...
#define NVM_NR_OF_CSM_MAC_JOBS    1u 
#define NVM_CRYPTO_BUFFER_LENGTH  0u 
#define NVM_MAC_BUFFER_LENGTH     16u 
#define NVM_CSM_OP_MODE           CRYPTO_OPERATIONMODE_SINGLECALL 
...
#define NVM_SIZE_STANDARD_JOB_QUEUE  (35u) 
...
/* create the internal immediate data buffer */
extern VAR(uint8, NVM_PRIVATE_DATA) NvM_InternalImmediateDataBuffer[]; /* PRQA S 3684 */ /* MD_NvM_Cfg_8.11 */
#endif
...
extern CONST(NvM_CsmMacJobType, NVM_PRIVATE_CONST) NvM_CsmMacJobs[NVM_NR_OF_CSM_MAC_JOBS]; /*!< All CSM MAC jobs any NvM block references to. */
