...
#endif
#ifndef DET_PROCESSOR_TDA4VE88
#define DET_PROCESSOR_TDA4VE88
#endif
#ifndef DET_COMP_LLVMTEXASINSTRUMENTS
#define DET_COMP_LLVMTEXASINSTRUMENTS
#endif
...
FUNC(Std_ReturnType, DET_CODE) Os_Call_Det_UserReportError( uint16 ModuleId, uint8 InstanceId, uint8 ApiId, uint8 ErrorId );
