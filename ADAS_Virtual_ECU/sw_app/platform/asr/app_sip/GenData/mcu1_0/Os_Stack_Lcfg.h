...
/* User: [BootAppOsTask] */
extern OS_STACK_DECLARE(OsCfg_Stack_BootAppOsTask_Dyn, OS_CFG_SIZE_BOOTAPPOSTASK_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Task_Prio78_Dyn, OS_CFG_SIZE_OSCORE0_TASK_PRIO78_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Task_Prio79_Dyn, OS_CFG_SIZE_OSCORE0_TASK_PRIO79_STACK);
...
/* User: [QM_Task_Init] */
extern OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Task_Prio88_Dyn, OS_CFG_SIZE_OSCORE0_TASK_PRIO88_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_QM_ComTask_10ms_Dyn, OS_CFG_SIZE_QM_COMTASK_10MS_STACK);
...
/* User: [QM_ComTask_5ms] */
extern OS_STACK_DECLARE(OsCfg_Stack_QM_ComTask_5ms_Dyn, OS_CFG_SIZE_QM_COMTASK_5MS_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_QM_DiagTask_10ms_Dyn, OS_CFG_SIZE_QM_DIAGTASK_10MS_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_QM_MemTask_10ms_Dyn, OS_CFG_SIZE_QM_MEMTASK_10MS_STACK);
...
/* User: [QM_Task_200ms] */
extern OS_STACK_DECLARE(OsCfg_Stack_QM_Task_200ms_Dyn, OS_CFG_SIZE_QM_TASK_200MS_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_Safety_Task_200ms_Dyn, OS_CFG_SIZE_SAFETY_TASK_200MS_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_Safety_WdgTask_10ms_Dyn, OS_CFG_SIZE_SAFETY_WDGTASK_10MS_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_SciServerHighOsTask_Dyn, OS_CFG_SIZE_SCISERVERHIGHOSTASK_STACK);
...
extern OS_STACK_DECLARE(OsCfg_Stack_SciServerLowOsTask_Dyn, OS_CFG_SIZE_SCISERVERLOWOSTASK_STACK);
...
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_BootAppOsTask;
...
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Task_Prio78;

/*! Stack configuration data: OsCore0_Task_Prio79 */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Task_Prio79;

/*! Stack configuration data: OsCore0_Task_Prio88 */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Task_Prio88;
...
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_QM_ComTask_10ms;

/*! Stack configuration data: QM_ComTask_5ms */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_QM_ComTask_5ms;

/*! Stack configuration data: QM_DiagTask_10ms */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_QM_DiagTask_10ms;

/*! Stack configuration data: QM_MemTask_10ms */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_QM_MemTask_10ms;

/*! Stack configuration data: QM_Task_200ms */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_QM_Task_200ms;

/*! Stack configuration data: Safety_Task_200ms */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_Safety_Task_200ms;

/*! Stack configuration data: Safety_WdgTask_10ms */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_Safety_WdgTask_10ms;

/*! Stack configuration data: SciServerHighOsTask */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_SciServerHighOsTask;

/*! Stack configuration data: SciServerLowOsTask */
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_SciServerLowOsTask;
