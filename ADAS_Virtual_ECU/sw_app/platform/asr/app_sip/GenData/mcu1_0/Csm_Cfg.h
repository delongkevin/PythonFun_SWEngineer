 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Csm_Cfg.h
 *   Generation Time: 2024-03-11 14:16:14
...
#define CsmConf_CsmJob_CsmJob_CsmHash                                                               1u 
#define CsmConf_CsmJob_CsmJob_GetRoleFromTesterCertificate                                          2u 
#define CsmConf_CsmJob_CsmJob_Random                                                                3u 
#define CsmConf_CsmJob_CsmJob_SecureLog_MacGen                                                      4u 
#define CsmConf_CsmJob_CsmJob_SecureLog_MacVerify                                                   5u 
#define CsmConf_CsmJob_CsmJob_SignatureVerify                                                       6u 
#define CsmConf_CsmJob_CsmJob_SignatureVerify_ADA                                                   7u 
#define CsmConf_CsmKey_CsmKey_CurrentTimeStamp                                                      0u 
#define CsmConf_CsmKey_CsmKey_KeyMCertificate_ADA_L4                                                1u 
#define CsmConf_CsmKey_CsmKey_RSAKey                                                                2u 
#define CsmConf_CsmKey_CsmKey_Random                                                                3u 
#define CsmConf_CsmKey_CsmKey_RoleFlag                                                              4u 
#define CsmConf_CsmKey_CsmKey_RsaSignatureVerifyKey_ADA_L4                                          5u 
#define CsmConf_CsmKey_CsmKey_SecondCounter                                                         6u 
#define CsmConf_CsmKey_CsmKey_SecureLog                                                             7u 
...
#define CSM_CALLBACKFUNC44OFBSWCALLBACKS                                                            STD_ON
...
/** 
  ...
  \{
*/ 
#define CSM_ASYNCHRONOUSOFJOBTABLE_MASK                                                             0x08u
#define CSM_BSWCALLBACKSUSEDOFJOBTABLE_MASK                                                         0x04u
#define CSM_CALLOUTINFOUSEDOFJOBTABLE_MASK                                                          0x02u
...
#define Csm_GetSizeOfBswCallbacksOfPCConfig()                                                       1u  /**< the number of accomplishable value elements in Csm_BswCallbacks */
#define Csm_GetSizeOfCalloutInfoOfPCConfig()                                                        1u  /**< the number of accomplishable value elements in Csm_CalloutInfo */
#define Csm_GetSizeOfCalloutOfPCConfig()                                                            1u  /**< the number of accomplishable value elements in Csm_Callout */
#define Csm_GetSizeOfJobInfoOfPCConfig()                                                            8u  /**< the number of accomplishable value elements in Csm_JobInfo */
#define Csm_GetSizeOfJobOfPCConfig()                                                                7u  /**< the number of accomplishable value elements in Csm_Job */
...
#define Csm_GetSizeOfKeyOfPCConfig()                                                                8u  /**< the number of accomplishable value elements in Csm_Key */
#define Csm_GetSizeOfPrimitiveInfoOfPCConfig()                                                      7u  /**< the number of accomplishable value elements in Csm_PrimitiveInfo */
#define Csm_GetSizeOfQueueInfoOfPCConfig()                                                          5u  /**< the number of accomplishable value elements in Csm_QueueInfo */
#define Csm_GetSizeOfQueueOfPCConfig()                                                              6u  /**< the number of accomplishable value elements in Csm_Queue */
...
#define Csm_GetCallbackFunc44OfBswCallbacks(Index)                                                  (Csm_GetBswCallbacksOfPCConfig()[(Index)].CallbackFunc44OfBswCallbacks)
...
#define Csm_GetJobObjSynchronousIdxOfQueueInfo(Index)                                               (Csm_GetQueueInfoOfPCConfig()[(Index)].JobObjSynchronousIdxOfQueueInfo)
#define Csm_GetJobPoolEndIdxOfQueueInfo(Index)                                                      (Csm_GetQueueInfoOfPCConfig()[(Index)].JobPoolEndIdxOfQueueInfo)
...
/** 
  ...
  \{
*/ 
#define Csm_IsBswCallbacksUsedOfJobTable(Index)                                                     (CSM_BSWCALLBACKSUSEDOFJOBTABLE_MASK == (Csm_GetMaskedBitsOfJobTable(Index) & CSM_BSWCALLBACKSUSEDOFJOBTABLE_MASK))  /**< TRUE, if the 0:1 relation has minimum 1 relation pointing to Csm_BswCallbacks */
...
#define Csm_GetCalloutIdxOfCalloutInfo(Index)                                                       ((Csm_CalloutIdxOfCalloutInfoType)((Index)))  /**< the index of the 1:1 relation pointing to Csm_Callout */
#define Csm_GetJobTableIdxOfCalloutInfo(Index)                                                      ((Csm_JobTableIdxOfCalloutInfoType)((((Csm_JobTableIdxOfCalloutInfoType)(Index)) + 7u)))  /**< the index of the 1:1 relation pointing to Csm_JobTable */
...
#define Csm_IsAsynchronousOfJobTable(Index)                                                         Csm_IsBswCallbacksUsedOfJobTable(Index)
...
#define Csm_HasCallbackFunc44OfBswCallbacks()                                                       (TRUE != FALSE)
...
/** 
  ...
  \{
*/ 
#define Csm_AddCalloutStateOfCalloutState(Index, Value)                                             Csm_SetCalloutStateOfCalloutState(Index, (Csm_GetCalloutStateOfCalloutState(Index) + Value))
...
/** 
  ...
  \{
*/ 
#define Csm_SubCalloutStateOfCalloutState(Index, Value)                                             Csm_SetCalloutStateOfCalloutState(Index, (Csm_GetCalloutStateOfCalloutState(Index) - Value))
...
{
  Csm_CallbackFunc44Type CallbackFunc44OfBswCallbacks;
...
{
  uint8 Csm_CalloutInfoNeverUsed;  /**< dummy entry for the structure in the configuration variant precompile which is not used by the code. */
} Csm_CalloutInfoType;
...
typedef struct sCsm_JobTableType
{
  ...
  Csm_MaskedBitsOfJobTableType MaskedBitsOfJobTable;  /**< contains bitcoded the boolean data of Csm_AsynchronousOfJobTable, Csm_BswCallbacksUsedOfJobTable, Csm_CalloutInfoUsedOfJobTable, Csm_PrimitiveCallbackUpdateNotificationOfJobTable */
 ...
 * (self.QueueStartIdxOfQueueInfo < Csm_GetSizeOfQueue()) &&
...
typedef struct sCsm_QueueInfoType
{
  ...
  Csm_JobPoolEndIdxOfQueueInfoType JobPoolEndIdxOfQueueInfo;  /**< the end index of the 0:n relation pointing to Csm_Job */
...
{
  Csm_CalloutStateType CsmJob_SignatureVerify_ADA;
...
{
  Csm_QueueElementType CsmQueue_vHsm_Hal;
  Csm_QueueElementType CsmQueue_vHsm_Core;
  Csm_QueueElementType CsmQueue_vHsm_KeyMRemote;
  Csm_QueueElementType CsmQueue_vHsm_LibCv[2];
  Csm_QueueElementType CsmQueue_Custom;
...
/*lint -restore */
extern CONST(Csm_BswCallbacksType, CSM_CONST) Csm_BswCallbacks[1];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Csm_CalloutType, CSM_CONST) Csm_Callout[1];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Csm_KeyType, CSM_CONST) Csm_Key[8];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Crypto_PrimitiveInfoType, CSM_CONST) Csm_PrimitiveInfo[7];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Crypto_JobType, CSM_VAR_NOINIT) Csm_Job[7];
#define CSM_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
/* PRQA S 3449, 3451 CALLBACKFUNCTIONS_3449_3451 */ /* MD_CSM_CALLBACK_DECLARATIONS */
/* Callback Notification Prototypes */
extern FUNC(void, CSM_APPL_CODE) CsmCallbackFunc_CsmCallback(const uint32 jobID, Csm_ResultType result);

/* Pre-and Post-Job Callout Prototypes */
extern FUNC(Std_ReturnType, CSM_APPL_CODE) CsmPreJobCalloutFunc_CsmCallout_ADASigVerify(P2VAR(Crypto_JobType, AUTOMATIC, CSM_APPL_VAR) job, Csm_JobCalloutStateType state);
extern FUNC(Std_ReturnType, CSM_APPL_CODE) CsmPostJobCalloutFunc_CsmCallout_ADASigVerify(P2VAR(Crypto_JobType, AUTOMATIC, CSM_APPL_VAR) job, Csm_JobCalloutStateType state, P2VAR(Std_ReturnType, AUTOMATIC, CSM_APPL_VAR) jobReturnValue);
/* PRQA L:CALLBACKFUNCTIONS_3449_3451 */
