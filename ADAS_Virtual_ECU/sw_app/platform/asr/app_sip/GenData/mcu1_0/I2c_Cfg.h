...
#define I2C_CFG_PATCH_VERSION       (1u)
...
# define I2C_CFG_COMP_PATCH_VERSION   1u
...
#define I2C_POLLING_MODE            (STD_OFF) /*!< Enables/disables the I2c Polling mode. */
...
#define I2C_ATOMIC_BIT_ACCESS_IN_BITFIELD STD_ON /* /MICROSAR/EcuC/EcucGeneral/AtomicBitAccessInBitfield */
#endif
...
#define I2cConf_I2cChannel_I2cChannel_EEPROM_ReadCom  (0u) 
#define I2cConf_I2cChannel_I2cChannel_EEPROM_ReadData  (1u) 
#define I2cConf_I2cChannel_I2cChannel_EEPROM_WriteCom  (2u) 
#define I2cConf_I2cChannel_I2cChannel_EEPROM_WriteData  (3u) 
#define I2cConf_I2cChannel_I2cChannel_EEPROM_Ack  (4u) 

/* Symbolic Name Values for sequences of I2cConfigSet */ 
#define I2cConf_I2cSequence_I2cSequence_EEPROM_Read  (0u) 
#define I2cConf_I2cSequence_I2cSequence_EEPROM_Write  (1u) 
#define I2cConf_I2cSequence_I2cSequence_EEPROM_Status  (2u) 




/* Symbolic Name Values for buses of I2cConfigSet */ 
#define I2cConf_I2cBus_I2cBus_EEPROM  (0u) 


/* Symbolic Name Values for HwUnits of I2cConfigSet */ 
#define I2cConf_I2cHardwareUnit_I2cHardwareUnit_EEPROM  (0u) 
...
#define I2C_HW_LOOP_MAX   (1000u) /*!< Maximum number of HW-Loop cycles. */
