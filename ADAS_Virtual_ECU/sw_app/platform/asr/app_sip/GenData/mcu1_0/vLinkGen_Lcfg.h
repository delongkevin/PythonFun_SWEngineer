...
extern uint8 _OS_DATA_CORE0_VAR_ZERO_INIT_bss_LIMIT[]; 
...
extern uint8 _OS_GLOBALSHARED_VAR_SAVED_ZONE_INIT_LIMIT[]; 
...
extern uint8 _OS_GLOBALSHARED_VAR_ZERO_INIT_bss_LIMIT[]; 
extern uint8 _OS_GLOBALSHARED_VAR_ZERO_INIT_bss_START[]; 
extern uint8 _OS_OsApplication_QM_VAR_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_QM_VAR_INIT_ROM_LIMIT[]; 
extern uint8 _OS_OsApplication_QM_VAR_INIT_ROM_START[]; 
extern uint8 _OS_OsApplication_QM_VAR_INIT_START[]; 
extern uint8 _OS_OsApplication_QM_VAR_SAVED_ZONE_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_QM_VAR_SAVED_ZONE_INIT_ROM_LIMIT[]; 
extern uint8 _OS_OsApplication_QM_VAR_SAVED_ZONE_INIT_ROM_START[]; 
extern uint8 _OS_OsApplication_QM_VAR_SAVED_ZONE_INIT_START[]; 
extern uint8 _OS_OsApplication_QM_VAR_ZERO_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_QM_VAR_ZERO_INIT_START[]; 
extern uint8 _OS_OsApplication_QM_VAR_ZERO_INIT_bss_LIMIT[]; 
extern uint8 _OS_OsApplication_QM_VAR_ZERO_INIT_bss_START[]; 
extern uint8 _OS_OsApplication_Safety_VAR_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_Safety_VAR_INIT_ROM_LIMIT[]; 
extern uint8 _OS_OsApplication_Safety_VAR_INIT_ROM_START[]; 
extern uint8 _OS_OsApplication_Safety_VAR_INIT_START[]; 
extern uint8 _OS_OsApplication_Safety_VAR_SAVED_ZONE_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_Safety_VAR_SAVED_ZONE_INIT_ROM_LIMIT[]; 
extern uint8 _OS_OsApplication_Safety_VAR_SAVED_ZONE_INIT_ROM_START[]; 
extern uint8 _OS_OsApplication_Safety_VAR_SAVED_ZONE_INIT_START[]; 
extern uint8 _OS_OsApplication_Safety_VAR_ZERO_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_Safety_VAR_ZERO_INIT_START[]; 
extern uint8 _OS_OsApplication_Safety_VAR_ZERO_INIT_bss_LIMIT[]; 
extern uint8 _OS_OsApplication_Safety_VAR_ZERO_INIT_bss_START[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_INIT_ROM_LIMIT[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_INIT_ROM_START[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_INIT_START[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_SAVED_ZONE_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_SAVED_ZONE_INIT_ROM_LIMIT[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_SAVED_ZONE_INIT_ROM_START[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_SAVED_ZONE_INIT_START[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_ZERO_INIT_LIMIT[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_ZERO_INIT_START[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_ZERO_INIT_bss_LIMIT[]; 
extern uint8 _OS_OsApplication_Trusted_Core0_VAR_ZERO_INIT_bss_START[]; 
extern uint8 _STACK_C0_LIMIT[]; 
extern uint8 _STACK_C0_START[]; 
extern uint8 _STACK_C1_LIMIT[]; 
extern uint8 _STACK_C1_START[]; 
extern uint8 _STACK_C2_LIMIT[]; 
extern uint8 _STACK_C2_START[]; 
extern uint8 _STACK_C3_LIMIT[]; 
extern uint8 _STACK_C3_START[]; 
extern uint8 _STACK_C4_LIMIT[]; 
extern uint8 _STACK_C4_START[]; 
extern uint8 _STACK_C5_LIMIT[]; 
