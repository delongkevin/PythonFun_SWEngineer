 ...
 *   Generation Time: 2025-09-16 12:23:28
...
#define EcuM_GetEcuM_CRCHash_LowerOfPCConfig()                                                      0x1CFAF2FBu
#define EcuM_GetEcuM_CRCHash_UpperOfPCConfig()                                                      0x691C85E2u
...
#define EcuM_AddValidationTimeoutTable(Index, Value)                                                EcuM_SetValidationTimeoutTable(Index, (EcuM_GetValidationTimeoutTable(Index) + Value))
/** 
  \}
*/ 
...
#define EcuM_SubValidationTimeoutTable(Index, Value)                                                EcuM_SetValidationTimeoutTable(Index, (EcuM_GetValidationTimeoutTable(Index) - Value))
/** 
  \}
*/ 
...
#include "EcuM_MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(EcuM_ValidationTimeoutTableType, ECUM_VAR_NO_INIT) EcuM_ValidationTimeoutTable[7];
