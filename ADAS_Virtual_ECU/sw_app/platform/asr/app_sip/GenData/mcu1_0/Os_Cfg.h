...
# define OS_CFG_MINOR_VERSION                    (79u)

/*! Defines which platform is used. */
# define OS_CFG_PLATFORM_ARM     (STD_ON)

/*! Defines which derivative group is configured. */
# define OS_CFG_DERIVATIVEGROUP_JACINTO7     (STD_ON)

/*! Defines which derivative is configured. */
# define OS_CFG_DERIVATIVE_TDA4VE88     (STD_ON)

/*! Defines which compiler is configured. */
# define OS_CFG_COMPILER_LLVMTEXASINSTRUMENTS     (STD_ON)

/*! Defines whether virtualization is active (STD_ON) or not (STD_OFF). */
# define OS_CFG_VIRTUALIZATION                   (STD_OFF)
...
/* Event masks */
# define Rte_Ev_Cyclic2_QM_ComTask_10ms_0_10ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic2_QM_ComTask_5ms_5_5ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic2_QM_DiagTask_10ms_0_10ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic2_QM_MemTask_10ms_0_10ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic2_QM_Task_200ms_0_200ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic2_Safety_WdgTask_10ms_0_10ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic_QM_ComTask_10ms_0_10ms     ((EventMaskType)2uLL)
# define Rte_Ev_Cyclic_QM_ComTask_5ms_0_5ms     ((EventMaskType)2uLL)
# define Rte_Ev_Cyclic_QM_DiagTask_10ms_0_10ms     ((EventMaskType)2uLL)
# define Rte_Ev_Cyclic_QM_MemTask_10ms_0_10ms     ((EventMaskType)2uLL)
# define Rte_Ev_Cyclic_QM_Task_200ms_0_200ms     ((EventMaskType)2uLL)
# define Rte_Ev_Cyclic_Safety_Task_200ms_0_200ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic_Safety_WdgTask_10ms_0_10ms     ((EventMaskType)2uLL)
# define Rte_Ev_InternalEventHandling     ((EventMaskType)4uLL)
# define Rte_Ev_Run_SWC_ProxiConfigMgr_RE_ProxiMgr_ConfigDataRSP     ((EventMaskType)2uLL)
# define SciServerTrigger_UserMainHi     ((EventMaskType)1uLL)
# define SciServerTrigger_UserMainLo     ((EventMaskType)1uLL)
# define SciServerTrigger_UserMcuHi     ((EventMaskType)2uLL)
# define SciServerTrigger_UserMcuLo     ((EventMaskType)2uLL)
# define ospi_dma_event     ((EventMaskType)1uLL)
