 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dcm_Lcfg.h
 *   Generation Time: 2025-08-06 18:59:41
 ...
 *********************************************************************************************************************/
# define Dcm_ModeOnComControlModeChange(channelId, mode)                       ((void)(Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_CN_FDCAN2_28a8fc44_DcmCommunicationControl_ComMConf_ComMChannel_CN_FDCAN2_28a8fc44(mode))) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
 ...
 *                 Dcm_GetSesCtrlType().
***********************************************************************************************************************/
FUNC(void, DCM_CALLOUT_CODE) Os_Call_DcmCalloutStub_SessionCallback(Dcm_SesCtrlType formerState, Dcm_SesCtrlType newState);
/***********************************************************************************************************************
...
/***********************************************************************************************************************
 *  DcmDslServiceRequestManufacturer_Indication()
 ***********************************************************************************************************************/
 ...
 *  \pre           -
 ***********************************************************************************************************************/
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) DcmDslServiceRequestManufacturer_Indication(
  uint8 SID,
...
/***********************************************************************************************************************
 *  DcmDslServiceRequestManufacturer_Confirmtion()
 ***********************************************************************************************************************/
 ...
 *  \pre           -
 ***********************************************************************************************************************/
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) DcmDslServiceRequestManufacturer_Confirmtion(
  uint8 SID,
  uint8 ReqType,
  uint16 SourceAddress,
 ...
 *  \pre           -
 ***********************************************************************************************************************/
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Os_Call_DcmCalloutStub_GetSeed(
  P2CONST(uint8, AUTOMATIC, DCM_VAR_NOINIT) SecurityAccessDataRecord, 
  Dcm_OpStatusType OpStatus,
  P2VAR(uint8, AUTOMATIC, DCM_VAR_NOINIT) Seed,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR_NOINIT) ErrorCode
  );
/***********************************************************************************************************************
 ...
 *  \pre           -
 ***********************************************************************************************************************/
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Os_Call_DcmCalloutStub_CompareKey(
  P2CONST(uint8, AUTOMATIC, DCM_VAR_NOINIT) Key,
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR_NOINIT) ErrorCode
  );
/***********************************************************************************************************************
...
extern CONST(Dcm_NetConnRefMemType, DCM_CONST) Dcm_CfgNetTxPduInfo[3];
...
extern CONST(uint8, DCM_CONST) Dcm_CfgFblMgrTransferAlfidLookUpTable[17];
/*! Look up table of all supported transfer MIDs */
extern CONST(uint8, DCM_CONST) Dcm_CfgFblMgrTransferMidLookUpTable[1];
...
extern CONST(uint8, DCM_CONST) Dcm_CfgSvc19SubFuncLookUpTable[11];
...
# include "Dcm_MemMap.h"                                                                                                                             /* PRQA S 5087 */ /* MD_MSR_MemMap */
/*! DID look up table  */
extern CONST(uint16, DCM_CONST) Dcm_CfgDidMgrDidLookUpTable[165];
/*! RID look up table  */
extern CONST(uint16, DCM_CONST) Dcm_CfgRidMgrRidLookUpTable[21];
...
/*! RxPduId map */
extern CONST(Dcm_CfgNetRxPduInfoType, DCM_CONST) Dcm_CfgNetRxPduInfo[6];
...
extern CONST(Dcm_ModeRuleFuncType, DCM_CONST) Dcm_CfgModeMgrRules[3];
/*! Diagnostic service execution conditions */
extern CONST(Dcm_CfgStatePreconditionInfoType, DCM_CONST) Dcm_CfgStatePreconditions[11];
...
/*! DID properties */
extern CONST(Dcm_CfgDidMgrDidInfoType, DCM_CONST) Dcm_CfgDidMgrDidInfo[164];
/*! DID operation properties */
extern CONST(Dcm_CfgDidMgrDidOpInfoType, DCM_CONST) Dcm_CfgDidMgrDidOpInfo[177];
/*! DID operation classes */
extern CONST(Dcm_CfgDidMgrDidOpClassInfoType, DCM_CONST) Dcm_CfgDidMgrDidOpClassInfo[181];
/*! DID signal operation classes */
extern CONST(Dcm_CfgDidMgrSignalOpClassInfoType, DCM_CONST) Dcm_CfgDidMgrSignalOpClassInfo[180];
...
/*! RID properties */
extern CONST(Dcm_CfgRidMgrRidInfoType, DCM_CONST) Dcm_CfgRidMgrRidInfo[20];
/*! RID operation properties */
extern CONST(Dcm_CfgRidMgrOpInfoType, DCM_CONST) Dcm_CfgRidMgrOpInfo[26];
...
extern CONST(Dcm_CfgDiagSvc2ProtMapMemType, DCM_CONST) Dcm_CfgDiagSvcId2ProtMap[15];
...
extern CONST(Dcm_CfgSvc19SubFuncInfoType, DCM_CONST) Dcm_CfgSvc19SubFuncInfo[10];
/*! Indirection from service 0x19 sub functions to execution pre conditions */
extern CONST(Dcm_CfgStateRefMemType, DCM_CONST) Dcm_CfgSvc19SubFuncExecPrecondTable[10];
