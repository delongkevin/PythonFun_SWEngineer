...
{
  DemConf_DemEventParameter_Dem_SystemInternalFailure /*  Ref to DemEvent (EEP_E_READ_FAILED)  */ , 
  DemConf_DemEventParameter_Dem_SystemInternalFailure /*  Ref to DemEvent (EEP_E_COMPARE_FAILED)  */ , 
  DemConf_DemEventParameter_Dem_SystemInternalFailure /*  Ref to DemEvent (EEP_E_WRITE_FAILED)  */ , 
  DemConf_DemEventParameter_Dem_SystemInternalFailure /*  Ref to DemEvent (EEP_E_ERASE_FAILED)  */ , 
  /* I2C references */
  I2cConf_I2cSequence_I2cSequence_EEPROM_Read /*  i2c read sequence  */ , 
  I2cConf_I2cChannel_I2cChannel_EEPROM_ReadCom /*  i2c read command channel  */ , 
  I2cConf_I2cChannel_I2cChannel_EEPROM_ReadData /*  i2c read data channel  */ , 
  I2cConf_I2cSequence_I2cSequence_EEPROM_Write /*  i2c write sequence  */ , 
  I2cConf_I2cChannel_I2cChannel_EEPROM_WriteCom /*  i2c write command channel  */ , 
  I2cConf_I2cChannel_I2cChannel_EEPROM_WriteData /*  i2c write data channel  */ , 
  I2cConf_I2cSequence_I2cSequence_EEPROM_Status /*  ackSequence  */ , 
  I2cConf_I2cChannel_I2cChannel_EEPROM_Ack /*  ackChannel  */ , 
  ...
  8191u /*  Last used address for EEPROM memory.  */ , 
