...
#define CANNM_NUMBER_OF_CANNM_CHANNELS        2u
...
#define CanNmConf_CanNmTxPdu_NM_PAM_oFDCAN2_5dbcd8d2_Tx               1
#define CanNmConf_CanNmTxPdu_NM_PAM_oFDCAN14_0d1e8b51_Tx              0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define CanNmConf_CanNmRxPdu_FDCAN2_CAN_70a1f111_Rx                   1
#define CanNmConf_CanNmRxPdu_FDCAN14_CAN_df03166d_Rx                  0
/**\} */
...
#endif
#ifndef CANNM_PROCESSOR_TDA4VE88
#define CANNM_PROCESSOR_TDA4VE88
#endif
#ifndef CANNM_COMP_LLVMTEXASINSTRUMENTS
#define CANNM_COMP_LLVMTEXASINSTRUMENTS
#endif
...
#define CANNM_BUSLOADREDUCTIONACTIVEOFCHANNELCONFIG                   STD_ON
...
#define CANNM_MSGTIMEOUTTIMER                                         STD_OFF  /**< Deactivateable: 'CanNm_MsgTimeoutTimer' Reason: 'ImmediateTxConf is enabled' */
...
#define CANNM_MSGREDUCEDTIMEOFPBCHANNELCONFIG                         STD_ON
...
#define CANNM_RXMESSAGEDATA_USERDATAENDIDXOFPBCHANNELCONFIG           STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.RxMessageData_UserDataEndIdx' Reason: 'the optional indirection is deactivated because RxMessageData_UserDataUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CANNM_RXMESSAGEDATA_USERDATALENGTHOFPBCHANNELCONFIG           STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.RxMessageData_UserDataLength' Reason: 'the optional indirection is deactivated because RxMessageData_UserDataUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CANNM_RXMESSAGEDATA_USERDATASTARTIDXOFPBCHANNELCONFIG         STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.RxMessageData_UserDataStartIdx' Reason: 'the optional indirection is deactivated because RxMessageData_UserDataUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CANNM_RXMESSAGEDATA_USERDATAUSEDOFPBCHANNELCONFIG             STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.RxMessageData_UserDataUsed' Reason: 'the optional indirection is deactivated because RxMessageData_UserDataUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
...
#define CANNM_TXMESSAGEDATA_USERDATAENDIDXOFPBCHANNELCONFIG           STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.TxMessageData_UserDataEndIdx' Reason: 'the optional indirection is deactivated because TxMessageData_UserDataUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CANNM_TXMESSAGEDATA_USERDATALENGTHOFPBCHANNELCONFIG           STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.TxMessageData_UserDataLength' Reason: 'the optional indirection is deactivated because TxMessageData_UserDataUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CANNM_TXMESSAGEDATA_USERDATASTARTIDXOFPBCHANNELCONFIG         STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.TxMessageData_UserDataStartIdx' Reason: 'the optional indirection is deactivated because TxMessageData_UserDataUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CANNM_TXMESSAGEDATA_USERDATAUSEDOFPBCHANNELCONFIG             STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.TxMessageData_UserDataUsed' Reason: 'the optional indirection is deactivated because TxMessageData_UserDataUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
...
#define CANNM_ISDEF_BUSLOADREDUCTIONACTIVEOFCHANNELCONFIG             STD_OFF
...
#define CANNM_ISDEF_MSGREDUCEDTIMEOFPBCHANNELCONFIG                   STD_OFF
...
#define CANNM_EQ2_BUSLOADREDUCTIONACTIVEOFCHANNELCONFIG               
...
#define CANNM_EQ2_MSGREDUCEDTIMEOFPBCHANNELCONFIG                     
...
#define CanNm_GetSizeOfChannelConfigOfPCConfig()                      2u  /**< the number of accomplishable value elements in CanNm_ChannelConfig */
#define CanNm_GetSizeOfPbChannelConfigOfPCConfig()                    2u  /**< the number of accomplishable value elements in CanNm_PbChannelConfig */
#define CanNm_GetSizeOfSysToNmChIndOfPCConfig()                       2u  /**< the number of accomplishable value elements in CanNm_SysToNmChInd */
#define CanNm_GetSizeOfTxMessageDataOfPCConfig()                      4u  /**< the number of accomplishable value elements in CanNm_TxMessageData */
...
#define CanNm_IsBusLoadReductionActiveOfChannelConfig(Index)          ((CanNm_GetChannelConfigOfPCConfig()[(Index)].BusLoadReductionActiveOfChannelConfig) != FALSE)
...
#define CanNm_GetMsgReducedTimeOfPbChannelConfig(Index)               (CanNm_GetPbChannelConfigOfPCConfig()[(Index)].MsgReducedTimeOfPbChannelConfig)
...
#define CanNm_HasBusLoadReductionActiveOfChannelConfig()              (TRUE != FALSE)
...
#define CanNm_HasMsgReducedTimeOfPbChannelConfig()                    (TRUE != FALSE)
...
/**   \brief  value based type definition for CanNm_BusLoadReductionActiveOfChannelConfig */
typedef boolean CanNm_BusLoadReductionActiveOfChannelConfigType;
...
/**   \brief  value based type definition for CanNm_MsgReducedTimeOfPbChannelConfig */
typedef uint8 CanNm_MsgReducedTimeOfPbChannelConfigType;
...
typedef struct sCanNm_ChannelConfigType
{
  ...
  CanNm_BusLoadReductionActiveOfChannelConfigType BusLoadReductionActiveOfChannelConfig;  /**< Determines if bus load reduction for the respective NM channel is active or not. */
...
typedef struct sCanNm_PbChannelConfigType
{
  ...
  CanNm_MsgReducedTimeOfPbChannelConfigType MsgReducedTimeOfPbChannelConfig;
...
{
  CanNm_CommStateType CN_FDCAN14_a902658e;
  CanNm_CommStateType CN_FDCAN2_28a8fc44;
...
{
  CanNm_CoordReadyToSleepStateType CN_FDCAN14_a902658e;
  CanNm_CoordReadyToSleepStateType CN_FDCAN2_28a8fc44;
...
{
  CanNm_ImmediateNmMsgCountType CN_FDCAN14_a902658e;
  CanNm_ImmediateNmMsgCountType CN_FDCAN2_28a8fc44;
...
{
  CanNm_MsgConfirmationFlagType CN_FDCAN14_a902658e;
  CanNm_MsgConfirmationFlagType CN_FDCAN2_28a8fc44;
...
{
  CanNm_MsgIndicationFlagType CN_FDCAN14_a902658e;
  CanNm_MsgIndicationFlagType CN_FDCAN2_28a8fc44;
...
{
  CanNm_MsgTimerType CN_FDCAN14_a902658e;
  CanNm_MsgTimerType CN_FDCAN2_28a8fc44;
...
{
  CanNm_NetworkRestartFlagType CN_FDCAN14_a902658e;
  CanNm_NetworkRestartFlagType CN_FDCAN2_28a8fc44;
...
{
  CanNm_NmStateType CN_FDCAN14_a902658e;
  CanNm_NmStateType CN_FDCAN2_28a8fc44;
...
{
  CanNm_RepeatMsgTimerType CN_FDCAN14_a902658e;
  CanNm_RepeatMsgTimerType CN_FDCAN2_28a8fc44;
...
{
  CanNm_TimeoutTimerType CN_FDCAN14_a902658e;
  CanNm_TimeoutTimerType CN_FDCAN2_28a8fc44;
...
{
  CanNm_TxControlStateType CN_FDCAN14_a902658e;
  CanNm_TxControlStateType CN_FDCAN2_28a8fc44;
...
{
  CanNm_TxControlStateRequestType CN_FDCAN14_a902658e;
  CanNm_TxControlStateRequestType CN_FDCAN2_28a8fc44;
...
{
  CanNm_WaitBusSleepTimerType CN_FDCAN14_a902658e;
  CanNm_WaitBusSleepTimerType CN_FDCAN2_28a8fc44;
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_CoordReadyToSleepStateType raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_ImmediateNmMsgCountType raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_MsgConfirmationFlagType raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_MsgIndicationFlagType raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_NetworkRestartFlagType raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_RepeatMsgTimerType raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_TxControlStateType raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_TxControlStateRequestType raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_WaitBusSleepTimerType raw[2];
...
/*lint -restore */
extern CONST(CanNm_ChannelConfigType, CANNM_CONST) CanNm_ChannelConfig[2];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(CanNm_PbChannelConfigType, CANNM_CONST) CanNm_PbChannelConfig[2];
#define CANNM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(CanNm_RxMessageDataType, CANNM_VAR_NOINIT) CanNm_RxMessageData[4];
#define CANNM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(CanNm_TxMessageDataType, CANNM_VAR_NOINIT) CanNm_TxMessageData[4];
#define CANNM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
