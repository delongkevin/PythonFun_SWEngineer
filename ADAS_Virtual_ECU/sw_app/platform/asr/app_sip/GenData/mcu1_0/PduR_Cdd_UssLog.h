...
#if !defined (PDUR_CDD_USSLOG_H)
# define PDUR_CDD_USSLOG_H
 ...
 *           The PDU Router evaluates the Cdd_UssLog I-PDU handle and identifies the destination(s) of the PDU.\n
 *           The call is routed to a lower IF module using the appropriate I-PDU handle of the destination layer.
 * \param    id                ID of the Cdd_UssLog I-PDU to be transmitted
 ...
 *                             or the Cdd_UssLogTxPduId is not valid\n
 *                             or the Cdd_UssLogTxPduId is not forwarded in this identity\n
 ...
 *           PduR_Cdd_UssLogTransmit calls for the same Cdd_UssLogTxPduId.
 * \trace    DSGN-PduR_TP_Forwarding
 * \trace    SPEC-666, SPEC-679, SPEC-686, SPEC-1827, SPEC-1096, SPEC-2020085, SPEC-38411
 * \note     The function is called by Cdd_UssLog.
 *********************************************************************************************************************/
FUNC(Std_ReturnType, PDUR_CODE) PduR_Cdd_UssLogTransmit(PduIdType id, P2CONST(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) info);
