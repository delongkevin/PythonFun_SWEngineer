 ...
 *          License:  CBD2101089
 *
 *      Description:  Application types header file for SW-C <SWC_RIDMgr>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_SWC_RIDMGR_TYPE_H
# define RTE_SWC_RIDMGR_TYPE_H
