 ...
 *          License:  CBD2101089
 *
 *      Description:  Application types header file for SW-C <CDD_Safety>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_CDD_SAFETY_TYPE_H
# define RTE_CDD_SAFETY_TYPE_H
