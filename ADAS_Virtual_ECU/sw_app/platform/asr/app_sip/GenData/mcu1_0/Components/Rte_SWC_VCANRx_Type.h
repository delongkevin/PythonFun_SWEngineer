 ...
 *          License:  CBD2101089
 *
 *      Description:  Application types header file for SW-C <SWC_VCANRx>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_SWC_VCANRX_TYPE_H
# define RTE_SWC_VCANRX_TYPE_H
