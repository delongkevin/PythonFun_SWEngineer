 ...
 * 17.02.01  2022-09-16  visaol  ESCAN00111759   PduR returns incorrect buffer size via CopyRxData API
 *           2022-09-19  visaol  ESCAN00112084   Processing of PduR Multicore Queue (McQ) can result in endless loop inside the PduR Mainfunction
 * 17.02.02  2022-11-21  visfrm  ESCAN00113218   Unqueued Communication Interface N:1 API Forwarding Routing Paths are not reset when its routing path group is disabled
 *********************************************************************************************************************/
#ifndef PDUR_H
# define PDUR_H
