 ...
 *  \details        The kernel uses this function to implement the PIT ISR. It is used to clear the pending timer interrupt flag.
 ...
 *  \details        The kernel uses this function to implement the AUTOSAR counter interface in case of a free running timer.
 *  \param[in]      TimerConfig     Timer hardware configuration. Parameter must not be NULL.
 ...
 **********************************************************************************************************************/
/*! \brief          Return the current compare register value of the given free running timer.
 *  \details        The kernel uses this function to implement the AUTOSAR counter interface in case of a free running timer.
 *  \param[in]      TimerConfig     Timer hardware configuration. Parameter must not be NULL.
 ...
 *  \details        The kernel uses this function to implement the FRT ISR. It is used to clear pending timer interrupt flags,
