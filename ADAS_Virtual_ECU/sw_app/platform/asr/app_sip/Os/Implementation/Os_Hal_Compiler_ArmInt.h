...
#ifndef OS_HAL_COMPILER_ARMINT_H
 ...
 *  \pre          -
 **********************************************************************************************************************/
static __inline void Os_Hal_SetThreadIdRegister(uint32 Thread)
{
  __asm
  {
    MCR  p15, 0x0, Thread, c13, c0, 0x3
  }
}
 ...
 *  \pre          -
 **********************************************************************************************************************/
static __inline void Os_Hal_WritePsr(uint32 NewPSR)
{
  __asm
  {
    MSR cpsr_cxsf, NewPSR
  }
}
 ...
 *                Multiple implementations are needed as the  __MRC intrinsic is not available on the ARMv5 compiler,
 ...
 **********************************************************************************************************************/
#define Os_Hal_RFC_variant_Definition(CRn, CRm, OpCode2)                        \
uint32 Os_Hal_RFC_variant_##CRn##_##CRm##_##OpCode2(void)                       \
{                                                                               \
  uint32 ret = 0;                                                               \
  __asm                                                                         \
  {                                                                             \
    mrc  p15, 0x0, ret, c##CRn, c##CRm, ##OpCode2                               \
  }                                                                             \
  return ret;                                                                   \
}                                                                               \
...
# define Os_Hal_WriteToCoprocessor(Value, Coproc, Opcode1, CRn, CRm, Opcode2) \
  __asm("MCR  p15 , " #Opcode1 ", " #Value ", c" #CRn ", c" #CRm ", " #Opcode2 )
