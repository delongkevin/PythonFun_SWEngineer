...
#define OS_HAL_COMPILER_LLVMDIAB_SOURCE
...
# if defined (OS_CFG_COMPILER_LLVMDIAB)                                                                                      /* COV_OS_DERIVATIVEBETAMODULE */
...
# endif /* if defined (OS_CFG_COMPILER_LLVMDIAB) */
 ...
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_LlvmDiab.c
 *********************************************************************************************************************/
