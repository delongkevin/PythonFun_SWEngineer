 ...
 *  \{
 *  \file    Os_Hal_InterruptController_GIC.h
...
#ifndef  OS_HAL_INTERRUPTCONTROLLER_GIC_H
# define OS_HAL_INTERRUPTCONTROLLER_GIC_H
 ...
 *  \details  The lowest interrupt level - defined in derivative header : Os_Hal_Derivative_xxxInt.h */
# define OS_HAL_TASK_LEVEL                                  (OS_HAL_INTC_GIC_LOWEST_INTERRUPT_PRIORITY)
...
# define OS_HAL_INTC_GIC_CPUIF           ((volatile Os_Hal_IntcGicCpuInterfaceType *)OS_HAL_INTC_GIC_CPUIF_BASE)
/*! Distributor base address. */
# define OS_HAL_INTC_GIC_DISTRIBUTOR     ((volatile Os_Hal_IntcGicDistributorType *)OS_HAL_INTC_GIC_DISTRIBUTOR_BASE)
...
))
{
  ...
  /* #10 Configure interrupts of any priority to be signaled to the processor. (Set ICCPMR to 0xF0) */
  OS_HAL_INTC_GIC_CPUIF->Iccpmr = 0xF0uL;                                                                               /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_CPUIF */

  /* #20 Write to the ICCBPR, to set the binary point position, that determines preemption on the interface. */
  OS_HAL_INTC_GIC_CPUIF->Iccbpr = 0uL;                                                                                  /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_CPUIF */

  /* #30 Write to the ICCICR to enable signaling of interrupts by the interface. */
  OS_HAL_INTC_GIC_CPUIF->Iccicr = 1uL;                                                                                  /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_CPUIF */

  /* #40 Write to the ICDDCR to enable the Distributor. */
  OS_HAL_INTC_GIC_DISTRIBUTOR->Icddcr = 1uL;                                                                            /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
}
...
))
{
  ...
  OS_HAL_INTC_GIC_DISTRIBUTOR->Icdisr[InterruptConfig->Source/32u] &= ~(1uL << (InterruptConfig->Source%32u));          /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
  ...
  OS_HAL_INTC_GIC_DISTRIBUTOR->Icdipr[InterruptConfig->Source] = (uint8)(InterruptConfig->Level);                       /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
  ...
  {
    OS_HAL_INTC_GIC_DISTRIBUTOR->Icdiptr[InterruptConfig->Source] = (uint8)(1uL << InterruptConfig->CoreID);            /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
  }
}
...
))
{
  ...
  OS_HAL_INTC_GIC_DISTRIBUTOR->Icdiser[Source/32u] = (1uL << (Source%32u));                                             /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
}
  ...
  ))
{
  ...
  OS_HAL_INTC_GIC_DISTRIBUTOR->Icdicer[InterruptConfig->Source/32u] = (1uL << (InterruptConfig->Source%32u));           /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
}
...
))
{
  ...
  OS_HAL_INTC_GIC_CPUIF->Iccpmr = Level;                                                                                /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_CPUIF */
}
...
))
{
  ...
  return OS_HAL_INTC_GIC_CPUIF->Iccpmr;                                                                                 /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */
}
...
))
{
  ...
  OS_HAL_INTC_GIC_DISTRIBUTOR->Icdicpr[Source/32u] = (1uL << (Source%32u));                                             /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
...
{
  /* #10 Write source ID and the sender core ID to ICCEOIR to signal end of interrupt. */
  OS_HAL_INTC_GIC_CPUIF->Icceoir = SenderCoreID | Source;                                                               /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_CPUIF */
}
...
))
{
  ...
  OS_HAL_INTC_GIC_DISTRIBUTOR->Icdispr[Source/32u] = (1uL << (Source%32u));                                             /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
}
...
{
  /* #10 Set the Software Generated Interrupt Register(ICDSGIR) with the given parameters.*/
  OS_HAL_INTC_GIC_DISTRIBUTOR->Icdsgir = ((1uL << (16u + CoreID)) | Source);                                            /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_ISRCONFIG_GIC_DISTRIBUTOR */
}
...
))
{
  ...
  return (Os_StdReturnType)((OS_HAL_INTC_GIC_DISTRIBUTOR->Icdicer[InterruptConfig->Source/32u] &                        /* PRQA S 0303, 4304 */ /* MD_Os_Hal_Rule11.4_0303, MD_Os_C90BooleanCompatibility */
...
))
{
  ...
  return (Os_StdReturnType)((OS_HAL_INTC_GIC_DISTRIBUTOR->Icdicpr[InterruptConfig->Source/32u] &                        /* PRQA S 0303, 4304 */ /* MD_Os_Hal_Rule11.4_0303, MD_Os_C90BooleanCompatibility */
      (1uL << (InterruptConfig->Source%32u))) != 0u);
}
...
))
{
  ...
  icciar = OS_HAL_INTC_GIC_CPUIF->Icciar;                                                                               /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */
  ...
  else
  {
    ...
    switch(interruptVectorTable[irqNumber].InterruptType)
    {
      ...
      case OS_HAL_ISR_CAT2:
        {
          ...
          *(pIsrConfig->SourceConfig->HwConfig->SenderCoreID) = icciar & OS_HAL_INTC_GIC_CPUID_ACKNOWLEDGE_MASK;        /* SBSW_OS_HAL_INT_VECTOR_TABLE */
      ...
      default:                                                                                                          /* COV_OS_HALPLATFORMGICINVSTATE */
        ...
        break;                                                                                                          /* PRQA S 2880 */ /* MD_Os_Hal_Rule2.1_2880_NonReturning */
    }
  }
}
...
#endif /* OS_HAL_INTERRUPTCONTROLLER_GIC_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_InterruptController_GIC.h
 *********************************************************************************************************************/
