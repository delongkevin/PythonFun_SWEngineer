 ...
 *  \brief      Assembler parts of context switching primitives for ARMv7-A and ARMv7-R.
 *  \internal
...
# if defined(OS_HAL_ARCH_V7A)
#  include "Os_Hal_ContextAsm_v7a.inc"
# elif defined(OS_HAL_ARCH_V7R)
#  include "Os_Hal_ContextAsm_v7r.inc"
# elif defined(OS_HAL_ARCH_V8R)
#  include "Os_Hal_ContextAsm_v8r.inc"
# endif
