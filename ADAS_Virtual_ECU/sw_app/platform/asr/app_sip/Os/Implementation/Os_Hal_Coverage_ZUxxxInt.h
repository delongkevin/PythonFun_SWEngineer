...
#ifndef  OS_HAL_COVERAGE_ZUXXXINT_H
# define OS_HAL_COVERAGE_ZUXXXINT_H
...
\ID COV_OS_HALPLATFORMSPURIOUSINTERRUPT
  \ACCEPT XF
  \REASON This code is only reached in case of race condition between different cores, attempting to serve the same
...
\ID COV_OS_HALPLATFORMMASTERSTARTALLOWED
  \ACCEPT XX
  \REASON This coverage token is never reached on a single-core derivative. The derivative is currently being tested
          a single core derivative.
...
#endif /* OS_HAL_COVERAGE_ZUXXXINT_H */

/*!
 * \}
 */
/***********************************************************************************************************************
 *  END OF FILE: Os_Hal_Coverage_ZUxxxInt.h
 **********************************************************************************************************************/
