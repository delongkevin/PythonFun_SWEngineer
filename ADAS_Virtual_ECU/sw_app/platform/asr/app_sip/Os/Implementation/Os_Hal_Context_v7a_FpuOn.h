 ...
 *  \{
 *
 *  \file  Os_Hal_Context_v7a_FpuOn.h
...
#ifndef  OS_HAL_CONTEXT_V7A_FPUON_H
# define OS_HAL_CONTEXT_V7A_FPUON_H
...
))
{
  ...
  Os_Hal_StoreExtendedFpuRegisters((uint32)&(Context->FpuRegisters));                                                   /* PRQA S 0306 */ /* MD_Os_Hal_Rule11.4_0306 */
}
...
))
{
  ...
  Os_Hal_RestoreExtendedFpuRegisters((uint32)&(Context->FpuRegisters));                                                 /* PRQA S 0306 */ /* MD_Os_Hal_Rule11.4_0306 */
}
...
#endif /* OS_HAL_CONTEXT_V7A_FPUON_H */
...
/***********************************************************************************************************************
 *  END OF FILE: Os_Hal_Context_v7a_FpuOn.h
 **********************************************************************************************************************/
