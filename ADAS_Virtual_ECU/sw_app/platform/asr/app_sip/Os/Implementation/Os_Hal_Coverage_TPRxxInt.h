...
#ifndef  OS_HAL_COVERAGE_TPRXXINT_H
# define OS_HAL_COVERAGE_TPRXXINT_H
...
\ID COV_OS_HALPLATFORMNOCENTRALECXEPTIONHANDLER
  \ACCEPT XX
  \REASON This path is never covered. It has no functionality for TPRxx and is never used.
...
#endif /* OS_HAL_COVERAGE_TPRXXINT_H */

/*!
 * \}
 */
/***********************************************************************************************************************
 *  END OF FILE: Os_Hal_Coverage_TPRxxInt.h
 **********************************************************************************************************************/
