...
#ifndef OS_HAL_DERIVATIVE_TPRXXINT_H
# define OS_HAL_DERIVATIVE_TPRXXINT_H
...
# define OS_HAL_INTC_VIM_CTRL_BASE    (0x02080000uL)

/*! Higher significant bits of TPRxx Vectored Interrupt Manager base address. */
# define OS_HAL_TPRXX_INTC_VIM_BASE_ADDRESS_HIGH     0x0208
/*! Lower significant bits of TPRxx Vectored Interrupt Manager base address. */
# define OS_HAL_TPRXX_INTC_VIM_BASE_ADDRESS_LOW      0x0000

/*! VIM dummy interrupt source. */
# define OS_HAL_INTC_VIM_DUMMY_SOURCE            (255uL)

/*! Activates workaround for back-2-back activation of the same interrupt. */
# define OS_HAL_TPRXX_INTC_VIM_IRQ_NESTING
...
# define OS_HAL_TIMER_RTI_BASE    (0x02F7A000uL)
...
#endif /* OS_HAL_DERIVATIVE_TPRXXINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Derivative_TPRxxInt.h
 *********************************************************************************************************************/
