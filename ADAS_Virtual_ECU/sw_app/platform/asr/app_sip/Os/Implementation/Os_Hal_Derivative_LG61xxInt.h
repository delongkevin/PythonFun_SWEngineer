...
#ifndef OS_HAL_DERIVATIVE_LG61XXINT_H
# define OS_HAL_DERIVATIVE_LG61XXINT_H
...
# define OS_HAL_INTC_GIC_DISTRIBUTOR_BASE     (0xC0401000uL)

/*! Interrupt controller GIC, CPUIF  base address. */
# define OS_HAL_INTC_GIC_CPUIF_BASE     (0xC0402000uL)
 ...
 *  Timer
 *********************************************************************************************************************/
/*! Defines whether PIT_DUALTIMER Timer Unit is supported (STD_ON) or not (STD_OFF). */
# define OS_HAL_TIMER_PIT_DUALTIMER     (STD_ON)
...
#endif /* OS_HAL_DERIVATIVE_LG61XXINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Derivative_LG61xxInt.h
 *********************************************************************************************************************/
