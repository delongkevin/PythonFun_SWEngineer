 ...
 * \{
 *
   * \file    Os_Hal_Compiler_LlvmTIInt.h
 * \brief   This file contains the specific keyword definition for the LLVM Texas Instruments compiler compiler
 * \details
 * The definitions are based on the LLVM Texas Instruments compiler Compiler User Manual
...
#ifndef OS_HAL_COMPILER_LLVMTEXASINSTRUMENTSINT_H
# define OS_HAL_COMPILER_LLVMTEXASINSTRUMENTSINT_H
...
#endif /* OS_HAL_COMPILER_LLVMTEXASINSTRUMENTSINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_LlvmTIInt.h
 *********************************************************************************************************************/
