...
#ifndef  OS_HAL_CORE_V7A_H
# define OS_HAL_CORE_V7A_H
 ...
 **********************************************************************************************************************/
/*! Exception vector table layout for ARMv7-A Architectures. */
typedef struct
{
...
{
  /* #10 Set up VBAR register with the corresponding core exception table. */
  Os_Hal_Set_VBAR((uint32)(Config->ExceptionTable));
}
