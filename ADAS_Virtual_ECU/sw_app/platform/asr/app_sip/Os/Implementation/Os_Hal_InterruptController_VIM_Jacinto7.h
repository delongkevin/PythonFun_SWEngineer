...
#ifndef  OS_HAL_INTERRUPTCONTROLLER_VIM_JACINTO7_H
# define OS_HAL_INTERRUPTCONTROLLER_VIM_JACINTO7_H
...
extern CONST(uint32, OS_CONST) OsJacinto7VimBase[];                                                                     /* PRQA S 3684 */ /* MD_Os_Rule8.11_3684_LinkerSymbol */


/*! translation table: HW Core ID to VIM number of IRQs */
extern CONST(uint32, OS_CONST) OsJacinto7VimNbrIrq[];                                                                   /* PRQA S 3684 */ /* MD_Os_Rule8.11_3684_LinkerSymbol */
...
# define OS_HAL_ISR1_DISABLE_LEVEL_ABSTRACT                 (OS_CFG_HAL_ISR1_DISABLE_MASK)
...
# define OS_HAL_TIMING_PROTECTION_DISABLE_LEVEL_ABSTRACT    (OS_HAL_PSR_INTERRUPTS_MASKED | \
                                                             OS_HAL_PSR_INTERRUPTS_MASKED_FIQ)
...
/*! The interrupt controller supports only 2 priority levels using IRQ and FIQ. */
...
/* VIM generic Macros */
/* ------------------------------------------------------------------------------------- */
/*! Number of IRQs supported by VIM (MCU and MAIN domains differ) */
# define OS_HAL_INTC_NUMBER_OF_IRQS    (OsJacinto7VimNbrIrq[Os_Hal_CoreGetId()])
...
/* VIM INTC base address is located in Os_Hal_Derivative_Jacinto7Int.h */

/*! Prioritized IRQ register */
/* It contains the number of the highest priority pending IRQ and its prio. */
#define OS_HAL_JACINTO7_INTC_VIM_PRIIRQ   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()] + 0x8uL))

/*! Prioritized FIQ register */
/* It contains the number of the highest priority pending FIQ and its prio. */
#define OS_HAL_JACINTO7_INTC_VIMPRIFIQ    (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()] + 0xCuL))

/*! IRQ group status register */
#define OS_HAL_JACINTO7_INTC_VIM_IRQGSTS  (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()] + 0x10uL))

/*! FIQ group status register */
#define OS_HAL_JACINTO7_INTC_VIM_FIQGSTS  (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()] + 0x14uL))
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_IRQVEC  (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()] + 0x18uL))
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_FIQVEC  (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()] + 0x1CuL))
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_ACTIRQ    (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()] + 0x20uL))
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_ACTFIQ  (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()] + 0x24uL))
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_RAW_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]             \
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_STS_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]             \
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_INTR_EN_SET_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]     \
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_IRQSTS_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]          \
...
/* This macro returns the content of the register related to the interrupt source identified by IntSrc.
   ...
   interrupt (Inactive or disabled, Active/pending and enabled).
 */
#define OS_HAL_JACINTO7_INTC_VIM_FIQSTS_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]          \
...
/* This macro returns the content of the register related to the interrupt source identified by IntSrc.
   ...
   Each bit of each register corresponds to an interrupt
 */
#define OS_HAL_JACINTO7_INTC_VIM_INTR_EN_CLR_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]     \
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_INTMAP_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]          \
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_INTTYPE_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]         \
                                                                          + 0x41CuL + ((IntSrc / 32uL) * 0x20uL)))
/*! Interrupt priority registers */
/* This macro returns the content of the register related to the interrupt source identified by IntSrc.
   There are 512 registers (1 reg per int) identified by IntSrc: 0..511.
   Priority value: 0..15
 ...
 */
#define OS_HAL_JACINTO7_INTC_VIM_PRI_INT_J(IntSrc)   (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]         \
...
/* This macro returns the content of the register related to the interrupt source identified by IntSrc.
   ...
   Note: MCU R5FSS has 384 interrupt sources.
         MAIN R5FSS has 512 interrupt sources.
         Ref.:
           Table 9-181. MCU_R5FSS0_CORE0 Interrupt Map,
           Table 9-186. R5FSS0_CORE0 Interrupt Map
 */
#define OS_HAL_JACINTO7_INTC_VIM_VEC_INT_J(IntSrc)    (*(volatile uint32*)(OsJacinto7VimBase[Os_Hal_CoreGetId()]        \
...
))
{
  ...
  OS_HAL_JACINTO7_INTC_VIM_PRI_INT_J(InterruptConfig->Source) = (InterruptConfig->Level);                               /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* OS_HAL_JACINTO7_INTC_VIM_PRI_INT_J */ /* SBSW_OS_HAL_PWA_CALLER */

  /* #20 Map the interrupt as IRQ or FIQ (represented by InterruptConfig->Type) */
  OS_HAL_JACINTO7_INTC_VIM_INTMAP_J(InterruptConfig->Source) &= ~(uint32)(0x01uL << (InterruptConfig->Source % 32uL));  /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
  OS_HAL_JACINTO7_INTC_VIM_INTMAP_J(InterruptConfig->Source) |= (uint32)( ((uint32)(InterruptConfig->Type) ^ 0x01u) <<  /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* OS_HAL_JACINTO7_INTC_VIM_INTMAP_J */ /* SBSW_OS_HAL_PWA_CALLER */
                                                                          (InterruptConfig->Source % 32uL) );

  /* #30 Map the interrupt as Pulse or Level (represented by InterruptConfig->TriggerType) */
  OS_HAL_JACINTO7_INTC_VIM_INTTYPE_J(InterruptConfig->Source) &= ~(uint32)(0x01uL << (InterruptConfig->Source % 32uL));  /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
  OS_HAL_JACINTO7_INTC_VIM_INTTYPE_J(InterruptConfig->Source) |= (uint32)(((uint32)(InterruptConfig->TriggerType)) <<    /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* OS_HAL_JACINTO7_INTC_VIM_INTMAP_J */ /* SBSW_OS_HAL_PWA_CALLER */
                                                                          (InterruptConfig->Source % 32uL) );
}
...
))
{
  ...
  for(IntSrc = 0; IntSrc < OS_HAL_INTC_NUMBER_OF_IRQS; IntSrc++)                                                        /* FETA_OS_HAL_ARM_JACINTO7INTC */
  {
    OS_HAL_JACINTO7_INTC_VIM_VEC_INT_J(IntSrc) = (uint32)(Core->IrqVectorTable[OS_HAL_INTC_VIM_ID][IntSrc]);            /* PRQA S 0303, 0305 */ /* MD_Os_Hal_Rule11.4_0303, MD_Os_Hal_Rule11.1_0305 */ /* OS_HAL_JACINTO7_INTC_VIM_VEC_INT_J */ /* SBSW_OS_HAL_PWA_CALLER */
  }
  ...
  OS_HAL_JACINTO7_INTC_VIM_PRI_INT_J(OS_HAL_INTC_VIM_DUMMY_SOURCE) = (uint32)(0);                                       /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* OS_HAL_JACINTO7_INTC_VIM_PRI_INT_J */ /* SBSW_OS_HAL_PWA_CALLER */

  /* #60 Map the interrupt as IRQ. */
  OS_HAL_JACINTO7_INTC_VIM_INTMAP_J(OS_HAL_INTC_VIM_DUMMY_SOURCE) &= ~(uint32)(0x01uL <<                                /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
                                                                              (OS_HAL_INTC_VIM_DUMMY_SOURCE % 32uL));

  /* #70 Enable interrupt handling for the dummy source. */
  OS_HAL_JACINTO7_INTC_VIM_INTR_EN_SET_J(OS_HAL_INTC_VIM_DUMMY_SOURCE) |= (uint32)(0x01uL <<                            /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* OS_HAL_JACINTO7_INTC_VIM_INTR_EN_SET_J */ /* SBSW_OS_HAL_PWA_CALLER */
                                                                               (OS_HAL_INTC_VIM_DUMMY_SOURCE % 32uL));
}
...
))
{
  ...
  OS_HAL_JACINTO7_INTC_VIM_INTR_EN_SET_J(Source) |= (uint32)(1uL << (Source % 32uL));                                   /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* OS_HAL_JACINTO7_INTC_VIM_INTR_EN_SET_J */ /* SBSW_OS_HAL_PWA_CALLER */
}
...
))
{
  ...
  OS_HAL_JACINTO7_INTC_VIM_INTR_EN_CLR_J(InterruptConfig->Source) = (uint32)(1uL << (InterruptConfig->Source % 32uL)); /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* OS_HAL_JACINTO7_INTC_VIM_INTR_EN_CLR_J */ /* SBSW_OS_HAL_PWA_CALLER */
}
...
))
{
  ...
  /* #10 Disable interrupt handling for for given mapped interrupt. */
  OS_HAL_JACINTO7_INTC_VIM_INTR_EN_CLR_J(InterruptConfig->Source) = (uint32)(1uL << (InterruptConfig->Source % 32uL)); /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* OS_HAL_JACINTO7_INTC_VIM_INTR_EN_CLR_J */ /* SBSW_OS_HAL_PWA_CALLER */
}
...
{
  /* #10 Set the current level in CPSR. */
  Os_Hal_WritePsr((Os_Hal_ReadPsr() & (~(OS_HAL_PSR_INTERRUPTS_MASKED | OS_HAL_PSR_INTERRUPTS_MASKED_FIQ))) |
                  ((uint32)Level & (OS_HAL_PSR_INTERRUPTS_MASKED | OS_HAL_PSR_INTERRUPTS_MASKED_FIQ)));
}
...
{
  /* #10 Get the current level from CPSR. */
  return (Os_Hal_ReadPsr() & (OS_HAL_PSR_INTERRUPTS_MASKED | OS_HAL_PSR_INTERRUPTS_MASKED_FIQ));
}
...
))
{
  ...
  */
  OS_HAL_JACINTO7_INTC_VIM_IRQVEC = (uint32)(0xFF);                                                                     /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
}
...
))
{
  ...
  /* #10 Clear FIQ interrupt status. */
  OS_HAL_JACINTO7_INTC_VIM_FIQVEC = (uint32)(0xFF);                                                                     /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
}
...
))
{
  ...
  return (Os_StdReturnType)((OS_HAL_JACINTO7_INTC_VIM_INTR_EN_SET_J(InterruptConfig->Source) &                          /* PRQA S 0303, 4304 */ /* MD_Os_Hal_Rule11.4_0303, MD_Os_C90BooleanCompatibility */
...
{
  volatile uint32 forceRead = 0;                                                                                        /* COMP_WARN_OS_READ_IO_REG */ /* COMP_WARN_UNUSED_VARIABLE */

  OS_IGNORE_UNREF_PARAM(SenderCoreID);                                                                                  /* PRQA S 3112 */ /* MD_Os_Rule2.2_3112 */
  OS_IGNORE_UNREF_PARAM(InterruptController);                                                                           /* PRQA S 3112 */ /* MD_Os_Rule2.2_3112 */

  /* #10 Clear pending state of given interrupt source. */
  forceRead = OS_HAL_JACINTO7_INTC_VIM_IRQVEC;                                                                          /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */
  OS_HAL_JACINTO7_INTC_VIM_IRQSTS_J(Source) = (1uL << (Source % 32uL));                                                 /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
  OS_HAL_JACINTO7_INTC_VIM_IRQVEC = (uint32)(0xFF);                                                                     /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
}
...
))
{
  ...
  return (Os_StdReturnType)((OS_HAL_JACINTO7_INTC_VIM_IRQSTS_J(InterruptConfig->Source) &                               /* PRQA S 0303, 4304 */ /* MD_Os_Hal_Rule11.4_0303, MD_Os_C90BooleanCompatibility */
...
))
{
  ...
  OS_HAL_JACINTO7_INTC_VIM_IRQSTS_J(IsrConfig->Source) = (1uL << (IsrConfig->Source % 32uL));                           /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
}
...
))
{
  ...
  /* #10 Clear the status flag for FIQ source. */
  OS_HAL_JACINTO7_INTC_VIM_FIQSTS_J(IsrConfig->Source) = (1uL << (IsrConfig->Source % 32uL));                           /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_CALLER */
}
...
#endif /* OS_HAL_INTERRUPTCONTROLLER_VIM_JACINTO7_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_InterruptController_VIM_Jacinto7.h
 *********************************************************************************************************************/
