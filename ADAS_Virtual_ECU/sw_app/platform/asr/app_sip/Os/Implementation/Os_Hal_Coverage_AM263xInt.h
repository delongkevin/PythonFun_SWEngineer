...
#ifndef  OS_HAL_COVERAGE_AM263XINT_H
# define OS_HAL_COVERAGE_AM263XINT_H
...
\ID COV_OS_HALPLATFORMMASTERSTARTALLOWED
  \ACCEPT XF
  \REASON For AM263x all cores are auto-started.
...
\ID COV_OS_HALARMCROSSCOREUNSUPPORTED
  \ACCEPT XX
  \REASON The function is not needed for AM263x. Triggering X-signal interrupts is done using inter-processor 
          communication registers (See Os_Hal_XSigTrigger function in Os_Hal_Core_AM263x.h).
...
\ID COV_OS_HALPLATFORMNOCENTRALECXEPTIONHANDLER
  \ACCEPT XX
  \REASON This path is never covered. It has no functionality for AM263x and is never used.
...
\ID COV_OS_HALPLATFORCROSSCOREUNSUPPORTED
  \ACCEPT XX
  \REASON This coverage token is never reached as cross core interrupts cannot be triggered directly in VIM interrupt controller.
          MSS_CTRL module is used instead.

END_COVERAGE_JUSTIFICATION */

#endif /* OS_HAL_COVERAGE_AM263XINT_H */

/*!
 * \}
 */
/***********************************************************************************************************************
 *  END OF FILE: Os_Hal_Coverage_AM263xInt.h
 **********************************************************************************************************************/
