...
#ifndef OS_HAL_DERIVATIVE_CYCLONEVINT_H
# define OS_HAL_DERIVATIVE_CYCLONEVINT_H
...
# define OS_HAL_INTC_GIC_DISTRIBUTOR_BASE     (0xFFFED000uL)

/*! Interrupt controller GIC, CPUIF  base address. */
# define OS_HAL_INTC_GIC_CPUIF_BASE     (0xFFFEC100uL)

/*! Number of available IRQ. */
# define OS_HAL_INTC_NUMBER_OF_IRQS       (212uL)
 ...
 *  Timer
 *********************************************************************************************************************/
/*! Defines whether PIT_PRIVATETIMER Timer Unit is supported (STD_ON) or not (STD_OFF). */
# define OS_HAL_TIMER_PIT_PRIVATETIMER     (STD_ON)
...
#endif /* OS_HAL_DERIVATIVE_CYCLONEVINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Derivative_CycloneVInt.h
 *********************************************************************************************************************/
