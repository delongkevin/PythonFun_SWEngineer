...
#ifndef  OS_HAL_CONTEXT_V7R_H
# define OS_HAL_CONTEXT_V7R_H
...
))
{
  ...
  Context->StackRegionInfo = Config->StackRegionSize;                                                                   /* SBSW_OS_HAL_PWA_CALLER */
...
))
{
  ...
  Context->StackRegionInfo = Stack->StackRegionSize;                                                                    /* SBSW_OS_HAL_PWA_CALLER */
}
...
/***********************************************************************************************************************
 *  END OF FILE: Os_Hal_Context_v7r.h
 **********************************************************************************************************************/
