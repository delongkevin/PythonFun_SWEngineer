...
#ifndef  OS_HAL_COMPILER_GCCNXPINT_H
# define OS_HAL_COMPILER_GCCNXPINT_H
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC_variant_Declaration(4, 6, 0);
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC_variant_Declaration(6, 3, 0);
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC_variant_Declaration(6, 3, 1);
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC_variant_Declaration(12, 12, 0);
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC_variant_Declaration(15, 3, 0);
...
/***********************************************************************************************************************
 *  Os_Hal_RFC64_variant_Declaration()
 **********************************************************************************************************************/
/*! \brief        Function like MACRO used to declare multiple variants of the Os_Hal_ReadFromCoprocessor function.
 *  \details      The variants are used to have a single implementation that can be reviewed instead of having multiple
 *                implementations using different registers.
 ...
 *  \param[in]    OpCode2 Coprocessor OpCode2 used as third postfix to form the variant name.
 **********************************************************************************************************************/
#define Os_Hal_RFC64_variant_Declaration(Coproc, Opcode1, Crm)                         \
   uint64 Os_Hal_RFC64_variant_##Coproc##_##Opcode1##_##Crm(void)
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC64_variant_Declaration(15, 0, 14);
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC64_variant_Declaration(15, 1, 14);
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC64_variant_Declaration(15, 2, 14);
...
/*! \brief        Function declaration of one of the used ReadFromCoprocessor variants.
 **********************************************************************************************************************/
Os_Hal_RFC64_variant_Declaration(15, 3, 14);
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_ReadFromCoprocessor64(Coproc, Opcode1, Crm) Os_Hal_RFC64_variant_##Coproc##_##Opcode1##_##Crm()
...
# define Os_Hal_WriteToCoprocessor64(Value, Coproc, Opcode1, CRm) \
  __asm volatile ("MCRR p" #Coproc " ," #Opcode1 ", r0, r1, c" #CRm  \
                   :                                                 \
                   : "r" (Value), "r" (Value)                        \
                   : "r0", "r1")
...
#endif /* OS_HAL_COMPILER_GCCNXPINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_GccNxpInt.h
 *********************************************************************************************************************/
