 ...
 * \brief   Compiler abstraction of the HighTec LLVM compiler
 *
 * \{
 *
   * \file    Os_Hal_Compiler_LlvmHighTecInt.h
 * \brief   This file contains the specific keyword definition for the HighTec LLVM compiler
 * \details
 * The definitions are based on the Hightec Compiler User Manual
 * "Hightec ARM Development Platform User Guide Version 1.1 March 2019"
 *********************************************************************************************************************/
/***********************************************************************************************************************
 *  REVISION HISTORY
 *  --------------------------------------------------------------------------------------------------------------------
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_ReadFromCoprocessor(Coproc, Opcode1, CRn, CRm, Opcode2)    __builtin_arm_mrc (Coproc, Opcode1, CRn, CRm, Opcode2)
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_ReadFromCoprocessor64(Coproc, Opcode1, CRm)    __builtin_arm_mrrc (Coproc, Opcode1, CRm)
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_Set_VBAR(Value)         Os_Hal_WriteToCoprocessor(Value, 15, 0, 12, 0, 0)
...
#endif /* OS_HAL_COMPILER_LLVMHIGHTECINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_LlvmHighTecInt.h
 *********************************************************************************************************************/
