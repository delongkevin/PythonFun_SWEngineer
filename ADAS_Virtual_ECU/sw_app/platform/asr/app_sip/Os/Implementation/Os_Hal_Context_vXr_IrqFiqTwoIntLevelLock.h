 ...
 *  \{
 *
 *  \file  Os_Hal_Context_vXr_IrqFiqTwoIntLevelLock.h
...
#ifndef  OS_HAL_CONTEXT_VXR_IRQFIQONLYINTLEVELLOCK_H
# define OS_HAL_CONTEXT_VXR_IRQFIQONLYINTLEVELLOCK_H
...
))
{
  ...
  Os_Hal_WriteSavedPsr((Next)->Psr | (Next)->IntLevel);
}
...
#endif /* OS_HAL_CONTEXT_VXR_IRQFIQONLYINTLEVELLOCK_H */
...
/***********************************************************************************************************************
 *  END OF FILE: Os_Hal_Context_vXr_IrqFiqTwoIntLevelLock.h
 **********************************************************************************************************************/
