...
#ifndef  OS_HAL_INTERRUPTCONTROLLER_VIM_AR16H
# define OS_HAL_INTERRUPTCONTROLLER_VIM_AR16H
...
/*! VIM software interrupt registers */
#define OS_HAL_MSS_RCM_SWIRQA                    (*(volatile uint32*)0xFFFFFFB8uL)
#define OS_HAL_MSS_RCM_SWIRQB                    (*(volatile uint32*)0xFFFFFFBCuL)

/*! VIM software interrupt trigger values */
#define OS_HAL_SWI_TRIGGER_LOW                   0xAD00uL
#define OS_HAL_SWI_TRIGGER_HIGH                  0xAD000000uL

/*! VIM software interrupt disable values */
#define OS_HAL_SWI_DISABLE_LOW                   0xFFFF00FFuL
#define OS_HAL_SWI_DISABLE_HIGH                  0x00FFFFFFuL
...
# define OS_HAL_INTC_VIM_CHANNCTRL(x)            (*(volatile uint8*)  (                                         \
                                                                        OS_HAL_INTC_VIM_CTRL_BASE +             \
                                                                        0x80uL +                                \
                                                                        (((x)/4uL) * 4uL) + (3uL - ((x)%4uL)))  \
                                                                      )
...
#endif /* OS_HAL_INTERRUPTCONTROLLER_VIM_AR16H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_InterruptController_VIM_AR16xx.h
 *********************************************************************************************************************/
