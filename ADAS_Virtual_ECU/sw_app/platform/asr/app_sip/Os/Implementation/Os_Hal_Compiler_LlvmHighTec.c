...
#define OS_HAL_COMPILER_LLVMHIGHTEC_SOURCE
...
# if defined (OS_CFG_COMPILER_LLVMHIGHTEC)                                                                              /* COV_OS_DERIVATIVEBETAMODULE */
...
{
  uint64 ret = 0;
  __asm volatile (" MRRC p15, 0, r0, r1, c14"
                    : "=r" (ret), "=r" (ret)
                    :
                    : );
  return ret;
...
{
  uint64 ret = 0;
  __asm volatile (" MRRC p15, 1, r0, r1, c14"
                    : "=r" (ret), "=r" (ret)
                    :
                    : );
  return ret;
 ...
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_LlvmHighTec.c
 *********************************************************************************************************************/
