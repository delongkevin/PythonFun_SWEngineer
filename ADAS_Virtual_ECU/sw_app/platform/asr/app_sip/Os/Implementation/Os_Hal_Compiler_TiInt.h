...
#ifndef  OS_HAL_COMPILER_TIINT_H
 ...
 *  \details      -
 *  \param[in]    Addr  Address where the current SP value will be stored. (The parameter is passed in R0.)
 *  \context      ANY
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \pre          -
...
static void Os_Hal_StoreStackPointer(volatile uint32 Addr)
{
  asm("  str sp, [r0]");
}
 ...
 *  \details      -
 *  \param[in]    Addr  Address where the current LR value will be stored. (The parameter is passed in R0.)
 *  \context      ANY
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \pre          -
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_StoreLinkRegister(volatile uint32 Addr)
{
  asm("  str lr, [r0]");
}
/* ECO_IGNORE_BLOCK_END */
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_SysCall(volatile uint32 TrapPacket)
{
  asm("  svc #0");
}
/* ECO_IGNORE_BLOCK_END */
 ...
 **********************************************************************************************************************/
/*! \fn           void Os_Hal_SetAbortModeStackPointer(volatile uint32 Var_Address)
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_SetAbortModeStackPointer(volatile uint32 Var_Address)
{
  asm("  cps #0x17   \n"
      "  mov sp, r0  \n"
      "  cps #0x1F   \n");
 ...
 **********************************************************************************************************************/
/*! \fn           void Os_Hal_SetUndModeStackPointer(volatile uint32 Var_Address)
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_SetUndModeStackPointer(volatile uint32 Var_Address)
{
  asm("  cps #0x1B   \n"
      "  mov sp, r0  \n"
      "  cps #0x1F   \n");
 ...
 **********************************************************************************************************************/
/*! \fn           void Os_Hal_SetFiqModeStackPointer(volatile uint32 Var_Address)
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_SetFiqModeStackPointer(volatile uint32 Var_Address)
{
  asm("  cps #0x11   \n"
      "  mov sp, r0  \n"
      "  cps #0x1F   \n");
 ...
 *  \details      -
 *  \param[in]    NewSp  Value which shall be written to stack pointer. (The parameter is passed in R0.)
 *  \context      ANY
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \pre          -
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_SetSpAndChangeToSupervisorMode(volatile uint32 NewSp)
{
  asm("  push {r1, lr} \n"
      "  mov  r1, sp   \n"
      "  mov  sp, r0   \n"
 ...
 *  \details      -
 *  \param[in]    NewSPSR  Value which shall be written. (The parameter is passed in R0.)
 *  \context      ANY
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \pre          -
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_WriteSavedPsr(volatile uint32 NewSPSR)
{
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_ReadPsr() _get_CPSR()
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_WritePsr(NewPSR) _set_CPSR(NewPSR)
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_Enable_Core_Interrupts() _enable_interrupts()
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_Disable_Core_Interrupts() _disable_interrupts()
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_DisableAndReturnPriorState() (uint32)_disable_interrupts()
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_RestorePriorIntState(IntState)      _restore_interrupts((                                         \
                                                                          _get_CPSR() &                           \
                                                                          (~OS_HAL_PSR_INTERRUPTS_MASKED) &       \
 ...
 *  \pre          -
 **********************************************************************************************************************/
extern uint32 Os_Hal_ReadFpscr();
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_WriteFpscr(volatile uint32 NewFpscr)
{
  asm(" vmsr FPSCR, r0 ");
}
/* ECO_IGNORE_BLOCK_END */
 ...
 *  \pre          -
 **********************************************************************************************************************/
extern uint32 Os_Hal_ReadFpexc();
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_WriteFpexc(volatile uint32 NewFpexc)
{
  asm( " vmsr FPEXC, r0 ");
}
/* ECO_IGNORE_BLOCK_END */
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_StoreFpuRegisters(volatile uint32 FpuRegs)
{
  asm( " vstm r0, {d0-d15}" );
}
/* ECO_IGNORE_BLOCK_END */
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_StoreExtendedFpuRegisters(volatile uint32 FpuRegs)
{
  asm( " vstm r0!, {d0-d15} \n"
       " vstm r0,  {d16-d31}");
}
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_RestoreFpuRegisters(volatile uint32 FpuRegs)
{
  asm( " vldm r0, {d0-d15} " );
}
/* ECO_IGNORE_BLOCK_END */
...
/* ECO_IGNORE_BLOCK_BEGIN */
__attribute__((noinline))
static void Os_Hal_RestoreExtendedFpuRegisters(volatile uint32 FpuRegs)
{
  asm( " vldm r0!, {d0-d15} \n "
       " vldm  r0, {d16-d31} ");
}
