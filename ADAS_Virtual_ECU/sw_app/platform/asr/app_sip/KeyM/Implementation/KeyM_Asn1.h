...
# define KEYM_ASN1_NULL_TAG_LENGHT                                    (0x02u)
 ...
 *  \details       This function initializes the ASN.1 module. It initializes all variables and and sets the module state to
 *                 initialized.
