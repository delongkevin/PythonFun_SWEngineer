...
LDIRS += $(PDK_PATH)/packages/ti/csl/lib/$(BOOTMODE)/$(SOC)/r5f/$(TARGET_BUILD)/
LDIRS += $(PDK_PATH)/packages/ti/board/lib/$(BOOTMODE)/$(BUILD_PDK_BOARD)/r5f/$(TARGET_BUILD)/
...
TIOVX_LIBS += vx_target_kernels_vpac_cuc_isp
TIOVX_LIBS += isp_qnx_magna
