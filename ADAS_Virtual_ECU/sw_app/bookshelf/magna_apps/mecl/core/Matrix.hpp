...
{
  T* v_Val_px = this->val;
  T const * c_EndVal_px = &this->val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype>::Matrix (T value)
: val()
{
  T* v_Val_px = this->val;
  T const * c_EndVal_px = &this->val[channels];
...
: val()
{
  AssertFunction( ( static_cast<uint32_t>(channels) * sizeof(T) ) == sizeof(i_Config_rs.cVal_ax),
...
{
  AssertFunction( ( static_cast<uint32_t>(channels) * sizeof(T) ) == sizeof(o_Config_rs.cVal_ax),
...
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype>::Matrix(const Array<T,channels>& i_Values_rx)
: val()
{
  T* v_Val_px = this->val;
  T const * c_Val_px = &this->val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T,m,n, Mtype> Matrix<T,m,n, Mtype>::zeros()
{
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T,m,n, Mtype> Matrix<T,m,n, Mtype>::ones()
{
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T,m,n, Mtype> Matrix<T,m,n, Mtype>::eye()
{
  Matrix<T,m,n, Mtype> M;
  for(uint32_t i = 0; i < shortdim; i++)
  {
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::add(const T value) const
{
  Matrix<T, m, n, Mtype> v_M_x((*this));
  T* v_MVal_px = v_M_x.val;
  T* const c_MValEnd_px = &v_M_x.val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::add(const Matrix<T, m, n, Mtype>& i_M_rx) const
{
  Matrix<T, m, n, Mtype> v_Mret_x( (*this) );
  T* v_MretVal_px = v_Mret_x.val;
  T* const c_MretValEnd_px = &v_Mret_x.val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::sub(const T value) const
{
  Matrix<T, m, n, Mtype> v_Mret_x( (*this) );
  T* v_MretVal_px = v_Mret_x.val;
  T* const c_MretValEnd_px = &v_Mret_x.val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::sub(const Matrix<T, m, n, Mtype>& i_M_rx) const
{
  Matrix<T, m, n, Mtype> v_Mret_x( (*this) );
  T* v_MretVal_px = v_Mret_x.val;
  T* const c_MretValEnd_px = &v_Mret_x.val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::mul(const T value) const
{
  Matrix<T, m, n, Mtype> v_Mret_x( (*this) );
  T* v_MretVal_px = v_Mret_x.val;
  T* const c_MretValEnd_px = &v_Mret_x.val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::mul(const Matrix<T, m, n, Mtype>& i_M_rx) const
{
  Matrix<T, m, n, Mtype> v_Mret_x( (*this) );
  T* v_MretVal_px = v_Mret_x.val;
  T* const c_MretValEnd_px = &v_Mret_x.val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::div(const T value) const
{
  Matrix<T, m, n, Mtype> v_Mret_x( (*this) );
  T* v_MretVal_px = v_Mret_x.val;
  T* const c_MretValEnd_px = &v_Mret_x.val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::div(const Matrix<T, m, n, Mtype>& i_M_rx) const
{
  Matrix<T, m, n, Mtype> v_Mret_x( (*this) );
 T* v_MretVal_px = v_Mret_x.val;
 T* const c_MretValEnd_px = &v_Mret_x.val[channels];
...
{
  const T* v_Val_px = this->val;
  const T* const c_MValEnd_px = &i_M_rx.val[channels];
  const T* v_MVal_px = i_M_rx.val;
  T v_S_x = math::constants<T>::zero_x();

  do
  {
    v_S_x += *(v_Val_px++) * *(v_MVal_px++);
  } while (v_MVal_px != c_MValEnd_px);
...
void Matrix<T, m, n, Mtype>::normalize(const T& i_Factor_rx)
{
  ...
  T* v_Val_px = this->val;
  T* const c_ValEnd_px = &this->val[channels];
  do
  {
    *(v_Val_px++) *= c_Factor_x;
...
Matrix<T, m, n1, Mtype> Matrix<T, m, n, Mtype>::mmulFast(const Matrix<T, n, n1, Mtype>& i_Rhs_rx) const
{
  ...
  for (uint32_t i=0; i< this->channels ; i += n)
  {
    ...
    for (uint32_t k=0; k < n1; ++k)
    {
      ...
      for (uint32_t j=0; j < i_Rhs_rx.channels; j += n1)
      {
...
T Matrix<T, m, n, Mtype>::sum(void) const
{
  ...
  const T* v_Val_px = this->val;
  const T* const c_ValEnd_px = &this->val[channels];
...
// --------------------------------------------------------------------------
/// @brief get cofactor of 6x6 matrix
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
void Matrix<T, m, n, Mtype>::getCofactor(float A[6][6], float temp[6][6], int p, int q, int count) const
{
  int i = 0, j = 0;
...
// --------------------------------------------------------------------------
/// @brief get determinant of 6x6 matrix
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
T Matrix<T, m, n, Mtype>::determinant(float A[6][6], int count) const
{
	...
	float temp[6][6]; // To store cofactors
	...
	for (int f = 0; f < count; f++)
	{
		...
		getCofactor(A, temp, 0, f, count);
		D += sign * A[0][f] * determinant(temp, count - 1);
...
// --------------------------------------------------------------------------
/// @brief get adjoint of 6x6 matrix
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
void Matrix<T, m, n, Mtype>::adjoint(float A[6][6],float adj[6][6]) const
{
	/*if (MATSIZE == 1)
	{
		adj[0][0] = 1;
...
// --------------------------------------------------------------------------
/// @brief Inverse for 6x6 matrix
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::inverse_6x6() const
{
  mecl::core::Matrix<T, 6, 6> inversebuff;
  T A[6][6];
  for (int i=0; i<6; i++)
  {
		for (int j=0; j<6; j++)
	...
	for (int i=0; i<6; i++)
  {
		for (int j=0; j<6; j++)
    {
			inversebuff(i,j) = adjbuf[i][j]/float(det);
    }
  }
  return inversebuff;
}
...
// --------------------------------------------------------------------------
/// @brief Inverse for 4x4 matrix
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::inverse_4x4() const
{
  // create a buffer
  mecl::core::Matrix<float, 4, 4> inversebuff;
  float inv[16];
  float input[16];
  float det;
  for (int i=0; i<4; i++)
...
void Matrix<T, m, n, Mtype>::setCol(uint32_t j, const Matrix<T,m,1>& i_Mat_x)
{
  ...
  for (uint32_t i=j; i < channels; i += n)
  {
...
{
  return this->reshape<m1, n1>().template convert<T1>();
}
...
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype>
template<uint32_t n1> inline
Matrix<T, m, n+n1, Mtype> Matrix<T, m, n, Mtype>::joinCol(const Matrix<T, m, n1, Mtype>& i_Mat_x) const
{
...
Matrix<T, m+m1, n, Mtype> Matrix<T, m, n, Mtype>::joinRow(const Matrix<T, m1, n, Mtype>& i_Mat_x) const
{
...
{
  AssertFunction(k < static_cast<uint32_t> (channels),"Index out of bounds.");
...
const T& Matrix<T, m, n, Mtype>::operator()(uint32_t i, uint32_t j) const
{
  ...
  AssertFunction(k < static_cast<uint32_t>(channels), "Indices out of bounds.");
  return (*this)(k);
}
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
void Matrix<T, m, n, Mtype>::operator= (const T value)
{
  T* v_Val_px = this->val;
  T* const v_ValEnd_px = &this->val[channels];
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
Matrix<T, m, n, Mtype> Matrix<T, m, n, Mtype>::operator= (const Matrix<T, m, n, Mtype>& v_Mat_rx)
{
  T* v_Val_px = this->val;
  const T* v_MatVal_px = &(v_Mat_rx.val[0]);

  memcpy(v_Val_px, v_MatVal_px, this->sizeOfConfig_u32());
  return *this;
...
// --------------------------------------------------------------------------
template<typename T, uint32_t m, uint32_t n, MatrixType_e Mtype> inline
bool_t Matrix<T, m, n, Mtype>::operator== (const Matrix<T, m, n, Mtype>& v) const
{
  bool_t v_Equal_b = true;
  uint32_t i = 0;
  uint32_t j = 0;
  ...
  while (true == v_Equal_b && i < m) {
    while (true == v_Equal_b && j < n) {
      v_Equal_b = math::equal_x( (*this)(i,j), v(i,j) );
      j++;
    }
    j=0;
    i++;
...
bool_t Matrix<T, m, n, Mtype>::operator!= (const Matrix<T, m, n, Mtype>& v) const
{
  return static_cast<bool_t>(!(*this == v));
}
...
{
  log_printf ("%s", i_OutputFormat_rs.headingChars);
  for (uint32_t i=0 ; i<m ; i++)
  {

    for (uint32_t j=0 ; j<n-1 ; j++) {
      log_printf ("%f%s", (*this)(i,j), i_OutputFormat_rs.columnSeperatorChars);
    }
    log_printf("%f%s", (*this)(i,n-1), (m-1) != i ? i_OutputFormat_rs.rowSeperatorChars
                                                  : i_OutputFormat_rs.trailingChars);
  }
  return;
}
