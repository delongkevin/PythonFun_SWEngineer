...
struct constants
{
  ...
  // --------------------------------------------------------------------------
  static constexpr T minusOne_x(void)
  {
    return static_cast<T>(-1);
  }
  ...
  // --------------------------------------------------------------------------
  static constexpr T zero_x(void)
  {
...
// --------------------------------------------------------------------------
template<typename T>
static constexpr T getPi_x(void)
{
...
// --------------------------------------------------------------------------
template<typename T>
static constexpr T toRadians_x(const T& i_Value_rx)
{
...
// --------------------------------------------------------------------------
template<typename T>
static constexpr T toDegrees_x(const T& i_Value_rx)
{
  return i_Value_rx * 180 / constants<T>::pi_x();
}
...
struct numeric_limits<float64_t>
{
  ...
  // --------------------------------------------------------------------------
//   static bool_t isNaN(const float64_t& i_Value_f64)
//   {
// #ifdef __GNUC__
//     return ((0 ==  isnan(i_Value_f64)) ? false : true);
// #else
//     return ((0 == isnan(i_Value_f64)) ? false : true);
// #endif
//   }
