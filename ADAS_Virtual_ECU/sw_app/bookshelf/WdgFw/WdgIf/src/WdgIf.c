...
{
   /* DD-ID: {5FFBB039-DEAA-42db-95F8-3B96B1A2BF7D}*/
  /* ----- Local Variables ---------------------------------------------- */
...
{
   /* DD-ID: {A0C2ABE2-DB08-4831-8278-4307EBFA0A33}*/
  /* ----- Local Variables ---------------------------------------------- */
...
{
  /* DD-ID: {EB765C03-A79D-411b-96F6-40BB8CCB8422}*/
  /* ----- Local Variables ---------------------------------------------- */
  P2VAR(WdgIf_StateCombinerSharedMemory, AUTOMATIC, WDGIF_APPL_DATA) slave_sdata;
  P2CONST(WdgIf_StateCombinerConfigType, AUTOMATIC, WDGIF_APPL_CONST) state_combiner_config_ptr;
  VAR(uint8, AUTOMATIC) ret_sc;
...
{
  /* DD-ID: {6B32B7B4-7D1C-411e-B96D-9A29D1A6C622}*/
  /* ----- Local Variables ---------------------------------------------- */
...
{
    /* DD-ID: {3E784FA9-B1DB-4ce9-B8C7-F953C216EC99}*/
  /* ----- Local Variables ---------------------------------------------- */
  VAR(Std_ReturnType, AUTOMATIC) ret;
#if (WDGIF_USE_STATECOMBINER == STD_ON)
  P2CONST(WdgIf_InterfaceFunctionsType, AUTOMATIC, WDGIF_APPL_CONST) wdg_function_address;
...
{
  /* DD-ID: {DCEAB843-AD58-4555-9776-867582CEFC59}*/
