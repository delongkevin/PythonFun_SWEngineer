 ...
 *  Ordered Derivat.: TDA4VMID
 *    License Scope : The usage is restricted to CBD2100465_D02
 *
 *  -------------------------------------------------------------------------------------------------------------------
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: WdgM_Cfg_Features.h
 *   Generation Time: 2022-06-30 14:52:19
 *           Project: Hydra3 - Version 1.0
 *          Delivery: CBD2100465_D02
 *      Tool Version: DaVinci Configurator (beta) 5.23.35 SP2
 *
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
# define WDGM_USE_OS_SUSPEND_INTERRUPT        STD_OFF 
