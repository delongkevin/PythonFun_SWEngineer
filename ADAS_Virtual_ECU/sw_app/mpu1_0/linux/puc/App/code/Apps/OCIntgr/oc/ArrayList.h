...
namespace core
{
    ...
    public:
        ...
        const T& back() const
        {
            return items_o[currentSize_u - 1];
        }
        ...
        T& popBack_ro();
        ArrayListSize_t size_u() const
        {
            return currentSize_u;
        }
    ...
    public:
        inline T& operator*()
        {
            assert( arrayIterator_ro.getIndex_u() < arrayList_ro.currentSize_u );
            return *const_cast<ArrayIterator<T, MaxSize>&>( arrayIterator_ro );
        }
        ...
        //PRQA S 3336 1
        inline bool operator !=( const ArrayListIterator<T, MaxSize>& i_other_ro ) const
        {
            return arrayIterator_ro != i_other_ro.arrayIterator_ro;
        }
        inline const ArrayIterator<T, MaxSize>& operator++() const
        {
            return ( ++arrayIterator_ro );
        }
