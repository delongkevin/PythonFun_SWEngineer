...
{
  /* DD-ID: {273F3A9D-5B23-4c5a-909D-DCC503AA69DB}*/
    bool_t v_Ret_b = true;
...
{
  /* DD-ID: {BFBA5207-7CDD-4c2e-AE84-939E01F0242A}*/
...
{
  /* DD-ID: {4246568F-A3C2-470d-B809-8ADCBF17C86C}*/
	info_x.getMPKnmtcMdl_po()->ResetMotionVector( true );
	resetImplObjects_v();
}
...
{
  /* DD-ID: {EEB751A1-7194-4794-AF04-8A9D06653752}*/
    bool_t v_Ret_b = true;
