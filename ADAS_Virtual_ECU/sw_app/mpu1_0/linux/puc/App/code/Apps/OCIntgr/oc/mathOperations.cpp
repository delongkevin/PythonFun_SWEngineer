...
{
    /* DD-ID: {558A1CC1-96D7-4c08-8939-7A4BC286DDFE}*/
...
{
    /* DD-ID: {727B9CB0-B67C-4fd8-8842-815120BA1A10}*/
    uint32_t v_Currsad_u32=0;
    const uint8_t* c_SrcThisLine_pu8;
    const uint8_t* c_RefThisLine_pu8;
    ...
    *o_SAD_pu32 = v_Currsad_u32;
    ...
    {
  /* DD-ID: {FA4DE6F5-4415-43f7-83D0-DA3DE03E49CD}*/
  float32_t v_B_f32;
  float32_t v_C_f32;
  float32_t v_F_f32;
...
{
    /* DD-ID: {FD07E6BD-0BDA-4188-9A37-0C1EEF57978F}*/
...
{
    /* DD-ID: {26E85117-A380-4542-8AF6-2E64995AB326}*/
    ...
    // compute mean value for template and for source image
        ...
        c_Source_pu8 += ( 960 - 16 ); // it was just incremented 2 lines above, so 640-16=624
    }
...
bool_t CrossCorrValidNormLevel1Pass16x16u8(
        ...
        float32_t* o_Dst_pf32 )
{
    /* DD-ID: {BA3A2FF8-692F-4b49-912E-C7A010E57F55}*/
    const uint8_t *c_Source_pu8 = i_Tpl_pu8;
    const uint8_t *c_Patch_pu8 = i_Src_pu8;
    uint32_t v_X_u32 = 0;
    ...
    // compute normalized cross-correlation value between template and image
        for( v_Y_u32 = 0; v_Y_u32 < 16; v_Y_u32++ )
        {
            ...
            c_Source_pu8 += ( i_TplStep_s32 - 16 ); // it was just incremented 2 lines above, so 640-16=624
    }
    ...
    v_Signedsqsumy_s32 = v_Sqsumy_u32 - v_Meanysq256_u32;
        ...
        if( v_Signedsumxy_s32  < 0 )
        {
            v_Signedsumxy_s32  = -v_Signedsumxy_s32;
        }
        if( v_Signedsqsumx_s32 < 0 )
        {
            v_Signedsqsumx_s32 = -v_Signedsqsumx_s32;
        }
        if( v_Signedsqsumy_s32 < 0 )
        {
            v_Signedsqsumy_s32 = -v_Signedsqsumy_s32;
        }
...
bool_t CrossCorrValidNorm16x16u8(
        ...
        float32_t* o_Dst_pf32 )
{
    /* DD-ID: {96B6ACDE-FC45-4bed-817F-F1918EADDDEA}*/
    const uint8_t *c_Source_pu8 = i_Tpl_pu8;
    const uint8_t *c_Patch_pu8 = i_Src_pu8;
    uint32_t v_Corr_u32 = 0;
    uint32_t v_Sqsum1_u32 = 0;
...
{
  /* DD-ID: {7A81E9A7-3641-4801-906D-EE14D7BB8BD7}*/
...
bool_t magna_MatrixMultiply(const float64_t *i_Src1_pf64, sint32_t i_Src1Height_s32,
    ...
    {
        /* DD-ID: {B8FB9312-E9EC-433b-8F80-BFF91D05DDBC}*/
...
// --- magna_transpose (any size and aspect ratio)
 bool_t magna_transpose(const float64_t* i_Src_pf64, float64_t* o_Dest_pf64, sint32_t i_SrcWidth_s32,
    ...
    {
        /* DD-ID: {275A0C10-1794-4569-ACE5-268E8687EC96}*/
    bool_t v_Ret_b = true;
...
{
  /* DD-ID: {BBF4334A-756C-4a1e-BBC2-ABE1F2C04E8B}*/
    bool_t v_Ret_b = true;
...
{
    /* DD-ID: {A5E1B095-CA11-4fe2-8DCF-A16CD889D4D6}*/
    bool_t v_Ret_b = true;
    ...
    bool_t MatrixMultiply(
        ...
        float64_t* o_Dst_pf64 )
    {
        /* DD-ID: {0E4B25E9-C3FE-44ce-8DAE-6E8E1A0E93EA}*/
        bool_t v_Ret_b = true;
        float64_t* v_DstTmp_pf64;
