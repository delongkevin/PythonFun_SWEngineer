...
public:
  ...
  virtual void reset_v(void)= 0;
        ...
        ModuleTypeInfo& getModuleInfo_rt( void )
        {
            return info_x;
        }
        ModuleTypeConfig* getModuleConfig_pt( void )
        {
            return &config_x;
        }
        ModuleTypeCameraConfig* getModuleCameraConfig_pt( tscApi::enuCameraID cameraID )
        {
            return &cameraConfigs_ax[cameraID];
        }
        uint64_t getTracer_u64( void ) const
        {
            return hTracer_s64;
        }
...
protected:
  ...
  bool_t initCamera_b( tscApi::enuCameraID i_CameraID_t )
  {
    bool_t v_Ret_b = true;
