...
namespace control
{
    ...
    public:
        ...
        bool_t isEnabled_b( void ) const
        {
            return enable_b;
        }
        bool_t isInitOk_b( void ) const
        {
            return initOK_b;
        }
        bool_t notInError_b( void ) const
        {
            return ( errorType_t == e_ErrTypeNoError );
        }
        bool_t isErrorNonRecoverable_b( void ) const
        {
            return ( errorType_t == e_ErrTypeNonRecoverable );
        }
