...
namespace tsc_cfg
{
    ...
    const km_ConfigStrType km_initConfig =
    {
        ...
        /* KM External Config */
        {
            ...
            /* Distance COG To Front Axis in mm */ 1497.2F,
            /* Distance COG To Rear Axis in mm */ 1497.2F
        }
    };
    ...
    */
    ...
    const tsc_ConfigStrType tsc_initConfig =
    {
        ...
        /* MaxNumValidFrames */ NUM_VALID_FRAMES,
        /* MinNumRawFrames */ MIN_NUM_RAW_FRAMES
    };
    ...
    const fc_ConfigStrType fc_initConfig =
    {
...
#endif
        {
            /* Front Camera */
            {
                /* ID */ 0, /* Rect */ /*{170, 175, 300, 165},*/ {1, 1, 1, 1},
                /* BMALFC */
                { /* NumROIs */ 2, /* NumPatchesPerROI */ NUM_PATCHES_PER_ROI, /* PatchSize */ PATCH_SIZE, /* RandomPatches */ USE_RANDOM_PATCHES_VAL,
                    /* FrameSkip */ DETECTOR_FRAME_SKIP_VAL, /* TrackLength */ 3, /* SpeedRanges */ {5,10,15,20,25,35}, /* FrameSkips */ {3,1,0,0,0,0},
                    /* SearchRadius */ 25, /* Thresh1 */ 3,/* Thresh2 */ 2, /* UseMad */ USE_MAD_VAL,
                    /* ROI Sets */
                    {
                        /* Num of ROIPools*/ 2, /* ROIs per pool*/ 1, /* Cycle */ CYCLE_THROUGH_ROIS_VAL,
                        /* ROIPools*/
                        {
                            /* Set 1 */ {{/* rect */ {400,330, 30, 30}}},
                            /* Set 2 */ {{/* rect */ {540,330, 30, 30}}}
                        }
                    }
                },
                /* Trajectory Filter */
                { /* MinimumPixelMotion */ 5,/* SlopeDifferenceThresh */ 0.08,
                    /* InitialGuess */ /* AngleThresh_deg */ 10.0, /* DeviationPercentage */ 20, /* UseCombinations */ 0 , /* CombinationsDiffThreshold_deg */ 2.0,
                    /* useSfMFilter */ 0, /* maxHeightDiff_mm */ 20.0
                }
            },
            /* Left Camera */
            {
                /* ID */ 0, /* Rect */ /*{200, 80, 250, 150},*/ {1, 1, 1, 1},
                /* BMALFC */
                { /* NumROIs */ 2, /* NumPatchesPerROI */ NUM_PATCHES_PER_ROI, /* PatchSize */ PATCH_SIZE, /* RandomPatches */ USE_RANDOM_PATCHES_VAL,
                    /* FrameSkip */ DETECTOR_FRAME_SKIP_VAL, /* TrackLength */ 3, /* SpeedRanges */ {6, 12, 17, 22, 25, 35}, /* FrameSkips */ {3, 2, 1, 0, 0, 0},
                    /* SearchRadius */ 25, /* Thresh1 */ 2,/* Thresh2 */ 1, /* UseMad */ USE_MAD_VAL,
                    /* ROI Sets */
                    {
                        /* Num of ROIPools*/ 2, /* ROIs per pool*/ 1, /* Cycle */ CYCLE_THROUGH_ROIS_VAL,
                        /* ROIPools*/
                        {
                            /* Set 1 */ {{/* rect */ {520, 400, 30, 30}}},
                            /* Set 2 */ {{/* rect */ {520, 480, 30, 30}}}
                        }
                    }
                },
                /* Trajectory Filter */
                { /* MinimumPixelMotion */ 5,/* SlopeDifferenceThresh */ 0.02,
                    /* InitialGuess */ /* AngleThresh_deg */ 10.0, /* DeviationPercentage */ 20, /* UseCombinations */ 1 , /* CombinationsDiffThreshold_deg */ 2.0,
                    /* useSfMFilter */ 0, /* maxHeightDiff_mm */ 20.0
                }
            },
            /* Rear Camera */
            {
                /* ID */ 0, /* Rect */ /*{170, 125, 300, 135},*/ {1, 1, 1, 1},
                /* BMALFC */
                { /* NumROIs */ 2, /* NumPatchesPerROI */ NUM_PATCHES_PER_ROI, /* PatchSize */ PATCH_SIZE, /* RandomPatches */ USE_RANDOM_PATCHES_VAL,
                    /* FrameSkip */ DETECTOR_FRAME_SKIP_VAL, /* TrackLength */ 3, /* SpeedRanges */ {6, 11, 15, 20, 25, 35}, /* FrameSkips */ {3,2,1,0,0,0},
                    /* SearchRadius */ 25, /* Thresh1 */ 2,/* Thresh2 */ 1, /* UseMad */ USE_MAD_VAL,
                    /* ROI Sets */
                    {
                        /* Num of ROIPools*/ 2, /* ROIs per pool*/ 1, /* Cycle */ CYCLE_THROUGH_ROIS_VAL,
                        /* ROIPools*/
                        {
                            /* Set 1 */ {{/* rect */ {320,460, 30, 30}}},
                            /* Set 2 */ {{/* rect */ {590,460, 30, 30}}}
                        }
                    }
                },
                /* Trajectory Filter */
            ...
            /* Right Camera */
            {
                /* ID */ 0, /* Rect */ /*{240, 100, 250, 145},*/ {1, 1, 1, 1},
                /* BMALFC */
                { /* NumROIs */ 2, /* NumPatchesPerROI */ NUM_PATCHES_PER_ROI, /* PatchSize */ PATCH_SIZE, /* RandomPatches */ USE_RANDOM_PATCHES_VAL,
                    /* FrameSkip */ DETECTOR_FRAME_SKIP_VAL, /* TrackLength */ 3, /* SpeedRanges */ {6, 12, 17, 22, 25, 35}, /* FrameSkips */ {3,2,1,0,0,0},
                    /* SearchRadius */ 25, /* Thresh1 */ 2,/* Thresh2 */ 1, /* UseMad */ USE_MAD_VAL,
                    /* ROI Sets */
                    {
                        ...
                        /* ROIPools*/
                        {
                            /* Set 1 */ {{/* rect */ {380,400, 30, 30}}},
                            /* Set 2 */ {{/* rect */ {380,480, 30, 30}}}
                        }
                    }
                },
                /* Trajectory Filter */
    ...
    {
  /* DD-ID: {DF16416E-7392-408a-ACD8-5918B8774469}*/
    ...
    {
  /* DD-ID: {5863263C-62F8-4294-A153-124FFDE11353}*/
        bool_t v_Status_b = true;
    ...
    {
  /* DD-ID: {ACF9339C-46DB-42f8-8461-CF0E2E22BD56}*/
        bool_t v_Status_b = true;
    ...
    {
  /* DD-ID: {80F0F77E-A117-46c6-8FD4-77527268B8A6}*/
        bool_t v_Status_b = true;
        /* Load the initial configuration, if enabled Replace the external config from platform layer */
    ...
    {
  /* DD-ID: {7D6F3926-1B7F-486c-BCC4-5E10745E34A1}*/
        bool_t v_Status_b = true;
        /* Load the initial configuration, if enabled Replace the external config from platform layer */
    ...
    {
  /* DD-ID: {EA6DB4CE-FE46-42f9-A519-BA74ABBD5F12}*/
        bool_t v_Status_b = true;
        /* Load the initial configuration, if enabled Replace the external config from platform layer */
    ...
    {
  /* DD-ID: {7CB46664-3DEA-42e5-B6BF-9F5EF159E8CE}*/
    ...
    {
  /* DD-ID: {5E740043-F826-4d68-B3B1-BE355EE7A48B}*/
        bool_t v_Status_b = true;
...
{
  /* DD-ID: {1E844CBE-76D7-4be2-8D6D-BEAB5441B7F4}*/
    bool_t v_Status_b = true;
...
{
  /* DD-ID: {38925A65-CBDC-49e4-B21E-B66730EFA364}*/
...
{
  /* DD-ID: {8F02D745-DE87-4843-ACA7-07D11ECECA91}*/
    bool_t v_Status_b = true;
...
{
  /* DD-ID: {1B26D32C-6775-4788-8886-A05E6983E75E}*/
    bool_t v_Status_b = true;
