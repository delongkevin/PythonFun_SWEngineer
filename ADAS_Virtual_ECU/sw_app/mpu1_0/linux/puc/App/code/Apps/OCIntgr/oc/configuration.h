...
namespace tsc_cfg
{
    ...
    const sint8_t NUM_PATCHES_PER_ROI = 1;
    ...
    const sint8_t NUM_FILTERED_INDICES = 2;      //First and last indices

    // NUM_SPEED_RANGES = 6, is currently defined in controller/tscApi.h
    const sint8_t MAX_FRAME_SKIP = 5;
    ...
    const uint16_t MIN_NUM_RAW_FRAMES = 1500; // 1500/30 fps = 50 seconds
    ...
    const sint16_t NUM_INITIAL_GUESSES = ( NUM_INITIAL_GUESSES_PER_FRAME* MIN_NUM_RAW_FRAMES );
