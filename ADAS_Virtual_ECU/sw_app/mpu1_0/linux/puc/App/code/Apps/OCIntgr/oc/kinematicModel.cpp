...
{
  /* DD-ID: {3851386B-9FB4-40bf-9773-149D1BE9CDB5}*/
...
{
  /* DD-ID: {EBEAC105-DD87-4951-A779-370B438D6B8E}*/
    uninitImplObjects_v();
}

void KinematicModel::reset_v (void)
{
  /* DD-ID: {15FC94B8-72FB-4141-A913-73F7B7E4D3A2}*/
	resetImplObjects_v();
}
...
{
  /* DD-ID: {9BEE90E3-1FD5-4d71-8674-6D1D9A5BF9A0}*/
    bool_t v_Status_b = true;
...
{
  /* DD-ID: {BC3ADF92-1851-40b4-A21B-B0894EAF044B}*/
