...
namespace fc
{
    ...
    public:
        ...
        float64_t getX_f64( void ) const
        {
            return dXMM_f64;
        }
        float64_t getY_f64( void ) const
        {
            return dYMM_f64;
        }
        float64_t getPsi_f64( void ) const
        {
            return dPsiRad_f64;
        }
        void PutX( float64_t i_Param_f64 )
        {
            dXMM_f64 = i_Param_f64;
        }
        void PutY( float64_t i_Param_f64 )
        {
            dYMM_f64 = i_Param_f64;
        }
        void PutPsi( float64_t i_Param_f64 )
        {
            dPsiRad_f64 = i_Param_f64;
        }
    ...
    public:
        ...
        float32_t getAngle_f32( void ) const
        {
            return angle_f32;
        }
        ...
        Point get2ndIPt_t( void ) const
        {
            return predicted2ndImagePt_t;
        }
        float64_t getFundMatErr_f64( void ) const
        {
            return fundMatError_f64;
        }
        uint32_t getFn_u32( void ) const
        {
            return frameNumber_u32;
        }
        Pointd getUnWarpedPt_x( void ) const
        {
            return unwarpedPt_x;
        }
        bool_t getIsUnWarped_b( void ) const
        {
            return isUnwarped_b;
        }
        MotionVector getMV_o( void ) const
        {
            return motionVector_o;
        }
        MotionVector& getMVAddress_ro( void )
        {
            return motionVector_o;
        }

        void PutPt( sint32_t x, sint32_t y )
        {
            pt_t.x_x = x;
            pt_t.y_x = y;
        }
        void PutAngle( float32_t i_Param_f32 )
        {
            angle_f32 = i_Param_f32;
        }
        void PutMatchDist( float32_t i_Param_f32 )
        {
            matchDistance_f32 = i_Param_f32;
        }
        void Put2ndIPt( Point i_Param_t )
        {
            predicted2ndImagePt_t = i_Param_t;
        }
        void PutFundMatErr( float64_t i_Param_f64 )
        {
            fundMatError_f64 = i_Param_f64;
        }
        void PutFn( uint32_t i_Param_u32 )
        {
            frameNumber_u32 = i_Param_u32;
        }
        void PutUnWarpedPt( Pointd i_Param_x )
        {
            unwarpedPt_x = i_Param_x;
        }
        void PutIsUnWarped( bool_t i_Param_b )
        {
            isUnwarped_b = i_Param_b;
        }
        void PutMV( MotionVector i_Param_o )
        {
            motionVector_o = i_Param_o;
        }
    ...
    public:
        ...
        km::KinematicModelImpl* getPKmaticMdl_po( void ) const
        {
            return kinematicModel_po;    // PRQA S 4628
        }
        uint32_t getTrckFrmSkp_u32( void ) const
        {
            return trackFrameSkip_u32;
        }
        uint32_t getRoiI_u32( void ) const
        {
            return roiIdx_u32;
        }
        uint32_t getTrckFrmNum_u32( void ) const
        {
            return trackedFrameNumber_u32;
        }
        bool_t getIsTerm_b( void ) const
        {
            return isTerminated_b;
        }
        MotionVector getTotalMV_o( void ) const
        {
            return totalMotionVector_o;
        }
        Point3d getDesignWorldPt_t( void ) const
        {
            return designWorldPt_t;
        }
        mecl::core::ArrayList < uint32_t, tsc_cfg::NUM_FILTERED_INDICES >& getFltrdIndcs_rx()
        {
            return filteredIndices_x;    // --- indices of the valid filtered items inside a feature track
        }
        mecl::core::ArrayList < ImageFeature, tsc_cfg::TRACK_LENGTH >& getTrckLst_rx()
        {
            return trackList_x;    // --- tracked list of feature across frames
        }
        mecl::core::Array< uint8_t, tsc_cfg::NUM_DESCRIPTOR_LIST>& getLstDscrptr_rx()
        {
            return lastDescriptor_x;    // --- (dynamic) array containing last descriptor
        }
        //PRQA S 6200 1 //const not added to input pointer variables, otherwise assignment produces error
        void PutPKmaticMdl( km::KinematicModelImpl* i_Param_po )
        {
            kinematicModel_po = i_Param_po;
        }
        void PutTrckFrmSkp( uint32_t i_Param_u32 )
        {
            trackFrameSkip_u32 = i_Param_u32;
        }
        void PutRoiI( uint32_t i_Param_u32 )
        {
            roiIdx_u32 = i_Param_u32;
        }
        void PutTrckFrmNum( uint32_t i_Param_u32 )
        {
            trackedFrameNumber_u32 = i_Param_u32;
        }
        void PutIsTerm( bool_t i_Param_b )
        {
            isTerminated_b = i_Param_b;
        }
        void PutIsValid( bool_t i_Param_b )
        {
            isValid_b = i_Param_b;
        }
        void PutTotalMVPlus( MotionVector i_Param_o )
        {
            totalMotionVector_o += i_Param_o;
        }
        void PutDesignWorldPt( Point3d i_Param_t )
        {
            designWorldPt_t = i_Param_t;
        }
    ...
    public:
        ...
        uint8_t getID_u8( void ) const
        {
            return id_u8;
        }
        tsc_math::ROIRect getRect_t( void ) const
        {
            return rect_t;
        }
        void PutID( uint8_t i_Param_u8 )
        {
            id_u8 = i_Param_u8;
        }
        void PutRect( tsc_math::ROIRect i_Param_t )
        {
            rect_t = i_Param_t;
        }
    ...
    public:
        ...
        ROI getRoi_o( void ) const
        {
            return roi_o;
        }
        void PutRoi( const ROI& i_ROI_ro )
        {
            roi_o = i_ROI_ro;
        }
        void AddValidTracks( uint32_t i_Count_u32 )
        {
            numValidTracks_u32 += i_Count_u32;
        }
        uint32_t getNumValidTracks_u32( void ) const
        {
            return numValidTracks_u32;
        }
        void AddIgnoredValidTracks( uint32_t i_Count_u32 )
        {
            numIgnoredValidTracks_u32 += i_Count_u32;
        }
        uint32_t getNumIgnoredValidTracks_u32( void ) const
        {
            return numIgnoredValidTracks_u32;
        }
        void incInvalidTracks_v( void )
        {
            numInvalidTracks_u32++;
        }
        uint32_t getNumInvalidTracks_u32( void ) const
        {
            return numInvalidTracks_u32;
        }
        mecl::core::ArrayList < FeatureTrack, tsc_cfg::NUM_TRACKS >& getTrcks_rx()
        {
            return tracks_x;
        }
    ...
    public:
        ...
        Point3d getWorldPt_t() const
        {
            return worldPt_t;
        }
        Point3d getDesignWorldPt_t() const
        {
            return designWorldPt_t;
        }
        void PutWorldPt( Point3d i_Param_t )
        {
            worldPt_t = i_Param_t;
        }
        MotionVector getMotionVector_o() const
        {
            return motionVector_o;
        }
        float64_t getFundMatError_f64() const
        {
            return fundMatError_f64;
        }
        void PutFundMatError( float64_t i_Param_f64 )
        {
            fundMatError_f64 = i_Param_f64;
        }
        void PutDesignWorldPt( Point3d i_Param_t )
        ...
        mecl::core::ArrayList <ImageFeature, tsc_cfg::TRACK_LENGTH >& getTrackList_rx()
        {
            return trackList_x;
        }
    ...
    public:
        ...
        void restoreValidFeatures_v( uint32_t i_Features_u32 )
        {
            numValidFeatures_u32 = i_Features_u32;
        }
        void restoreProcessedFrames_v( uint32_t i_Frames_u32 )
        {
            numProcessedFrames_u32 = i_Frames_u32;
        }
        void addValidFeatures_v( uint32_t i_Count_u32 )
        {
            numValidFeatures_u32 += i_Count_u32;
        }
        uint32_t getNumValidFeatures_u32( void ) const
        {
            return numValidFeatures_u32;
        }
        void addIgnoredValidFeatures_v( uint32_t i_Count_u32 )
        {
            numIgnoredValidFeatures_u32 += i_Count_u32;
        }
        uint32_t getNumIgnoredValidFeatures_u32( void ) const
        {
            return numIgnoredValidFeatures_u32;
        }
        void incInvalidFeatures_v( void )
        {
            numInvalidFeatures_u32++;
        }
        uint32_t getNumInvalidFeatures_u32( void ) const
        {
            return numInvalidFeatures_u32;
        }
        void incUndetectedFeatures_v( void )
        {
            numUndetectedFeatures_u32++;
        }
        uint32_t getNumUndetectedFeatures_u32( void ) const
        {
            return numUndetectedFeatures_u32;
        }
        void incSkippedFrames_v( void )
        {
            numSkippedFrames_u32++;
        }
        uint32_t getNumSkippedFrames_u32( void ) const
        {
            return numSkippedFrames_u32;
        }
        void incProcessedFrames_v( void )
        {
            numProcessedFrames_u32++;
        }
        uint32_t getNumProcessedFrames_u32( void ) const
        {
            return numProcessedFrames_u32;
        }
        void putNumVldFrms_v( uint32_t i_Param_u32 )
        {
            numValidFrames_u32 = i_Param_u32;
        }
        void incNumVldFrms_v( void )
        {
            ++numValidFrames_u32;
        }
        uint32_t getNumVldFrms_u32( void ) const
        {
            return numValidFrames_u32;
        }
        mecl::core::ArrayList< tscApi::DebugOverlay_s, tsc_cfg::NUM_VALID_INDICES >& getOverlays_rx()
        {
            return overlays_x;
        }
        //#if defined (DEBUG) && defined (TRACING) && defined (APP_CTRL)
        mecl::core::ArrayList< ValidFeature, tsc_cfg::NUM_VALID_INDICES >& getValidFeatures_u32()
        {
    ...
    public:
        ...
        mecl::core::ArrayList < ValidFeature, tsc_cfg::NUM_VALID_FEATURES >& GetVldFtrs()
        {
            return validFeatures;
        }
    ...
    public:
        ...
        void SetCameraID( tscApi::enuCameraID i_ID_t )
        {
            cameraID_t = i_ID_t;
        }
        void SetRawFrame( uint32_t i_Num_u32 )
        {
            numRawFrames_u32 = i_Num_u32;
        }
        void SetValidFrame( uint32_t i_Num_u32 )
        {
            numValidFrames_u32 = i_Num_u32;
        }
        void SetValidFeatures( uint32_t i_Num_u32 )
        {
            numValidFeatures_u32 = i_Num_u32;
        }
        tscApi::enuCameraID getCameraID_t( void ) const
        {
            return cameraID_t;
        }
        uint16_t getVer_u16( void ) const
        {
            return version_u16;
        }
        uint32_t getValidFrames_u32( void ) const
        {
            return numValidFrames_u32;
        }
        uint32_t getRawFrames_u32( void ) const
        {
            return numRawFrames_u32;
        }
        uint32_t getValidFeatures_u32( void ) const
        {
            return numValidFeatures_u32;
        }
    ...
    public:
        ...
        InitialGuess( float64_t i_Pitch_f64, float64_t i_Yaw_f64, float64_t i_Roll_f64 )
        ...
        float64_t getPitch_f64() const
        {
            return pitch_f64;
        }
        float64_t getYaw_f64() const
        {
            return yaw_f64;
        }
        float64_t getRoll_f64() const
        {
            return roll_f64;
        }
        void PutPitch( float64_t i_Pitch_f64 )
        {
            pitch_f64 = i_Pitch_f64;
        }
        void PutYaw( float64_t i_Yaw_f64 )
        {
            yaw_f64 = i_Yaw_f64;
        }
        void PutRoll( float64_t i_Roll_f64 )
        {
            roll_f64 = i_Roll_f64;
        }
        void reset_v()
...
#ifdef ENABLE_SFM    // PRQA S 1070
        sint16_t getNumValidFeatures_u32() const
        {
            return numValidFeatures_u32;
        }
        ValidFeature& GetValidFeature( uint32_t i )
        {
            return m_ValidFeatures[i];
        }
#endif
        sint16_t getNumInitialGuesses_s16() const
        {
            return numInitialGuesses_s16;
        }
        InitialGuess& getInitialGuess_ro( uint32_t i_Index_u32 )
        {
            return initialGuesses_ao[i_Index_u32];
        }
    ...
    public:
        ...
        Descriptor& getDescriptor_ro()
        {
            return descriptor_o;
        }
        uint32_t getNumOfRecord_u32() const
        {
            return numRecord_u32;
        }
        SavedRecord& getSavedRecord_ro( uint32_t i_Index_u32 )
        {
            return savedRecords_ao[i_Index_u32];
        }
        uint32_t getRecordLength_u32() const
        {
            return ( sizeof( savedRecords_ao[0] ) );
        }
        uint32_t getHeaderLength_u32() const
        {
            return ( reinterpret_cast<uint64_t>( &savedRecords_ao[0] ) - reinterpret_cast<uint64_t>( &descriptor_o ) );    // PRQA S 3044
        }
        uint32_t getValidLength_u32() const
        {
            return getHeaderLength_u32() + numRecord_u32 * getRecordLength_u32();
        }
        uint32_t getArraySize_u32() const
        {
            return sizeof( savedRecords_ao );
        }
