...
{
  /* DD-ID: {5D72274E-21EE-476a-9510-ECDE0289E64E}*/
...
{
  /* DD-ID: {0BC6B250-6526-4d36-8FF8-8F0A7FB3ACF2}*/
...
{
  /* DD-ID: {7833388C-C26A-438a-837C-DD22A789A64A}*/
    c_IGs_px = NULL;
...
{
  /* DD-ID: {9A0FFE2F-4BBF-4ad9-B045-C23671E7F6E0}*/
}

// ----------------------------------------------------------------------------
bool_t TSCAlgImpl::start_b(void)
{
  /* DD-ID: {D5558EA0-182A-4cf3-AB7A-23A6BCA51A05}*/
    bool_t v_RetValue_b = true;
    enable_v();
    tscState_e = tscApi::e_TscStateInitOk;
...
{
  /* DD-ID: {A4B638B4-C9CA-4fe1-80BE-0A4F32EACFF2}*/
    bool_t v_RetValue_b = true;
    resetErrorType_v();
...
{
  /* DD-ID: {41DBF6E3-7467-40e2-A5F8-0B69AA51E5AB}*/
    bool_t v_RetValue_b = true;
...
{
  /* DD-ID: {F588D076-2598-4203-ADC8-A418C30A01D3}*/
    return false;
}
...
{
  /* DD-ID: {4B52D9E9-A572-4f55-9DE5-A7EDB9E33FC1}*/
...
{
  /* DD-ID: {95EA40A0-8F34-4f93-B2A6-EF07EC8DFC1E}*/
    ...
    if ( v_RetValue_b )
    {    
        OC_DEBUG_PRINTF(( " [%s]: Final IG Pitch [%.2f], Yaw [%.2f], Roll [%.2f]",
            __func__, initialGuess_o.getPitch_f64(), initialGuess_o.getYaw_f64(), initialGuess_o.getRoll_f64() ));
        OC_DEBUG_PRINTF(( " [%s]: mean(IGs) Pitch [%.2f], Yaw [%.2f], Roll [%.2f]",
            __func__, v_Means_ro.getPitch_f64(), v_Means_ro.getYaw_f64(), v_Means_ro.getRoll_f64() ));
        OC_DEBUG_PRINTF(( " [%s]: stdDev(IGs) Pitch [%.2f], Yaw [%.2f], Roll [%.2f]",
            __func__, v_StdDevs_ro.getPitch_f64(), v_StdDevs_ro.getYaw_f64(), v_StdDevs_ro.getYaw_f64() ));
    } 
...
{
  /* DD-ID: {5C73BE57-8BD5-4606-B758-A8A89041246D}*/
...
{
  /* DD-ID: {243C3B69-4627-4b11-8DCB-979ABBBA22A8}*/
...
{
  /* DD-ID: {B674FE4D-0F7F-4786-B5D1-E832813A9F92}*/
...
{
  /* DD-ID: {A22687E2-970D-44cc-883B-252FEEF91231}*/
    sint16_t v_Index_s16;
...
{
  /* DD-ID: {B9FDBCF4-B60B-4660-AB42-DADDCFDFD802}*/
  ...
  /* DD-ID: {992417BA-4FF6-4d0d-BF49-7337C6B24B04}*/
        {
...
{
  /* DD-ID: {6B2848B2-3E61-4d38-ABFA-5BAB4322A027}*/
...
{
  /* DD-ID: {0CD39230-1230-471f-812D-29F5ECB79E4E}*/
    float64_t v_Sum_f64 = 0.0;
