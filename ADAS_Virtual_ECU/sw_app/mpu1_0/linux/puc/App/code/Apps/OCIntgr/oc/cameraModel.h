    ...
    class IntrinsicParams
    {
      public:
        IntrinsicParams():
            ...
            float64_t GetPixelS( void ) const
            {
                return pixelSize;
            }
            float64_t GetFocalL( void ) const
            {
                return focalLength;
            }
            float64_t GetR0( void ) const
            {
                return R0;
            }
            float64_t GetRadialC1( void ) const
            {
                return radialCoeff1;
            }
            float64_t GetRadialC2( void ) const
            {
                return radialCoeff2;
            }
            float64_t GetRadialC3( void ) const
            {
                return radialCoeff3;
            }
            float64_t GetTangentialC1( void ) const
            {
                return tangentialCoeff1;
            }
            float64_t GetTangentialC2( void ) const
            {
                return tangentialCoeff2;
            }
            float64_t GetAffineC1( void ) const
            {
                return affineCoeff1;
            }
            float64_t GetAffineC2( void ) const
            {
                return affineCoeff2;
            }
            float64_t GetPpx( void ) const
            {
                return ppx;
            }
            float64_t GetPpy( void ) const
            {
                return ppy;
            }
            float64_t GetOrigX( void ) const
            {
                return origX;
            }
            float64_t GetOrigY( void ) const
            {
                return origY;
            }
            float64_t GetPadLen( void ) const
            {
                return padLength;
            }
            uint32_t GetDwnSmplFctr( void ) const
            {
                return downsampleFactor;
            }
            float64_t GetAxisX( void ) const
            {
                return axisX;
            }
            float64_t GetAxisY( void ) const
            {
                return axisY;
            }
            ...
            void PutPixelS( float64_t param )
            {
                pixelSize = param;
            }
            void PutFocalL( float64_t param )
            {
                focalLength = param;
            }
            void PutR0( float64_t param )
            {
                R0 = param;
            }
            void PutRadialC1( float64_t param )
            {
                radialCoeff1 = param;
            }
            void PutRadialC2( float64_t param )
            {
                radialCoeff2 = param;
            }
            void PutRadialC3( float64_t param )
            {
                radialCoeff3 = param;
            }
            void PutTangentialC1( float64_t param )
            {
                tangentialCoeff1 = param;
            }
            void PutTangentialC2( float64_t param )
            {
                tangentialCoeff2 = param;
            }
            void PutAffineC1( float64_t param )
            {
                affineCoeff1 = param;
            }
            void PutAffineC2( float64_t param )
            {
                affineCoeff2 = param;
            }
            void PutPpx( float64_t param )
            {
                ppx = param;
            }
            void PutPpy( float64_t param )
            {
                ppy = param;
            }
            void PutOrigX( float64_t param )
            {
                origX = param;
            }
            void PutOrigY( float64_t param )
            {
                origY = param;
            }
            void PutDwnSmplFctr( uint32_t param )
            {
                downsampleFactor = param;
            }
            void PutAxisX( float64_t param )
            {
                axisX = param;
            }
            void PutAxisY( float64_t param )
            {
                axisY = param;
            }
        private:
        ...
        public:
            ...
            float64_t GetPtchDg( void ) const
            {
                return Pitch_deg;
            }
            float64_t GetYwDg( void ) const
            {
                return Yaw_deg;
            }
            float64_t GetRllDg( void ) const
            {
                return Roll_deg;
            }
            float64_t GetXmm( void ) const
            {
                return X_mm;
            }
            float64_t GetYmm( void ) const
            {
                return Y_mm;
            }
            float64_t GetZmm( void ) const
            {
                return Z_mm;
            }
            bool_t GetFlppd( void ) const
            {
                return flipped;
            }

            void PutPtchDg( float64_t param )
            {
                Pitch_deg = param;
            }
            void PutYwDg( float64_t param )
            {
                Yaw_deg = param;
            }
            ...
            void PutRllDgMinus( float64_t param )
            {
                Roll_deg -= param;
            }
            void PutXmm( float64_t param )
            {
                X_mm = param;
            }
            void PutYmm( float64_t param )
            {
                Y_mm = param;
            }
            void PutZmm( float64_t param )
            {
                Z_mm = param;
            }
            void PutFlppd( bool_t param )
            {
                flipped = param;
            }
        ...
        public:
            ...
            float64_t GetCmrXOffst( void ) const
            {
                return cameraXOffset_mm;
            }
            float64_t GetCmrYOffst( void ) const
            {
                return cameraYOffset_mm;
            }
            float64_t GetCmrPrRll( void ) const
            {
                return cameraPreRoll_deg;
            }

            void PutCmrXOffst( float64_t param )
            {
                cameraXOffset_mm = param;
            }
            void PutCmrYOffst( float64_t param )
            {
                cameraYOffset_mm = param;
            }
            void PutCmrPrRll( float64_t param )
            {
                cameraPreRoll_deg = param;
            }
        ...
        tscApi::enuCameraID GetID() const
        {
            return ID;
        }
        bool_t Valid() const
        ...
        IntrinsicParams& GetIntrinsic()
        {
            return intrinsic;
        }
        ExtrinsicParams& GetExtrinsic()
        {
            return extrinsic;
        }
        ...
        void PutID( tscApi::enuCameraID cameraID )
        {
            ID = cameraID;
        }
