...
namespace tsc
{
    ...
    public:
        ...
        float64_t getWorldPtLimitX_f64( void ) const
        {
            return worldPtLimit_t.x_x;
        }
        float64_t getWorldPtLimitY_f64( void ) const
        {
            return worldPtLimit_t.y_x;
        }
        float64_t getWorldPtLimitZ_f64( void ) const
        {
            return worldPtLimit_t.z_x;
        }
        float64_t getFundMatOutlierThresh_f64( void ) const
        {
            return fundMatOutlierThresh_f64;
        }
        uint32_t getFCRestrictionMaxNumValidFrame_u32( void ) const
        {
            return fCRestriction_s.maxNumValidFrames_u32;
        }
        uint32_t getFCRestrictionMinNumRawFrame_u32( void ) const
        {
            return fCRestriction_s.minNumRawFrames_u32;
        }
    private:
    ...
    public:
        ...
        void setFullCalibration( bool_t i_Value_b )
        {
            fullCalibration_b = i_Value_b;
        }
    private:
    ...
    public:
        ...
        tscApi::TSCState_e getTSCState_e( tscApi::enuCameraID i_CameraID_t )
        {
            return implArray_t[i_CameraID_t].getTSCState_e();
        }
        tscApi::TSCError_e getTSCError_e( tscApi::enuCameraID i_CameraID_t )
        {
            return implArray_t[i_CameraID_t].getTSCError_e();
        }
        bool_t Calibrate( tscApi::enuCameraID i_CameraID_t )
        {
            return implArray_t[i_CameraID_t].calibrate_b();
        }
