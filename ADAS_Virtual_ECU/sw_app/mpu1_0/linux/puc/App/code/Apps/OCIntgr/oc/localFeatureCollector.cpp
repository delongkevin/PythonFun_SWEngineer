...
{
  /* DD-ID: {CB74F847-6814-4b28-9BE6-BD76A1B247C5}*/
    bool_t v_Ret_b = true;
    pROI_po = i_ROI_po;
...
LocalFeatureCollector::~LocalFeatureCollector()
{
  /* DD-ID: {0F9858DA-C347-4299-90FD-727A40AB51A5}*/
...
{
  /* DD-ID: {7BB01CB1-A87E-4e90-8985-BD894D8D9927}*/
...
{
  /* DD-ID: {1E0C26C7-308E-4617-BD84-81BBDD4B101D}*/
...
{
  /* DD-ID: {1596E4BA-F480-492b-99FF-FF3529FF7B62}*/
    bool_t v_Ret_b = true;
...
{
  /* DD-ID: {27C2B2C5-2785-4839-8119-CDA21560501B}*/
    CREATE_TIMER( t );
    START_TIMER( t );
...
{
  /* DD-ID: {1F1B853F-A626-444f-A8A0-CED20FDDA76F}*/
    ...
    for ( uint32_t v_Index_u32 = 0; v_Index_u32 < v_Endlp_u32; ++v_Index_u32)
    {
        ...
        uint32_t v_RandWidth_u32 = c_CurrentROI_rt.width_s32 - params_o.getPtchSz_t().width_s32;
        uint32_t v_RandHeight_u32 = c_CurrentROI_rt.height_s32 - params_o.getPtchSz_t().height_s32;
        ...
        for ( uint32_t v_InnerIndex_u32 = 0; v_InnerIndex_u32 < params_o.getNmPtchsPrROI_u32(); ++v_InnerIndex_u32 )
        {
            ...
            {
                v_Patch_t.x_s32 = ( rand() % v_RandWidth_u32 ) + c_CurrentROI_rt.x_s32;
                v_Patch_t.y_s32 = ( rand() % v_RandHeight_u32 ) + c_CurrentROI_rt.y_s32;
            }
            else
            {
                v_Patch_t.x_s32 = c_CurrentROI_rt.x_s32;
                v_Patch_t.y_s32 = c_CurrentROI_rt.y_s32;
            }
            ...
            TRACE_3( hTracer_s64, "[LFC] ROI{%u} [CreateFeatureTrack] at (%u, %u) ", v_RoiIdx_u32, v_Patch_t.x_x, v_Patch_t.y_x);
        }
    }
...
{
  /* DD-ID: {54044438-0980-4c3d-9403-6FE7A61CB144}*/
...
{
    /* DD-ID: {2824CF5A-184D-4650-A9A7-901B94A99958}*/
    bool_t v_Ret_b = true;
...
{
  /* DD-ID: {6A8B2C41-CDFB-4c61-94E0-92C1C0689560}*/
    bool_t v_Ret_b = true;
...
{
  /* DD-ID: {E1633DEE-B5A7-4bbb-8EDC-9383F3DD14BF}*/
    bool_t v_Ret_b = true;
...
// PRQA S 4212 --
{
    /* DD-ID: {DA7AE2F2-24CB-4876-BE66-9D993B7A8FA6}*/
...
{
    /* DD-ID: {D0CDA499-D15A-44aa-AED1-B0559DE650D2}*/
    bool_t v_Found_b = false;
    bool_t v_Err_b = false;
    sint32_t v_X_s32;
    sint32_t v_Y_s32;
...
{
  /* DD-ID: {AD998C88-89E1-445e-93B8-7E454B4BF265}*/
  bool_t v_Return_b = true;
...
{
  /* DD-ID: {DD009FD8-CA8D-476b-BD1D-835B4D25133C}*/
