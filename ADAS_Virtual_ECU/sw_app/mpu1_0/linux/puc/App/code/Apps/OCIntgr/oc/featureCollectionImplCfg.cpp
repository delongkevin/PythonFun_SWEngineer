...
{
  /* DD-ID: {06DFD8BF-160B-4666-9800-3CF4364FE05B}*/
    bool_t v_Ret_b = true;
...
{
  /* DD-ID: {8B66DF29-BB34-498a-A228-3E17D1808E53}*/
    bool_t v_Ret_b = true;
...
{
  /* DD-ID: {0E82DAD8-5A8D-4ff4-B302-9FB8C9D36B70}*/
    bool_t v_Ret_b = true;
    ...
    else
    {
        ...
        else if( !v_CameraModel_po->LoadExtrinsicParamConfig( cameraModelConfigPtr ) )
        {
            TRACE_1( m_hTracer, "Failed to load Extrinsic CameraModel configuration for [%s]", tsc_trace::kCameraStrings[i_CameraID_t].c_str() );
            v_Ret_b = false;
        }
        else if( !v_CameraModel_po->LoadOrientationParamConfig( cameraModelConfigPtr ) )
        {
...
{
  /* DD-ID: {259ECB18-3B5C-4c1f-909A-18274B49042F}*/
