...
class KinematicModelConfig
{
  public:
    ...
    KinematicModelConfig() : tireCircumferencePerPulseMM_f32(0)
    {
        ...
        void PutM_TrCrcmfrncPrPls_mm( float32_t i_Param_f32 )
        {
            tireCircumferencePerPulseMM_f32 = i_Param_f32;
        }
...
class KinematicModelInfo
{
  public:
        ...
        straightMotionDistanceThreshMM_f64(0)
    {
        ...
        float64_t getMVhclSlpAnglRd_f64( void ) const
        {
            return vehicleSlipAngleRad_f64;
        }
        float64_t getMDstncCG2FrntAxsMM_f64( void ) const
        {
            return distanceCoG2FrontAxisMM_f64;
        }
        float64_t getMDstncCG2RrAxsMM_f64( void ) const
        {
            return distanceCoG2RearAxisMM_f64;
        }
        float64_t getMHdngIncrmnt_f64( void ) const
        {
            return headingIncrement_f64;
        }
        float64_t getMMnTrvldDstncMM_f64( void ) const
        {
            return meanTraveledDistanceMM_f64;
        }
        float64_t getMAccmltdHdng_f64( void ) const
        {
            return accumulatedHeading_f64;
        }
        float64_t* getMAccmltdDsplcmntCOG_pf64( void )
        {
            return &accumulatedDisplacementCOG_af64[0];
        }
        float64_t getMStrghtMtnDstncThrshMM_f64( void ) const
        {
            return straightMotionDistanceThreshMM_f64;
        }
    
        void putMVhclSlpAnglRd_v( float64_t i_Param_f64 )
        {
            vehicleSlipAngleRad_f64 = i_Param_f64;
        }
        void putMDstncCG2FrntAxsMM_v( float64_t i_Param_f64 )
        {
            distanceCoG2FrontAxisMM_f64 = i_Param_f64;
        }
        void putMDstncCG2RrAxsMM_v( float64_t i_Param_f64 )
        {
            distanceCoG2RearAxisMM_f64 = i_Param_f64;
        }
        void putMHdngIncrmnt_v( float64_t i_Param_f64 )
        {
            headingIncrement_f64 = i_Param_f64;
        }
        void putMMnTrvldDstncMM_v( float64_t i_Param_f64 )
        {
            meanTraveledDistanceMM_f64 = i_Param_f64;
        }
        void putMStrghtMtnDstncThrshMM_v( float64_t i_Param_f64 )
        {
            straightMotionDistanceThreshMM_f64 = i_Param_f64;
        }
