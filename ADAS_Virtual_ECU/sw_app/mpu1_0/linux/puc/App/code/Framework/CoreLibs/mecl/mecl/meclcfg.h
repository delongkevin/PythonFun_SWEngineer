...
#define meclcfg_VERSION_ID_H "$Id: meclcfg.h 1.2 2021/08/17 08:52:01CEST Martin Rachor (MEE_MRACHO) draft  $"
...
namespace mecl
{
  ...
  typedef mecl::model::LensRadial<float32_t, 5U, 5U> LensRadial_t;
  typedef mecl::model::LensCylinder<float32_t> LensCylinder_t;
  typedef mecl::model::LensStretchVertical<float32_t, 5U, 5U, 6U, 6U> LensStretchVertical_t;
