                                                     ...
                                                     Decomposition_ax& o_Decomp_rax)
{
  ...
  // x axis
  o_Decomp_rax[rx] = static_cast<core::RotationMatrix<T> >(core::Matrix<T, 3, 3>::eye());
  ...
  // y-axis
  o_Decomp_rax[ry] = static_cast<core::RotationMatrix<T> >(core::Matrix<T, 3, 3>::eye());
  ...
  // z-axis
  o_Decomp_rax[rz] = static_cast<core::RotationMatrix<T> >(core::Matrix<T, 3, 3>::eye());
