...
public:
  ...
  void assertOverflowMsg_v() const
  {
    ...
    snprintf(&v_Msg_ac[0], sizeof(v_Msg_ac),
        ...
        static_cast<float64_t>(val_x) / static_cast<float64_t>(1ULL << FRACBITS), static_cast<sint32_t>(val_x),
        static_cast<float64_t>(c_RefVal_x) / static_cast<float64_t>(1ULL << FRACBITS), static_cast<sint32_t>(c_RefVal_x));
