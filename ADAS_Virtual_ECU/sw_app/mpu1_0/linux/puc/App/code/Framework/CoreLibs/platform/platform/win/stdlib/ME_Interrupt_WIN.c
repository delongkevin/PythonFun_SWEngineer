...
PlatformError_t ME_Interrupt_Mask_t(const InterruptHandle_t* i_InterruptHandle_t)
{
  return e_PeOk;
}

PlatformError_t ME_Interrupt_Unmask_t(const InterruptHandle_t* i_InterruptHandle_t)
{
  return e_PeOk;
}

PlatformError_t ME_Interrupt_Wait_t(const InterruptHandle_t* i_InterruptHandle_t)
{
  return e_PeOk;
}
