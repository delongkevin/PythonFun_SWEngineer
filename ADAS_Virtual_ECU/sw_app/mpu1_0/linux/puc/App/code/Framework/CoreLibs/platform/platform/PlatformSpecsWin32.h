...
/// @brief Platform Specifications for Windows 32 bit
/// Defines macros that must be implemented for Windows 32 bit
///       
/// --------------------------------------------------------------------------
...
#ifndef ME_PLATFORM_SPECS_WIN32_H
#define ME_PLATFORM_SPECS_WIN32_H
...
#define ME_PLATFORM_NAME          "Microsoft Windows"
#define ME_COMPILER_NAME          "Microsoft Visual C++ Win32"
...
#define ME_PRETTY_FUNCTION        __FUNCSIG__
...
#endif // ME_PLATFORM_SPECS_WIN32_H
