...
void Quaternion<T>::fromMatrix4x4(const Projection4D<T>& i_Mat_ro)
{
  ...
  {  
    T s = static_cast<T>(0.5) / math::algebra<T>::sqrt_x(trace + one);
  ...
  else 
  {
    ...
    {
      T s = static_cast<T>(2) * math::algebra<T>::sqrt_x(one + i_Mat_ro(0,0) - i_Mat_ro(1,1) - i_Mat_ro(2,2));
    ...
    {
      T s = static_cast<T>(2) * math::algebra<T>::sqrt_x(one + i_Mat_ro(1,1) - i_Mat_ro(0,0) - i_Mat_ro(2,2));
    ...
    {
      T s = static_cast<T>(2) * math::algebra<T>::sqrt_x(one + i_Mat_ro(2,2) - i_Mat_ro(0,0) - i_Mat_ro(1,1) );
