...
#define ILens_D_VERSION_ID "$Id: ILens.h 1.2 2021/08/17 08:52:00CEST Martin Rachor (MEE_MRACHO) draft  $"
//! @endcond

#include "mecl/config/IConfig.h"
...
#endif
      return (i_Pos_x.getElevation(e_Degrees) < 88.0f);
    }
