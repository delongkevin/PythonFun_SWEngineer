//--------------------------------------------------------------------------
/// @file PlatformSpecsPos4X.h
/// @brief Platform Specifications for Pike OS 4.X 64 bit
/// Defines macros that must be implemented for Pike OS 4.X 64 bit
///       
/// --------------------------------------------------------------------------
...
#ifndef ME_PLATFORM_SPECS_POS4X_H
#define ME_PLATFORM_SPECS_POS4X_H
...
#define ME_COMPILER_NAME          "Gnu Compiler Collection 4.9.3 64 Bit"  
...
#define ME_PACKED                 __attribute__((packed)) // we want Macros here
...
#endif // ME_PLATFORM_SPECS_POS4X_H
