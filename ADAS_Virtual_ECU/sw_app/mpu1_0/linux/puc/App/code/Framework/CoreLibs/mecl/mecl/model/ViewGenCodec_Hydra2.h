...
public:
  ...
  virtual void encode_v( const core::Point2D<float32_t>& i_Pos_rx, uint32_t& o_Val_rx) const
  {
    ...
    v_Pos_f32(0) = math::clamp_x(v_Pos_f32(0), -32768.0F, 32767.0F);
    v_Pos_f32(1) = math::clamp_x(v_Pos_f32(1), -32768.0F, 32767.0F);
...
public:
                                              ...
                                              uint32_t& o_Val_rx) const
  {
    ...
    switch(v_NormDim_u32)
    {
      ...
      //o_Val_rx = e_Side | (c_U_u16 << 15) | c_V_u16;
        o_Val_rx = ( this->sensorFlipped_b ? e_Rear : e_Side ) | (c_U_u16 << 15) | c_V_u16;
      }
      break;
      case 1U: // vertical
      {
      ...
      case 2U: // front or rear
      {
        const uint16_t c_U_u16 = calcF32S15_u16(v_Pos_x(0));
        const uint16_t c_V_u16 = calcF32S15_u16(v_Pos_x(1));
        o_Val_rx = ( (v_Pos_x(2)>=0) ? e_Front : e_Rear ) | (c_U_u16 << 15) | c_V_u16;
      }
      break;
      default:
      {
  ...
  {
    const uint32_t c_Face_e = i_Val_rx & 0xC0000000U;
    // SF draft
  ...
  void setSensorFlipped_v(bool_t i_SensorFlipped_b)
  {
    this->sensorFlipped_b = i_SensorFlipped_b;
  }
