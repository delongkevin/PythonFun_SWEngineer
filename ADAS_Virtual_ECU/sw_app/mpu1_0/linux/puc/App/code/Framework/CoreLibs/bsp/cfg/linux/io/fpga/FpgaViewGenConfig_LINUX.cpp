...
namespace bsp
{
  ...
  uint32_t ViewGenConfig::getViewGenCameraId_u32(variants::Camera_t i_CameraId_t)
  {
  ...
  bool_t ViewGenConfig::init_b(void* i_BaseAddress_pv)
  {
    ...
    if(i_BaseAddress_pv != NULL)
    {
      ...
      for(uint32_t v_I_u32 = 0; v_I_u32 < c_MaxLensCount_u32; v_I_u32++)
      {
        undistPrinciplePoints_apv[v_I_u32]    = &reinterpret_cast<uint8_t*>(axiLite_pv)[c_UndistortPrinciplePointsOffset_u32 + (v_I_u32 * 0x0008U)];
  ...
  void* ViewGenConfig::getAxiLite_pv()                                      { return axiLite_pv; }
  void* ViewGenConfig::getSequencingTable_pv()                              { return sequencingTable_pv; }

  void* ViewGenConfig::getUndistPrincipalPoints_pv(uint32_t i_LensId_u32)
  {
  ...
  void* ViewGenConfig::getDistPrincipalPoints_pv(variants::Camera_t i_CameraId_t)
  {
    void* v_Result_pv = NULL;

    if(i_CameraId_t < variants::e_CameraCount)
    {
      uint32_t v_ViewGenCameraId_u32 = getViewGenCameraId_u32(i_CameraId_t);
  ...
  void* ViewGenConfig::getDistPixelDensity_pv(variants::Camera_t i_CameraId_t)
  {
    void* v_Result_pv = NULL;
  ...
  void* ViewGenConfig::getMatMul_pv(uint32_t i_ProjectionId_u32)
  {
    void* v_Result_pv = NULL;
  ...
  void* ViewGenConfig::getUndistortLUT_pv(uint32_t i_LensId_u32)
  {
    void* v_Result_pv = NULL;
  ...
  void* ViewGenConfig::getDistortLUT_pv(variants::Camera_t i_CameraId_t)
  {
    void* v_Result_pv = NULL;
