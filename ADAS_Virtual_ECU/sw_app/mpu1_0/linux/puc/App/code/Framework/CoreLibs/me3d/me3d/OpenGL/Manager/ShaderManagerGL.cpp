...
EffectFilePass* ShaderManagerGL::createPass_po()
{
...
EffectFileShader* ShaderManagerGL::createEffectFileShader_po()
{
...
EffectFileVertexDeclaration* ShaderManagerGL::createVertexDeclaration_po()
{
...
EffectFileConstantBlock* ShaderManagerGL::createConstantBlock_po()
{
...
EffectFileParser* ShaderManagerGL::createParser_po()
{
...
EffectFileRenderStateBlock* ShaderManagerGL::createRenderStateBlock_po()
{
