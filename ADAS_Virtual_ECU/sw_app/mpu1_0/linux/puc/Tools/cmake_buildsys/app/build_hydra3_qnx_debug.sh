...
mkdir -p hydra_build_qnx_debug
cd hydra_build_qnx_debug
echo tests
...
cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_TOOLCHAIN_FILE=../../addons/toolchain_hydra3_stellantis_qnx.cmake  $RUNTIME_STATS_FLAG ../../../../App/code/
make -j $(nproc)