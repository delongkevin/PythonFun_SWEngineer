...
##********************************************************************************************
## $Id: toolchain_x86_x64.cmake 1.1.2.1 2021/08/17 09:27:34CEST Martin Rachor (MEE_MRACHO) draft  $
##********************************************************************************************
...
set(CMAKE_SYSTEM_VERSION 7.0.0)                                     # QNX OS Version
set(arch gcc_ntox86_64)
set(CMAKE_SYSTEM_PROCESSOR x86_64-pc-nto-qnx7.0.0)
set(QNX_ARCH x86_64)
...
FIND_PATH(QNX_HOST
  ...
  PATHS $ENV{QNX_HOST} "C:/prjtools/QNX/Toyota_EV7.0/host/win64/x86_64"
  NO_CMAKE_PATH
...
FIND_PATH(QNX_TARGET
  ...
  PATHS $ENV{QNX_TARGET} "C:/prjtools/QNX/Toyota_EV7.0/target/qnx7"
  NO_CMAKE_PATH
  NO_CMAKE_ENVIRONMENT_PATH
)
...
#set(ENV{QCC_CONF_PATH} "C:/prjtools/QNX/Toyota_EV7.0/host/win64/x86_64/etc/qcc/gcc")
#set(ENV{PLATFORM} "armv7le")
#set(ENV{LD} "QCC -lang-c++ -V5.4.0,gcc_ntoarmv7le")
#set(ENV{CXX} "QCC -lang-c++ -V5.4.0,gcc_ntoarmv7le")
#set(ENV{CPUVARDIR} "armle-v7")
#set(ENV{BUILD_PROFILE} "debug")
#set(ENV{CC} "qcc -V5.4.0,gcc_ntoarmv7le")
#set(ENV{AS} "qcc -V5.4.0,gcc_ntoarmv7le")
