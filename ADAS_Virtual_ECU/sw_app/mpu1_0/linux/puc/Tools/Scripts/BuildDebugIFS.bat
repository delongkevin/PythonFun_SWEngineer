...
@echo ###############################################
@echo Delete old QNX ifs (%ELF_PATH%\ifs-magna-ultrascale_debug.elf)
del %ELF_PATH%\.\ifs-magna-ultrascale_debug.elf
@echo.
...
make -C%ELF_PATH% ifs-magna-ultrascale_debug.elf
@goto done
