...
@set INPUT_IMAGES_DIR=%CURDIR%/./../../App/code/OS/BSP/images
@set BOOT_IMAGE=%INPUT_IMAGES_DIR%/flashimage_debug.bin
@set FSBL_ELF_FILE=%INPUT_IMAGES_DIR%/zynqmp_fsbl_debug.elf

@call python %CURDIR%/flash.py --image %BOOT_IMAGE% --fsbl %FSBL_ELF_FILE%
