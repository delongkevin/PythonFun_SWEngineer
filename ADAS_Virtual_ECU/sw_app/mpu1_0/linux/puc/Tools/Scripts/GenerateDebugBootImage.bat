...
@set PMU_FW_ELF_FILENAME=pmufw_debug.elf

@rem set file name of the FSBL file
@set FSBL_ELF_FILENAME=zynqmp_fsbl_debug.elf
...
@set QNX_IMAGE_ELF_FILENAME=ifs-magna-ultrascale_debug.elf

@rem set file name of the FPGA bit file
@set FPGA_BIT_FILENAME=./Zynq_PL.bit

@rem set boot image file name
@set BOOT_IMAGE_FILENAME=flashimage_debug.bin
