...
@rem #--------------------------------------------------------------------------------#
@rem #    Created on: 22.11.2019                                                      #
@rem #        Author: Roman Berngardt (Roman.Berngardt@magna.com)                     #
@rem #--------------------------------------------------------------------------------#

@set QNX_BASE_DIR=C:\QNX

@title Toyota_780B PuC Launch QNXMomentics IDE

@call python LaunchQNXMomenticsIDE.py --qnxbase %QNX_BASE_DIR% -d ..\Workspace\cmake_qde