 ...
 * Remarks:  DD-ID: {2310E6F4-C653-4447-BCB1-6EEB87A304D0}
 * ===========================================================================*/
 ...
 */
/* ===========================================================================
 * Name:     UssOD_TriangEchoesTemporalDir
 * Remarks:  DD-ID: {5EDEFA5C-9E42-4a25-8D60-A3E2B0EAE581}
 * Req.-ID: 13514834
 * ===========================================================================*/
static bool_t UssOD_TriangEchoesTemporalDir(const US_S_SnrCalcs_t * psSnrCalcs,
                                            uint8_t uGrpIdx,
...
#endif /* (US_D_OD_USE_LONE_DIR_PNT_MATCHING ) */
...
#endif
/* ===========================================================================
 * Name: UssOD_AgeAndAdjustOldPoints	
 * Remarks:  DD-ID: {C8C84A47-891F-406f-9570-8DFFADD85733}
 * ===========================================================================*/
static void UssOD_AgeAndAdjustOldPoints(uint8_t uGrpIdx, US_E_Grp_Allow_Level_t eGrpAllowLvl)
{
    uint8_t uListIdx;
 ...
 */
/* ===========================================================================
 * Name: DynTargetDeadPntSweeper	
 * Remarks:  DD-ID: {48C4FDD0-7E3F-4b4b-8E57-82B8E1A8DC92}
 * ===========================================================================*/
static void DynTargetDeadPntSweeper(uint8_t uGrpIdx)
{
...
/* ===========================================================================
 * Name: UssOD_UpdateCacheEntries	
 * Remarks:  DD-ID: {7A1ACAAA-3878-4ad5-B0B2-932DAEE78264}
 * ===========================================================================*/
static void UssOD_UpdateCacheEntries(const US_S_SnrCalcs_t *psSnrCalcs,
                                     uint8_t uDirSnrDataIdx,
                                     uint8_t uCurMeasUsageStat)
...
/* ===========================================================================
 * Name: UssOD_UpdateCacheDistanceCalcs	
 * Remarks:  DD-ID: {868D57C4-7948-4735-84CE-726F4BD29080}
 * ===========================================================================*/
static void UssOD_UpdateCacheDistanceCalcs(uint8_t uDirSnrDataIdx)
{
    US_S_DirEchoCache_t *psDirEchoCache = &sObjDetCalcRec[uDirSnrDataIdx].sDirEchoCache;
 ...
 * Remarks:  DD-ID: {61208FC3-4452-4f98-A17C-F54405AEA7B0} 
...
#endif /* (US_D_OD_EGO_DIR_CHANGE_CONF_REDUCE ) */
...
/* ===========================================================================
 * Name: eGetCurVehDirOfMotion	
 * Remarks:  DD-ID: {D70EC444-54C5-4869-B55F-B95DA4E34468}
 * ===========================================================================*/
static US_E_Dir_Ego_Motion_t eGetCurVehDirOfMotion(void)
{
...
/* ===========================================================================
 * Name: UssOD_bIsPntInsideVehicle	
 * Remarks:  DD-ID: {F6A91CF7-CECB-46d9-8731-C0436D0BC9D0}
 * ===========================================================================*/
static bool_t UssOD_bIsPntInsideVehicle(float32_t fX, float32_t fY)
{
    US_S_DrivingTubeInfo_t * psDrivingTubeInfo = UssOD_psGetDrivingTubeInfo();
...
/* ===========================================================================
 * Name: UssOD_bIsFlankingMitigationActive	
 * Remarks:  DD-ID: {968F50B4-F92F-486d-BA8E-909D213E60D9}
 * ===========================================================================*/
static bool_t UssOD_bIsFlankingMitigationActive(void)
{
...
/* ===========================================================================
 * Name: UssOD_eGetGrpAllowLevel	
 * Remarks:  DD-ID: {816A9D1D-DECE-45c5-A872-DD9CB36CAEB0} 
 * ===========================================================================*/
#if  US_D_OD_DEBUG_VARS_ON == ME_TRUE
