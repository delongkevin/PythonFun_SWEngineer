/*
 * @Author: Manatheykad, Shalhoob
 * @Date:   2023-07-09 23:52:04
 * @Last Modified by:   Manatheykad, Shalhoob
 * @Last Modified time: 2023-09-12 13:17:07
 */
/**
 * @file Safety_CDD.c
 * @brief Safety goal protection in mcu2_1 core
 *
 * @details This file reports safety goal related error enum to error manager
 *
 * --------------------------------------------------------------------------
...
ASILB_CONST_SECTION const Safety_arm_vim_cfg j721s2_vim_data_2_1[] = {

    {
        .intrNum = CSLR_R5FSS0_CORE1_INTR_TIMER3_INTR_PEND_0,
    ...
    {
        .intrNum = CSLR_R5FSS0_CORE1_INTR_TIMER5_INTR_PEND_0,
        .pri = VIM_PRIV_VAL_0x0F,
        .intrMap = VIM_INTR_MAP_VAL_0,
        .intrType = VIM_INTR_TYPE_VAL_0,
        .intrEnClr = VIM_INTR_EN_VAL_1,
...
ASILB_CONST_SECTION const Safety_vimStaticRegs j721s2_vim_static_data_2_1 = {
    .PID = 0x60900001,
    .INFO = 0x0200,
	#if !defined(VCAST)
...
{
  /* DD-ID: {C650F553-8239-44d2-B9FC-72DAE09AAB2A}*/
    ...
    {
        retVal = Safety_VIM_verifyCfgIntr(&j721s2_vim_data_2_1[VIM_INTR_TIMER_OS]);
        if (retVal != 0x0)
        {
            /* Report Error Status */
            v_errData_u8[0] = u32SafetyTaskrunCount;
            ErrorMgrSatellite_ReportErrorStatus(ldef_ErrorMgr_Error_SysIntFlt_Main_VIM_Register_Mismatch_in_MainDomain_2_1, ldef_ErrorMgr_ErrorActive, (const ldef_ErrorMgr_stAddData *)v_errData_u8);
        }
        break;
    }
    ...
    case SAFETY_VIM_TIMER_TASK_RUN_OFFSET:
    {
        ...
        retVal = Safety_VIM_verifyCfgIntr(&j721s2_vim_data_2_1[VIM_INTR_TIMER_TASK]);
        if (retVal != 0x0)
        {
            /* Report Error Status */
            v_errData_u8[0] = u32SafetyTaskrunCount;
    ...
    {
        retVal = Safety_VIM_VerifyStaticRegs(&j721s2_vim_static_data_2_1);
        if (retVal != 0x0)
        {
            /* Report Error Status */
            v_errData_u8[0] = u32SafetyTaskrunCount;
    ...
    case SAFETY_TASKTIMER_RUN_OFFSET:
    {
        ...
        {
            v_errData_u8[0] = u32SafetyTaskrunCount;
            ErrorMgrSatellite_ReportErrorStatus(ldef_ErrorMgr_Error_SysIntFlt_Main_Timer_2TimerSyncCheck_MainDomain_2_1, ldef_ErrorMgr_ErrorActive, (const ldef_ErrorMgr_stAddData *)v_errData_u8);
        }
        break;
    }
