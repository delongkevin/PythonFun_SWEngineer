...
.fg-title{{
  ...
  padding:9px 14px;background:#c62828;
  border-left:4px solid #7f0000;border-radius:0 5px 5px 0;
...
/* Keep fail/pass row colours intact on hover – do not override with light-blue */
table tr.row-fail:hover td{{background:#d32f2f !important;color:#fff !important}}
table tr.row-pass:hover td{{background:#388e3c !important;color:#fff !important}}

/* Fail / Pass row highlighting – applied by JS; white text ensures readability on coloured backgrounds */
table tr.row-fail td{{background:#c62828 !important;color:#fff !important;font-weight:600}}
table tr.row-pass td{{background:#2e7d32 !important;color:#fff !important;font-weight:500}}
